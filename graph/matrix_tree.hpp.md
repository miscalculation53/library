...
data:
  ...
  bundledCode: "#line 2 \"graph/matrix_tree.hpp\"\n\n#line 2 \"template/template_all_but_modint.hpp\"\
    ...
    };\n\ntemplate <class T, const T infty = INF>\nusing SemiRingMinPlus = SemiRingFromMonoidMonoid<MonoidMin<T,\
    \ infty>, MonoidAdd<T>>;\ntemplate <class T, const T infty = INF>\nusing SemiRingMaxPlus\
    \ = SemiRingFromMonoidMonoid<MonoidMax<T, infty>, MonoidAdd<T>>;\ntemplate <class\
    ...
    \ GroupMulDiv<T>>;\n#line 2 \"math/linalg/bbla.hpp\"\n\n#line 2 \"math/fps/berlekamp_massey.hpp\"\
    \n\n#line 5 \"math/fps/berlekamp_massey.hpp\"\n\n/**\n * @brief Berlekamp\u2013\
    Massey\n * @docs docs/math/fps/berlekamp_massey.md\n */\n\n// https://codeforces.com/blog/entry/61306\n\
    \n// F \u306F\u4F53 (FieldAddSubMulDiv<mint> \u306A\u3069)\n// \u5165\u529B: a[0],\
    \ ..., a[n-1]\n// \u51FA\u529B: c[1], ..., c[d] \u3067\u3042\u3063\u3066 a[i]\
    \ = sum[j=1..d] c[j]a[i-j] \u3092\u6E80\u305F\u3059\u3082\u306E\u306E\u3046\u3061\
    \ d \u304C\u6700\u5C0F\u306E\u3082\u306E\n//   (c[0] == -1 \u3068\u3059\u308B\
    )\n// \u8A08\u7B97\u91CF: O(n^2) \u6642\u9593\u3001n = 10000 \u3067 86 ms \u304F\
    \u3089\u3044\ntemplate <class F>\nvc<typename F::S> berlekamp_massey(const vc<typename\
    \ F::S> &a)\n{\n  using S = typename F::S;\n  const int n = a.size();\n  vc<S>\
    \ b, c;\n  int pos = -1;\n  S x = F::e0();\n  repi(i, n)\n  {\n    const int d\
    \ = c.size();\n    S y = a[i];\n    repi(j, d) y = F::add(y, F::minus(F::mul(c[j],\
    \ a[i - 1 - j])));\n    if (y == F::e0())\n      continue;\n    \n    if (c.empty())\n\
    \    {\n      c.assign(i + 1, F::e0());\n      pos = i;\n      x = y;\n      continue;\n\
    \    }\n\n    S z = F::mul(y, F::inv(x));\n    int d2 = i - pos + b.size();\n\
    \    vc<S> tmp;\n    if (d2 >= d)\n    {\n      tmp = c;\n      c.resize(d2, F::e0());\n\
    ...
    \  return c;\n}\n#line 5 \"math/linalg/bbla.hpp\"\n\n/**\n * @brief Black Box\
    \ Linear Algebra\n * @docs docs/math/linalg/bbla.md\n */\n\n// https://yukicoder.me/wiki/black_box_linear_algebra\n\
    \nnamespace bbla\n{\n\ntemplate <class mint>\nmint random_sample_mint() { return\
    \ randrange(1, mint::mod()); }\n\n// \u7DDA\u578B\u5199\u50CF linear_map: S^n\
    \ \u2192 S^n \u306E\u6700\u5C0F\u591A\u9805\u5F0F\u3092\u6C42\u3081\u308B\n//\
    \ linear_map \u306F void(vc<S>) \u3068\u3057\u3066\u6E21\u3059 (\u7834\u58CA\u7684\
    \u306B\u5909\u66F4\u3059\u308B\u95A2\u6570)\n// \u6642\u9593\u8A08\u7B97\u91CF\
    : O(n^2 + nt), t \u306F linear_map \u306E\u8A08\u7B97\u91CF\ntemplate <class F,\
    \ class LinearMap, class RandomSample = decltype(random_sample_mint<typename F::S>)>\n\
    vc<typename F::S> minimal_polynomial(int n, const LinearMap &linear_map, const\
    \ RandomSample &random_sample = random_sample_mint)\n{\n  using S = typename F::S;\n\
    \  assert(n > 0);\n  vc<S> u(n, F::e0()), v(n, F::e0());\n  repi(j, n) u[j] =\
    \ random_sample(), v[j] = random_sample();\n  vc<S> a(2 * n + 1, F::e0());\n \
    \ repi(i, 2 * n + 1)\n  {\n    S sm = F::e0();\n    repi(j, n) sm = F::add(sm,\
    \ F::mul(u[j], v[j]));\n    a[i] = sm;\n    linear_map(v);\n  }\n  return reversed(berlekamp_massey<F>(a));\n\
    }\n\n// \u7DDA\u578B\u5199\u50CF linear_map: S^n \u2192 S^n \u3068\u30D9\u30AF\
    \u30C8\u30EB y: S^n \u3092\u53D7\u3051\u53D6\u308A\u3001\n// \u7DDA\u578B\u65B9\
    \u7A0B\u5F0F y = linear_map(x) \u3092\u89E3\u304F\n// linear_map \u306F void(vc<S>)\
    \ \u3068\u3057\u3066\u6E21\u3059 (\u7834\u58CA\u7684\u306B\u5909\u66F4\u3059\u308B\
    \u95A2\u6570)\n// \u5236\u7D04: linear_map \u306F\u975E\u7279\u7570\n// \u6642\
    ...
    \ F::S>)>\nvc<typename F::S> solve(const LinearMap &linear_map, vc<typename F::S>\
    \ y, const RandomSample &random_sample = random_sample_mint)\n{\n  using S = typename\
    \ F::S;\n  const int n = y.size();\n  if (n == 0)\n    return {};\n  auto m =\
    ...
    \ = typename larger_int<T>::type;\n#line 2 \"math/modint/modint_internal_isprime.hpp\"\
    \n\n#line 4 \"math/modint/modint_internal_isprime.hpp\"\n\n#line 6 \"math/modint/modint_internal_isprime.hpp\"\
    \n\nnamespace internal\n{\n\ntemplate <class T>\nconstexpr ll powmod_constexpr(ll\
    \ x, ll n, T m)\n{\n  if (m == 1)\n    return 0;\n  using U = make_unsigned_t<T>;\n\
    \  using L = larger_int_t<U>;\n\n  U r = 1, y = safemod(x, m);\n  while (n)\n\
    \  {\n    if (n & 1)\n      r = L(r) * y % m;\n    y = L(y) * y % m;\n    n >>=\
    \ 1;\n  }\n  return r;\n}\n\ntemplate <class T>\nconstexpr bool isprime_constexpr(T\
    \ n)\n{\n  if constexpr (sizeof(T) > 4)\n  {\n    if (n <= INT_MAX)\n      return\
    \ isprime_constexpr<int>(n);\n  }\n\n  if (n <= 1)\n    return false;\n  if (n\
    \ == 2 || n == 7 || n == 61)\n    return true;\n  if (n % 2 == 0)\n    return\
    \ false;\n\n  ll d = n - 1;\n  while (d % 2 == 0)\n    d /= 2;\n\n  using U =\
    \ make_unsigned_t<T>;\n  using L = larger_int_t<U>;\n\n  auto miller_rabin = [&](const\
    \ auto &bases) constexpr\n  {\n    for (ll a : bases)\n    {\n      ll t = d,\
    \ y = powmod_constexpr(a, t, n);\n      while (t != n - 1 && y != 1 && y != n\
    \ - 1)\n      {\n        y = L(y) * y % n;\n        t <<= 1;\n      }\n      if\
    \ (y != n - 1 && t % 2 == 0)\n        return false;\n    }\n    return true;\n\
    \  };\n\n  if constexpr(sizeof(T) <= 4)\n  {\n    constexpr ll bases[3] = {2,\
    \ 7, 61};\n    return miller_rabin(bases);\n  }\n  else\n  {\n    constexpr ll\
    \ bases[7] = {2, 325, 9375, 28178, 450775, 9780504, 1795265022};\n    return miller_rabin(bases);\n\
    ...
    \ mod_type mod() { return M; }\n  static constexpr value_type umod() { return\
    \ M; }\n\n  static constexpr value_type init(value_type v) { return v; }\n  static\
    \ constexpr mod_type val(value_type v) { return v; }\n  static constexpr value_type\
    \ mul(value_type a, value_type b)\n  {\n    return (value_type)((calc_type(a)\
    ...
    \ b[i][j]);\n    return *this;\n  }\n  M &operator-=(const M &b)\n  {\n    assert(shape<int>()\
    \ == b.shape<int>());\n    auto [n, m] = shape<int>();\n    repi(i, n) repi(j,\
    \ m) (*this)[i][j] = F::add((*this)[i][j], F::minus(b[i][j]));\n    return *this;\n\
    ...
    \ = (*this)[i][j];\n          if (cnt == 0)\n            cand = x, cnt = 1;\n\
    \          else if (cand == x)\n            cnt++;\n          else\n         \
    \   cnt--;\n        }\n        int k = n * n;\n        repi(i, n) repi(j, n) if\
    \ ((*this)[i][j] == cand) k--;\n        if (k < n * n / 8)\n          return det_sparse(cand);\n\
    \      }\n    }\n    return get<2>(row_reduction());\n  }\n  // \u6B63\u65B9\u884C\
    \u5217\n  // \u8981\u7D20\u6570\u3092 k \u3068\u3057\u3066 O(n^2 + nk)\n  template\
    \ <class RandomSample = decltype(bbla::random_sample_mint<typename F::S>)>\n \
    \ S det_sparse(const S &majority = F::e0(), const RandomSample &random_sample\
    \ = bbla::random_sample_mint) const\n  {\n    auto [n, m] = shape<int>();\n  \
    \  assert(n == m);\n    vc<pair<int, pair<int, S>>> elms;\n    const S minus_majority\
    \ = F::minus(majority);\n    repi(i, n) repi(j, n)\n    {\n      S val = (*this)[i][j];\n\
    \      if (val != majority)\n        elms.eb(i, pair{j, F::add(val, minus_majority)});\n\
    \    }\n    CSR<pair<int, S>> csr(n, elms);\n    auto linear_map = [&](vc<S> &x)\n\
    \    {\n      S sm = F::e0();\n      fec(xi : x) sm = F::add(sm, xi);\n      sm\
    \ = F::mul(majority, sm);\n      vc<S> y(n, sm);\n      repi(i, n)\n      {\n\
    \        S yi = sm;\n        fec([j, val] : csr[i]) yi = F::add(yi, F::mul(val,\
    \ x[j]));\n        y[i] = yi;\n      }\n      swap(x, y);\n    };\n    return\
    \ bbla::det<F>(n, linear_map, random_sample);\n  }\n\n  // \u6B63\u65B9\u884C\u5217\
    \n  // (\u5B58\u5728\u3059\u308B\u304B, \u5B58\u5728\u3059\u308B\u5834\u5408\u9006\
    \u884C\u5217)\n  pair<bool, M> inv() const\n  {\n    auto [n, m] = shape<int>();\n\
    \    assert(n == m);\n    M a(n, 2 * n);\n    repi(i, n) repi(j, n) a[i][j] =\
    \ (*this)[i][j];\n    repi(i, n) a[i][n + i] = F::e1();\n    M b = get<0>(a.row_reduction(true));\n\
    \    repi(i, n) if (b[i][i] == F::e0()) return {false, {}};\n    M res(n, n);\n\
    \    repi(i, n) repi(j, n) res[i][j] = b[i][n + j];\n    return {true, res};\n\
    \  }\n\n  // (\u89E3\u304C\u5B58\u5728\u3059\u308B\u304B, \u89E3\u306E\u3072\u3068\
    \u3064, \u57FA\u5E95)\n  // O(nm min(n, m) + m^2)\n  tuple<bool, V, vc<V>> solve(const\
    \ V &b) const\n  {\n    auto [n, m] = shape<int>();\n    assert(SZ(b) == n);\n\
    ...
    \u6728\u306E\u500B\u6570\n// g \u306B\u306F\u96A3\u63A5\u884C\u5217 (\u8FBA\u306E\
    \u672C\u6570) \u3092\u6E21\u3059\n// \u884C\u5217\u5F0F\u306E\u8A08\u7B97\u3001\
    O(n^3) \u306A\u3069\ntemplate <class mint, class I>\nmint count_spanning_trees_directed(const\
    \ vvc<I> &g, int r)\n{\n  const int n = g.size();\n  if (n == 0)\n    return 1;\n\
    \  repi(i, n) assert(SZ(g[i]) == n);\n  Matrix<FieldAddSubMulDiv<mint>> mat(n\
    \ - 1, n - 1);\n  repi(i, r) repi(j, r)\n  {\n    if (i == j)\n      continue;\n\
    \    mat[i][j] = -g[i][j];\n    mat[j][j] += g[i][j];\n  }\n  repi(i, r) repi(j,\
    \ r + 1, n)\n  {\n    mat[i][j - 1] = -g[i][j];\n    mat[j - 1][j - 1] += g[i][j];\n\
    \  }\n  repi(j, r) mat[j][j] += g[r][j];\n  repi(j, r + 1, n) mat[j - 1][j - 1]\
    ...
    \u7ACB\u70B9\u3092\u9664\u53BB\n  int k = 0;\n  vc<int> id(n, -1);\n  repi(i,\
    \ n) if (indeg[i] != 0 || outdeg[i] != 0) id[i] = k++;\n  vvc<I> h(k, vc<I>(k,\
    \ 0));\n  repi(i, n) repi(j, n)\n  {\n    if (g[i][j] == 0)\n      continue;\n\
    \    h[id[i]][id[j]] = g[i][j];\n  }\n  if (k == 0)\n    return 1;\n  repi(i,\
    \ n) if (indeg[i] != outdeg[i]) return 0;\n  // \u5B64\u7ACB\u70B9\u3092\u9664\
    \u3044\u3066\u9023\u7D50\u3067\u306A\u3044\u306A\u3089 0\n  int cnt_visited =\
    \ 1;\n  vb visited(k, false);\n  visited[0] = true;\n  MyQueue<int> que;\n  que.push(0);\n\
    \  while (!que.empty())\n  {\n    int i = que.front();\n    que.pop();\n    repi(j,\
    \ k)\n    {\n      if (h[i][j] == 0)\n        continue;\n      if (visited[j])\n\
    \        continue;\n      visited[j] = true;\n      cnt_visited++;\n      if (cnt_visited\
    \ == k)\n        break;\n      que.push(j);\n    }\n    if (cnt_visited == k)\n\
    \      break;\n  }\n  if (cnt_visited < k)\n    return 0;\n\n  mint res = count_spanning_trees_directed<mint>(h,\
    \ 0);\n  repi(i, n) if (indeg[i] != 0) res *= Binomial<mint>::fac(indeg[i] - 1);\n\
    \  return res;\n}\n\n// \u6709\u5411\u30B0\u30E9\u30D5\u306E\u30AA\u30A4\u30E9\
    \u30FC\u8DEF\u306E\u500B\u6570\n// g \u306B\u306F\u96A3\u63A5\u884C\u5217 (\u8FBA\
    \u306E\u672C\u6570) \u3092\u6E21\u3059\n// \u884C\u5217\u5F0F\u306E\u8A08\u7B97\
    \ O(n^3) \u306A\u3069 + \u968E\u4E57\u524D\u8A08\u7B97 O(max{\u5165\u6B21\u6570\
    })\ntemplate <class mint, class I>\nmint count_eularian_trails(const vvc<I> &g)\n\
    {\n  const int n = g.size();\n  repi(i, n) assert(SZ(g[i]) == n);\n  vc<int> indeg(n,\
    \ 0), outdeg(n, 0);\n  repi(i, n) repi(j, n) indeg[j] += g[i][j], outdeg[i] +=\
    \ g[i][j];\n  const int m = SUM(indeg);\n  if (m == 0)\n    return 1;\n  int u\
    \ = -1, v = -1;\n  repi(i, n)\n  {\n    if (indeg[i] - outdeg[i] == 1)\n    {\n\
    \      if (u != -1)\n        return 0;\n      u = i;\n    }\n    else if (indeg[i]\
    \ - outdeg[i] == -1)\n    {\n      if (v != -1)\n        return 0;\n      v =\
    \ i;\n    }\n    else\n    {\n      if (indeg[i] - outdeg[i] != 0)\n        return\
    \ 0;\n    }\n  }\n  if (u == -1 && v == -1)\n    return count_eularian_circuits<mint>(g)\
    \ * m;\n  else if (u != -1 && v != -1)\n  {\n    auto h = g;\n    h[u][v]++;\n\
...
layout: document
redirect_from:
- /library/graph/matrix_tree.hpp
- /library/graph/matrix_tree.hpp.html
title: "\u884C\u5217\u6728\u5B9A\u7406\u306A\u3069"
---
## 行列木定理など
