...
data:
  ...
  attributes:
    _deprecated_at_docs: docs/graph/tree/cartesian_tree.md
    document_title: Cartesian Tree
    links: []
  bundledCode: "#line 2 \"graph/tree/cartesian_tree.hpp\"\n\n#line 2 \"template/template_all_but_modint.hpp\"\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 4 \"graph/tree/cartesian_tree.hpp\"\n\n\
    ...
    \u306A\u308B [l, r) \u306E\u6761\u4EF6: seg_l[i] <= l <= i and i < r <= seg_r[i]\n\
    \n    int par, chi_l, chi_r, seg_l, seg_r;\n    Node() {}\n    Node(int par, int\
    \ chi_l, int chi_r, int seg_l, int seg_r)\n    : par(par), chi_l(chi_l), chi_r(chi_r),\
    \ seg_l(seg_l), seg_r(seg_r) {}\n  };\n  vector<Node> nodes;\n\n  template <class\
    \ I = ll>\n  struct ChildList\n  {\n    I data[2];\n    int sz = 0;\n    const\
    \ I *begin() const { return data; }\n    const I *end() const { return data +\
    \ sz; }\n  };\n\npublic:\n  CartesianTree() {}\n  template <class T, class Compare\
    \ = less<T>>\n  CartesianTree(const vector<T> &a, Compare comp = Compare{}) :\
    \ n(a.size()), nodes(n, Node(-1, -1, -1, -1, n))\n  {\n    vc<int> sta;  // stack\
    \ \u306B\u306F\u300C\u53F3\u306B\u4F38\u3073\u3066\u3044\u308B\u3084\u3064\u300D\
    \u3092\u6301\u3064\n    repi(i, n)\n    {\n      int p = -1, c = -1;  // p: i\
    \ \u306E\u89AA\u3001c: i \u306E\u5B50\n      while (!sta.empty())\n      {\n \
    \       int j = sta.back();\n        if (comp(a[j], a[i]))\n        {\n      \
    ...
    \ res;\n  }\n\n  // i \u304C argmin \u3068\u306A\u308B [l, r) \u306E\u6761\u4EF6\
    : seg_l[i] <= l <= i and i < r <= seg_r[i]\n  template <class I = ll>\n  pair<I,\
    \ I> range(int i) const\n  {\n    assert(0 <= i && i < n);\n    return {nodes[i].seg_l,\
