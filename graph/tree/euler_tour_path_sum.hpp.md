...
data:
  ...
  attributes:
    _deprecated_at_docs: docs/graph/tree/euler_tour_path_sum.md
    document_title: "\u6728\u306E\u30AA\u30A4\u30E9\u30FC\u30C4\u30A2\u30FC\u3067\u30D1\
      \u30B9\u306E\u7DCF\u548C\u30AF\u30A8\u30EA\u3092\u51E6\u7406"
    links: []
  bundledCode: "#line 2 \"graph/tree/euler_tour_path_sum.hpp\"\n\n#line 2 \"template/template_all_but_modint.hpp\"\
  ...
  code: "#pragma once\n\n#include \"../../template/template_all_but_modint.hpp\"\n\
    ...
    \ + 1] = G::inv(vec[i]);\n    }\n    fw = DS(fw_init);\n  }\n\npublic:\n  PathSum()\
    \ {}\n  template <class I, class T>\n  PathSum(int n, const vc<I> &par, const\
    \ vc<T> &vec = {})\n    : EulerTour<need_lca, RMQ>(n, par)\n  {\n    build(vec);\n\
    \  }\n  template <class P, class T>\n  PathSum(int n, const vc<P> &es, int rt,\
...
documentation_of: graph/tree/euler_tour_path_sum.hpp
layout: document
redirect_from:
- /library/graph/tree/euler_tour_path_sum.hpp
- /library/graph/tree/euler_tour_path_sum.hpp.html
title: "\u6728\u306E\u30AA\u30A4\u30E9\u30FC\u30C4\u30A2\u30FC\u3067\u30D1\u30B9\u306E\
  \u7DCF\u548C\u30AF\u30A8\u30EA\u3092\u51E6\u7406"
---
