...
data:
  ...
  bundledCode: "#line 2 \"graph/tree/diameter.hpp\"\n\n#line 2 \"template/template_all_but_modint.hpp\"\
    ...
    \ n, const vc<Pair> &es, const vc<Cost> &costs)\n{\n  assert(all_of(ALL(costs),\
    \ [](const Cost &x) { return x >= 0; }));\n  RootedTree g(n, es, 0);\n  vc<Cost>\
    \ wds0 = g.weighted_depths(g.reordered_edge_info(es, costs));\n  int a = ARGMAX(GEN_VEC(n,\
    \ i, wds0[i]));\n  RootedTree ga(n, es, a);\n  vc<Cost> wdsa = ga.weighted_depths(ga.reordered_edge_info(es,\
