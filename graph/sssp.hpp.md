...
data:
  ...
  bundledCode: "#line 2 \"graph/sssp.hpp\"\n\n#line 2 \"template/template_all_but_modint.hpp\"\
    ...
    \    dists[s] = 0;\n    que.push(s);\n    while (!que.empty())\n    {\n      auto\
    \ v = que.front();\n      que.pop();\n      if (v == t)\n        break;\n    \
    \  fe(e : out_edges(v))\n      {\n        if (chmin(dists[e.to], dists[e.from]\
    \ + e.cost))\n        {\n          prv[e.to] = e;\n          que.push(e.to);\n\
    \        }\n      }\n    }\n    return dists;\n  }\n\n  vc<Cost> bfs01(int s,\
    \ int t = -1)\n  {\n    const int n = size();\n    assert(0 <= s && s < n);\n\
    \    init_solve(s, t);\n    dists.assign(n, infty);\n    prv.assign(n, {});\n\
    ...
    \u3089 v \u3078\u306E\u6700\u77ED\u30D1\u30B9\u306E\u3072\u3068\u3064\u3067 v\
    \ \u306B\u884C\u304F\u305F\u3081\u306B\u4F7F\u3063\u305F\u8FBA (\u306A\u3051\u308C\
    \u3070 from=-1, to=-1, cost=-1)\n  // (t \u3092\u6307\u5B9A\u3057\u3066\u6253\u3061\
    \u5207\u3063\u3066\u3044\u305F\u5834\u5408\u3001t \u306B\u5230\u9054\u3059\u308B\
    \u6700\u77ED\u30D1\u30B9\u306E\u3072\u3068\u3064\u3067\u4F7F\u3063\u305F\u8FBA\
    \u306F\u6B63\u3057\u304F\u8A18\u9332\u3055\u308C\u308B)\n  vc<Edge<Cost>> prev_edges()\n\
    \  {\n    const int n = size();\n    assert(SZ(dists) == n && \"solve(s, t) is\
    \ not called\");\n    return prv;\n  }\n\n  // solve(s, t) \u306E\u5F8C\u306B\u547C\
    \u3076\n  // (sssp \u306E\u5B9F\u884C\u3067 t \u3092\u6307\u5B9A\u3057\u3066\u6253\
    \u3061\u5207\u3063\u3066\u3044\u3066\u3082\u52D5\u4F5C\u3059\u308B)\n  vc<Edge<Cost>>\
    \ path(int t)\n  {\n    const int n = size();\n    assert(SZ(dists) == n && \"\
    solve(s, t) is not called\");\n    vc<Edge<Cost>> res;\n    while (true)\n   \
    \ {\n      cauto &e = prv[t];\n      if (e.index == -1)\n        break;\n    \
    \  t = e.from;\n      res.eb(e.rev());\n    }\n    return rev_path(res);\n  }\n\
    \n  // cnt[v] := s \u304B\u3089 v \u3078\u306E\u6700\u77ED\u30D1\u30B9\u306E\u500B\
    \u6570\n  // (**sssp \u306E\u5B9F\u884C\u3067 t \u3092\u6307\u5B9A\u3057\u3066\
    \u6253\u3061\u5207\u3063\u3066\u3044\u3066\u306F\u3044\u3051\u306A\u3044**)\n\
    \  template <class mint>\n  vc<mint> count_paths()\n  {\n    const int n = size();\n\
    \    assert(SZ(dists) == n && source != -1 && \"solve(s) is not called\");\n \
    \   assert(solved_all && \"solve(s, t) must not stop at t\");\n    assert(dists[source]\
    \ != -infty && \"the shortest-path graph must be finite\");\n    vc<mint> cnt(n,\
    \ 0);\n    vc<int> indeg(n, 0);\n    int active = 0;\n    repi(v, n) if (dists[v]\
    \ != infty && dists[v] != -infty) active++;\n    repi(v, n)\n    {\n      if (dists[v]\
    \ == infty || dists[v] == -infty)\n        continue;\n      fec(e : out_edges(v))\n\
    \      {\n        if (dists[e.to] != infty && dists[e.to] != -infty &&\n     \
    \       dists[e.to] == dists[e.from] + e.cost)\n          indeg[e.to]++;\n   \
    \   }\n    }\n    MyQueue<int> que;\n    repi(v, n) if (dists[v] != infty && dists[v]\
    \ != -infty && indeg[v] == 0) que.push(v);\n    cnt[source] = 1;\n    int processed\
    \ = 0;\n    while (!que.empty())\n    {\n      auto v = que.front();\n      que.pop();\n\
    \      processed++;\n      fec(e : out_edges(v))\n      {\n        if (dists[e.to]\
    \ != infty && dists[e.to] != -infty &&\n            dists[e.to] == dists[e.from]\
    \ + e.cost)\n        {\n          cnt[e.to] += cnt[e.from];\n          if (--indeg[e.to]\
    \ == 0)\n            que.push(e.to);\n        }\n      }\n    }\n    assert(processed\
    \ == active && \"the shortest-path graph must be a DAG\");\n    return cnt;\n\
    \  }\n};\n"
  code: "#pragma once\n\n#include \"../template/template_all_but_modint.hpp\"\n\n\
    ...
    // - SPFA \u7B49\n\ntemplate <bool is_directed, class Cost, const Cost infty =\
    \ INF>\nstruct ShortestPath : Graph<is_directed, Cost>\n{\n  using Graph<is_directed,\
    \ Cost>::Graph;\n  using Graph<is_directed, Cost>::size;\n  using Graph<is_directed,\
    \ Cost>::num_of_edges;\n  using Graph<is_directed, Cost>::out_edges;\n  using\
    \ Graph<is_directed, Cost>::edges;\n\nprivate:\n  vc<Cost> dists;\n  vc<Edge<Cost>>\
    ...
    \ (!que.empty())\n    {\n      auto v = que.front();\n      que.pop();\n     \
    \ if (v == t)\n        break;\n      fe(e : out_edges(v))\n      {\n        if\
    \ (chmin(dists[e.to], dists[e.from] + e.cost))\n        {\n          prv[e.to]\
    \ = e;\n          que.push(e.to);\n        }\n      }\n    }\n    return dists;\n\
    ...
    \ {\n        Cost nd = dists[e.from] + e.cost;\n        if (chmin(dists[e.to],\
    \ nd))\n        {\n          prv[e.to] = e;\n          pque.push({nd, e.to});\n\
    \        }\n      }\n    }\n    return dists;\n  }\n\n  vc<Cost> dijkstra_dense(int\
    \ s, int t = -1)\n  {\n    const int n = size();\n    assert(0 <= s && s < n);\n\
    \    init_solve(s, t);\n    dists.assign(n, infty);\n    prv.assign(n, {});\n\
    \    vc<bool> ok(n, false);\n    dists[s] = 0;\n    repi(_, n)\n    {\n      Cost\
    \ mn = infty;\n      int v = -1;\n      repi(u, n) if (!ok[u] && chmin(mn, dists[u]))\
    \ v = u;\n      if (v == -1)\n        break;\n      if (v == t)\n        break;\n\
    \      ok[v] = true;\n      fec(e : out_edges(v))\n      {\n        if (chmin(dists[e.to],\
    \ dists[e.from] + e.cost))\n          prv[e.to] = e;\n      }\n    }\n    return\
    \ dists;\n  }\n\n  // \u6700\u77ED\u306E\u30A6\u30A9\u30FC\u30AF\u3068\u3057\u3066\
    ...
    \ infty);\n    prv.assign(n, {});\n    dists[s] = 0;\n    repi(t, 2 * n)\n   \
    \ {\n      repi(v, n)\n      {\n        if (dists[v] == infty)\n          continue;\n\
    \        fec(e : out_edges(v))\n        {\n          Cost nd = dists[v] == -infty\
    \ ? -infty : dists[v] + e.cost;\n          if (dists[e.to] > nd)\n          {\n\
    \            prv[e.to] = e;\n            if (t == n - 1)\n              dists[e.to]\
    \ = -infty;\n            else\n              dists[e.to] = nd;\n          }\n\
    \        }\n      }\n    }\n    return dists;\n  }\n\n  vc<Cost> solve(int s,\
    \ int t = -1)\n  {\n    bool neg = false;\n    int zcnt = 0;\n    Cost wplus1\
...
layout: document
redirect_from:
- /library/graph/sssp.hpp
- /library/graph/sssp.hpp.html
title: "\u5358\u4E00\u59CB\u70B9\u6700\u77ED\u8DEF\u554F\u984C"
---
## 単一始点最短路問題
