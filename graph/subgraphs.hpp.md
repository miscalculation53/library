...
data:
  ...
  attributes:
    _deprecated_at_docs: docs/graph/subgraphs.md
    document_title: "\u90E8\u5206\u30B0\u30E9\u30D5\u3078\u306E\u5206\u89E3"
    links: []
  bundledCode: "#line 2 \"graph/subgraphs.hpp\"\n\n#line 2 \"template/template_all_but_modint.hpp\"\
    ...
    \u3059\n// \u3082\u3068\u306E\u30B0\u30E9\u30D5\u306E\u9802\u70B9 u <-> \u90E8\
    \u5206\u30B0\u30E9\u30D5 l \u306E\u9802\u70B9 i \u306E\u5BFE\u5FDC\u306F\n// u\
    \ = grp.idxs[l][i]  (GroupIndex \u3092\u4F7F\u3046)\n// l = ids[u], i = nvids[u]\n\
    template <bool is_directed, class Cost, class I>\npair<vc<Graph<is_directed, Cost>>,\
    \ vc<I>> subgraphs(const Graph<is_directed, Cost> &g, const vc<I> &ids)\n{\n \
    \ const int n = g.size();\n  assert(SZ(ids) == n);\n  const int k = MAX(ids) +\
    \ 1;\n  vc<I> nvids(n), cnt(k);\n  repi(u, n) nvids[u] = cnt[ids[u]]++;\n  vc<Graph<is_directed,\
    \ Cost>> graphs(k);\n  {\n    vc<pair<int, int>> uvs(k);\n    fec(e : g.edges())\n\
    \    {\n      if (ids[e.from] == ids[e.to])\n        uvs[ids[e.from]].eb(nvids[e.from],\
    \ nvids[e.to]);\n    }\n    repi(l, k) graphs[l] = Graph<is_directed, cost>(cnt[l],\
    \ uvs[l]);\n  }\n  return {graphs, nvids};\n}\n"
  code: "#pragma once\n\n#include \"../template/template_all_but_modint.hpp\"\n\n\
    ...
    \ i = nvids[u]\ntemplate <bool is_directed, class Cost, class I>\npair<vc<Graph<is_directed,\
    \ Cost>>, vc<I>> subgraphs(const Graph<is_directed, Cost> &g, const vc<I> &ids)\n\
    {\n  const int n = g.size();\n  assert(SZ(ids) == n);\n  const int k = MAX(ids)\
    \ + 1;\n  vc<I> nvids(n), cnt(k);\n  repi(u, n) nvids[u] = cnt[ids[u]]++;\n  vc<Graph<is_directed,\
    \ Cost>> graphs(k);\n  {\n    vc<pair<int, int>> uvs(k);\n    fec(e : g.edges())\n\
    \    {\n      if (ids[e.from] == ids[e.to])\n        uvs[ids[e.from]].eb(nvids[e.from],\
  ...
  verifiedWith: []
documentation_of: graph/subgraphs.hpp
layout: document
redirect_from:
- /library/graph/subgraphs.hpp
- /library/graph/subgraphs.hpp.html
title: "\u90E8\u5206\u30B0\u30E9\u30D5\u3078\u306E\u5206\u89E3"
---
## 部分グラフへの分解
