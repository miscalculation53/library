...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/poly_shift_of_sampling_points.test.cpp\"\n\
    ...
    \ c); }\n};\n#line 18 \"verify/yosupo/poly_shift_of_sampling_points.test.cpp\"\
    ...
    \ main2()\n{\n  LL(N, M);\n  IN(mint, c);\n  VEC(mint, N, y);\n  auto z = shift_of_sampling_points_many(y,\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 39 \"verify/yosupo/poly_shift_of_sampling_points.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/yosupo/poly_shift_of_sampling_points.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo/poly_shift_of_sampling_points.test.cpp
- /verify/verify/yosupo/poly_shift_of_sampling_points.test.cpp.html
