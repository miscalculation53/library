...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/matrix_solve_array.test.cpp\"\n#define PROBLEM\
    ...
    \    else\n      return std::hash<mint>{}(x);\n  }\n};\n#line 18 \"verify/yosupo/matrix_solve_array.test.cpp\"\
    ...
    \ N) rep(j, M) A.at(i).at(j) = A_.at(i).at(j);\n  array<mint, MX> b{};\n  rep(i,\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 66 \"verify/yosupo/matrix_solve_array.test.cpp\"\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/system_of_linear_equations\"\
    ...
    void init() {}\n\nvoid main2()\n{\n  LL(N, M);\n  VEC2(mint, N, M, A_);\n  VEC(mint,\
    \ N, b_);\n  const int MX = local_oj(4, 500);\n  MatrixArray<FieldAddSubMulDiv<mint>,\
  ...
  verifiedWith: []
documentation_of: verify/yosupo/matrix_solve_array.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo/matrix_solve_array.test.cpp
- /verify/verify/yosupo/matrix_solve_array.test.cpp.html
