...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/vertex_set_path_composite_euler_tour.test.cpp\"\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 17 \"verify/yosupo/vertex_set_path_composite_euler_tour.test.cpp\"\
    ...
    \ auto inv = Gmul::inv;\n};\n#line 13 \"graph/tree/euler_tour_path_prod.hpp\"\n\
    \n// G \u306F\u7FA4\n// \u6839\u304B\u3089\u306E\u30D1\u30B9\u3060\u3051\u306A\
    \u3089 LCA \u3044\u3089\u306A\u3044\ntemplate <\n  class G,\n  bool need_lca =\
    ...
    \ n, const vc<I> &par, const vc<T> &vec = {})\n    : EulerTour<need_lca, RMQ>(n,\
    \ par)\n  {\n    build(vec);\n  }\n  template <class P, class T>\n  PathProd(int\
    \ n, const vc<P> &es, int rt, const vc<T> &vec = {})\n    : EulerTour<need_lca,\
    \ RMQ>(n, es, rt)\n  {\n    build(vec);\n  }\n\n  S get(int v) const\n  {\n  \
    ...
    \  {\n    assert(0 <= u && u < this->n);\n    assert(0 <= v && v < this->n);\n\
    \    int w = this->lca(u, v);\n    S up = seg2.prod(this->in[w] + 1, this->in[u]\
