...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/vertex_set_path_composite_euler_tour.test.cpp\"\
    ...
    \ res[i] = randint<T>(T(l), T(r) - T(k));\n  sort(ALL(res));\n  repi(i, k) res[i]\
    \ += i;\n  if (!does_sort)\n    shuffle(ALL(res), mt);\n  return res;\n}\n#line\
    \ 17 \"verify/yosupo/vertex_set_path_composite_euler_tour.test.cpp\"\n\n#line\
    \ 2 \"math/modint/modint.hpp\"\n\n#line 4 \"math/modint/modint.hpp\"\n\n#line\
    \ 2 \"math/modint/modint_internal_static.hpp\"\n\n#line 4 \"math/modint/modint_internal_static.hpp\"\
    ...
    \    else\n      return std::hash<mint>{}(x);\n  }\n};\n#line 19 \"verify/yosupo/vertex_set_path_composite_euler_tour.test.cpp\"\
    \nusing mint = modint998244353;\n\n#line 2 \"graph/tree/euler_tour_path_prod.hpp\"\
    \n\n#line 4 \"graph/tree/euler_tour_path_prod.hpp\"\n\n/**\n * @brief \u6728\u306E\
    \u30AA\u30A4\u30E9\u30FC\u30C4\u30A2\u30FC\u3067\u30D1\u30B9\u306E\u7DCF\u7A4D\
    \u30AF\u30A8\u30EA\u3092\u51E6\u7406\n * @docs docs/graph/tree/euler_tour_path_prod.md\n\
    \ */\n\n#line 2 \"graph/tree/euler_tour.hpp\"\n\n#line 4 \"graph/tree/euler_tour.hpp\"\
    \n\n/**\n * @brief \u6728\u306E\u30AA\u30A4\u30E9\u30FC\u30C4\u30A2\u30FC\n *\
    ...
    \n\n#line 4 \"ds/static_range/sparse_table.hpp\"\n\n/**\n * @brief Sparse Table\n\
    \ * @docs docs/ds/static_range/sparse_table.md\n */\n\n// M \u306F\u51AA\u7B49\
    \ (max, min, and, or, gcd, lcm \u306A\u3069)\ntemplate <class M>\nstruct SparseTable\n\
    {\n  using S = typename M::S;\n\nprivate:\n  int n;\n  // dat[j][i] = prod[i,\
    \ i+2^j)\n  vvc<S> dat;\n\npublic:\n  SparseTable() {}\n  SparseTable(const vc<S>\
    ...
    \ + 1, j)), cl[r]);\n    else\n      return v[i * B + lsb_pos(bit[r - 1] & ~((Word(1)\
    \ << (l % B)) - 1))];\n  }\n};\n#line 11 \"graph/tree/euler_tour.hpp\"\n\ntemplate\
    \ <bool need_lca = true, class RMQ = BlockSparseTable<MonoidMin<ull>, 64>>\nstruct\
    \ EulerTour\n{\nprotected:\n  int n, rt;\n  vc<int> in, out, tour, dep;\n  RMQ\
    \ rmq;\n\n  inline int first(ull x) const { return x >> 32; }\n  inline int second(ull\
    \ x) const { return uint(x); }\n\n  template <class I>\n  void build(const vc<int>\
    \ &siz, const vc<I> &par)\n  {\n    vc<int> ord(n);\n    {\n      vc<int> cnt(n\
    \ + 1);\n      repi(i, n) cnt[siz[i]]++;\n      cnt = cumlsum(cnt);\n      repi(i,\
    \ n) ord[n - 1 - (cnt[siz[i]]++)] = i;\n    }\n    {\n      vc<int> add(n, 0);\n\
    \      dep.assign(n, 0);\n      in[rt] = 0, out[rt] = 2 * n - 2, tour[0] = rt,\
    \ dep[rt] = 0;\n      repi(i, 1, n)\n      {\n        int v = ord[i], p = par[v];\n\
    \        dep[v] = dep[p] + 1;\n        in[v] = in[p] + 1 + 2 * add[p];\n     \
    \   add[p] += siz[v];\n        out[v] = in[v] + 2 * siz[v] - 2;\n        tour[in[v]]\
    \ = v;\n        tour[out[v] + 1] = p;\n      }\n      if constexpr (need_lca)\n\
    \      {\n        vc<ull> rmq_init(2 * n - 1);\n        repi(i, 2 * n - 1) rmq_init[i]\
    \ = (ull(dep[tour[i]]) << 32) | tour[i];\n        rmq = RMQ(rmq_init);\n     \
    \   dep.clear();\n      }\n    }\n  }\n\npublic:\n  EulerTour() {}\n  template\
    ...
    \    bool operator==(const ChildIterator& r) const { return cur == r.cur; }\n\
    \  };\n\n  class ChildRange\n  {\n  private:\n    const EulerTour* t;\n    int\
    \ start_pos, end_pos;\n\n    friend class EulerTour;\n    ChildRange(const EulerTour*\
    \ t, int start_pos, int end_pos)\n      : t(t), start_pos(start_pos), end_pos(end_pos)\
    ...
    \ { return vc<int>(begin(), end()); }\n  };\n\n  ChildRange children(int v) const\n\
    \  {\n    assert(0 <= v && v < n);\n    return ChildRange(this, in[v] + 1, out[v]\
    \ + 1);\n  }\n\n  // \u8FBA (u, v) \u304C\u5B58\u5728\u3059\u308B\u3068\u3057\u3066\
    ...
    \ }\n\npublic:\n  SegmentTree() {}\n  SegmentTree(int n) : SegmentTree(vc<S>(n,\
    \ M::e())) {}\n  template <class Iter>\n  SegmentTree(const Iter &bg, const Iter\
    \ &ed) : SegmentTree(vc<S>(bg, ed)) {}\n  template <class T>\n  SegmentTree(const\
    \ vc<T> &vec) : n(vec.size()), siz(bit_ceil(vec.size())), dat(2 * siz, M::e())\n\
    ...
    \ DS2 = SegmentTree<OppositeGroup<G>>,\n  class RMQ = BlockSparseTable<MonoidMin<ull>,\
    ...
    \ {}\n  template <class I, class T>\n  PathProd(int n, const vc<I> &par, const\
    \ vc<T> &vec = {})\n    : EulerTour<true>(n, par)\n  {\n    build(vec);\n  }\n\
    \  template <class P, class T>\n  PathProd(int n, const vc<P> &es, int rt, const\
    \ vc<T> &vec = {})\n    : EulerTour<true>(n, es, rt)\n  {\n    build(vec);\n \
    \ }\n\n  S get(int v) const\n  {\n    assert(0 <= v && v < this->n);\n    return\
    \ seg1.get(this->in[v]);\n  }\n  void set(int v, const S &x)\n  {\n    assert(0\
    \ <= v && v < this->n);\n    S ix = G::inv(x);\n    seg1.set(this->in[v], x),\
    \ seg1.set(this->out[v] + 1, ix);\n    seg2.set(this->in[v], x), seg2.set(this->out[v]\
    \ + 1, ix);\n  }\n  // \u6839\u304B\u3089\n  S prod(int v) const\n  {\n    assert(0\
    \ <= v && v < this->n);\n    return seg1.prod(0, this->in[v] + 1);\n  }\n  S prod(int\
    \ u, int v) const\n  {\n    assert(0 <= u && u < this->n);\n    assert(0 <= v\
    \ && v < this->n);\n    int w = this->lca(u, v);\n    S up = seg2.prod(this->in[w]\
    ...
    \ b);\n#endif\n#line 23 \"verify/yosupo/vertex_set_path_composite_euler_tour.test.cpp\"\
    \n\nvoid init() {}\n\nvoid main2()\n{\n  LL(N, Q);\n  VEC(pll, N, AB);\n  VEC(pll,\
    \ N - 1, UV);\n  PathProd<OppositeGroup<GroupAffineFunction<mint>>> G(N, UV, randrange(0,\
    \ N), AB);\n  rep(_, Q)\n  {\n    LL(t);\n    if (t == 0)\n    {\n      LL(p,\
    \ c, d);\n      G.set(p, {c, d});\n    }\n    else if (t == 1)\n    {\n      LL(u,\
    \ v, x);\n      auto [c, d] = G.prod(u, v);\n      PRINT(c * x + d);\n    }\n\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 52 \"verify/yosupo/vertex_set_path_composite_euler_tour.test.cpp\"\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/vertex_set_path_composite\"\
    ...
    {\n  LL(N, Q);\n  VEC(pll, N, AB);\n  VEC(pll, N - 1, UV);\n  PathProd<OppositeGroup<GroupAffineFunction<mint>>>\
    \ G(N, UV, randrange(0, N), AB);\n  rep(_, Q)\n  {\n    LL(t);\n    if (t == 0)\n\
    \    {\n      LL(p, c, d);\n      G.set(p, {c, d});\n    }\n    else if (t ==\
    \ 1)\n    {\n      LL(u, v, x);\n      auto [c, d] = G.prod(u, v);\n      PRINT(c\
  ...
  verifiedWith: []
documentation_of: verify/yosupo/vertex_set_path_composite_euler_tour.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo/vertex_set_path_composite_euler_tour.test.cpp
- /verify/verify/yosupo/vertex_set_path_composite_euler_tour.test.cpp.html
