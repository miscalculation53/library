...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/represent_a_number_as_two_square_sum.cpp\"\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 2 \"math/two_square_sum.hpp\"\n\n#line\
    \ 4 \"math/two_square_sum.hpp\"\n\n#line 2 \"math/modint/modint.hpp\"\n\n#line\
    ...
    }\n#line 2 \"math/svp2d.hpp\"\n\n#line 4 \"math/svp2d.hpp\"\n\n#line 6 \"math/svp2d.hpp\"\
    \n\n/**\n * @brief \u6700\u77ED\u30D9\u30AF\u30C8\u30EB\u554F\u984C\uFF08$2$ \u6B21\
    \u5143\uFF09\n * @docs docs/math/svp2d.md\n */\n\n// \u5165\u529B: a = (a1, a2),\
    \ b = (b1, b2)\n// \u51FA\u529B: \u6574\u6570 x, y \u3092\u7528\u3044\u3066 v\
    \ = (v1, v2) = xa + yb \u3068\u8868\u3055\u308C\u308B\u30D9\u30AF\u30C8\u30EB\u306E\
    \u3046\u3061\u3001\n//      \u30CE\u30EB\u30E0\u306E 2 \u4E57 v1^2 + v2^2 \u304C\
    \u6700\u5C0F\u306E\u3082\u306E\u306E\u3072\u3068\u3064 (\u7B26\u53F7\u306F\u4E0D\
    \u5B9A)\n// T \u306F\u6574\u6570\u3001U \u306F T \u306E 2 \u500D\u306E\u30D3\u30C3\
    \u30C8\u6570\n// \u521D\u671F\u5024\u306E \u221A2 \u500D\u304C T \u304B\u3089\u6EA2\
    \u308C\u306A\u3044\u306A\u3089\u6B63\u3057\u304F\u52D5\u304F\ntemplate <class\
    \ T = ll, class U = larger_int_t<T>>\npair<T, T> svp2d(const pair<T, T> &a, const\
    \ pair<T, T> &b)\n{\n  assert((a != pair<T, T>{0, 0} && b != pair<T, T>{0, 0}));\n\
    \  auto [a1, a2] = a;\n  auto [b1, b2] = b;\n  if ((U)a1 * a1 + (U)a2 * a2 < (U)b1\
    \ * b1 + (U)b2 * b2)\n    swap(a1, b1), swap(a2, b2);\n  while ((U)a1 * a1 + (U)a2\
    \ * a2 > (U)b1 * b1 + (U)b2 * b2)\n  {\n    swap(a1, b1), swap(a2, b2);\n    T\
    \ k = divround<U>((U)a1 * b1 + (U)a2 * b2, (U)a1 * a1 + (U)a2 * a2);\n    b1 -=\
    \ k * a1, b2 -= k * a2;\n    if (b1 == 0 && b2 == 0)\n      return {a1, a2};\n\
    \  }\n  return {a1, a2};\n}\n#line 8 \"math/two_square_sum.hpp\"\n\n/**\n * @brief\
    \ \u4E8C\u5E73\u65B9\u548C\n * @docs docs/math/two_square_sum.md\n */\n\n// \u7D20\
    \u6570 p \u306B\u5BFE\u3057\u3001p = a^2 + b^2 \u3068\u306A\u308B (a, b)\n// \u306E\
    \u3046\u3061 0 <= a <= b \u3067\u3042\u308B\u3082\u306E (1 \u901A\u308A) \u3092\
    \u6C42\u3081\u308B\n// (\u5B58\u5728\u3059\u308B\u304B, \u30DA\u30A2)\n// \u8868\
    \u3057\u65B9\u304C\u5B58\u5728\u3057\u306A\u3044 <=> p \u304C 4n+3 \u578B\u7D20\
    \u6570\ntemplate <class T>\npair<bool, pair<T, T>> two_square_sum_prime(T p)\n\
    {\n  assert(is_prime(p));\n  if (p == 2)\n    return {true, {1, 1}};\n  if (p\
    \ % 4 == 3)\n    return {false, {}};\n  ll i;\n  if (p <= INT_MAX)\n  {\n    using\
    \ mint = dynamic_modint32<INT_MIN>;\n    mint::set_mod(p);\n    mint ii = 1;\n\
    \    rep(v, 2, p)\n    {\n      ii = mint(v).pow((p - 1) / 4);\n      if (ii *\
    \ ii == p - 1)\n        break;\n    }\n    i = ii.val();\n  }\n  else\n  {\n \
    \   using mint = dynamic_modint64_odd<INT_MIN>;\n    mint::set_mod(p);\n    mint\
    \ ii = 1;\n    rep(v, 2, p)\n    {\n      ii = mint(v).pow((p - 1) / 4);\n   \
    ...
    }\n\n// \u6574\u6570 n \u306B\u5BFE\u3057 n = a^2 + b^2 \u3068\u306A\u308B\u6B63\
    \u6574\u6570 a, b \u306E\u7D44 (0 <= a <= b) \u3092\u3059\u3079\u3066\u6C42\u3081\
    ...
    \    nans.clear();\n    fec([ a, b ] : ans)\n    {\n      nans.eb(minmax({abs(a\
    \ * d - b * c), a * c + b * d}));\n      nans.eb(minmax({abs(a * c - b * d), a\
    \ * d + b * c}));\n    }\n    swap(ans, nans);\n    sortunique(ans);\n  }\n  return\
    \ ans;\n}\n#line 18 \"verify/yosupo/represent_a_number_as_two_square_sum.cpp\"\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 37 \"verify/yosupo/represent_a_number_as_two_square_sum.cpp\"\
...
layout: document
redirect_from:
- /library/verify/yosupo/represent_a_number_as_two_square_sum.cpp
- /library/verify/yosupo/represent_a_number_as_two_square_sum.cpp.html
