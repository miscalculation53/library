...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/cycle_detection_undirected.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/cycle_detection_undirected\"\n\n#define\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 17 \"verify/yosupo/cycle_detection_undirected.test.cpp\"\
    \n\n#line 2 \"graph/cycle_detection.hpp\"\n\n#line 4 \"graph/cycle_detection.hpp\"\
    ...
    \ (false, \u7A7A)\n// \u30B5\u30A4\u30AF\u30EB\u304C\u3042\u308C\u3070 (true,\
    \ \u30B5\u30A4\u30AF\u30EB\u306E\u8FBA\u3092\u4E26\u3079\u305F\u914D\u5217)\n\
    template <bool is_directed, class Cost>\npair<bool, vc<Edge<Cost>>> cycle_detection(const\
    \ Graph<is_directed, Cost> &g)\n{\n  const int n = g.size();\n  vc<bool> seen(n,\
    ...
    \      dfs(dfs, e.to);\n    }\n    finished[v] = true;\n  };\n\n  repi(sv, n)\n\
    \  {\n    if (finished[sv])\n      continue;\n    dfs(dfs, sv);\n    if (!res.empty())\n\
    \      break;\n  }\n  if (res.empty())\n    return {false, {}};\n  int v = res.front().from,\
    \ w = res.front().to;\n  while (v != w)\n  {\n    cauto &e = prv[v];\n    res.eb(e);\n\
    \    v = e.from;\n  }\n  return {true, reversed(res)};\n}\n#line 19 \"verify/yosupo/cycle_detection_undirected.test.cpp\"\
    \n\nvoid init() {}\n\nvoid main2()\n{\n  LL(N, M);\n  VEC(pll, M, UV);\n  GraphUndirected<ll>\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 45 \"verify/yosupo/cycle_detection_undirected.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/yosupo/cycle_detection_undirected.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo/cycle_detection_undirected.test.cpp
- /verify/verify/yosupo/cycle_detection_undirected.test.cpp.html
