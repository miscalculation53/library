...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/matrix_det_array.test.cpp\"\n#define PROBLEM\
    ...
    \    else\n      return std::hash<mint>{}(x);\n  }\n};\n#line 18 \"verify/yosupo/matrix_det_array.test.cpp\"\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 36 \"verify/yosupo/matrix_det_array.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/yosupo/matrix_det_array.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo/matrix_det_array.test.cpp
- /verify/verify/yosupo/matrix_det_array.test.cpp.html
