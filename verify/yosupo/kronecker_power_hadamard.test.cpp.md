...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/kronecker_power_hadamard.test.cpp\"\n#define\
    ...
    \ res[i] = randrange<T>(T(l), T(r) - T(k));\n  sort(ALL(res));\n  repi(i, k) res[i]\
    \ += i;\n  if (!does_sort)\n    shuffle(ALL(res), mt);\n  return res;\n}\n#line\
    \ 15 \"verify/yosupo/kronecker_power_hadamard.test.cpp\"\n\n#line 2 \"math/modint/modint.hpp\"\
    ...
    \ k>(mat, v_);\n  return v_;\n}\n#line 20 \"verify/yosupo/kronecker_power_hadamard.test.cpp\"\
    ...
    \ MULTI_TESTCASE\n    CERR(\"\\n[MULTI_TESTCASE]\\n\\n\", \"33\");\n    dump(\"\
    T\");\n    IN(uint, T);\n    while (T--)\n    {\n      dump(\"new testcase\");\n\
    \      main2();\n    }\n    #endif\n  }\n};\n#line 47 \"verify/yosupo/kronecker_power_hadamard.test.cpp\"\
