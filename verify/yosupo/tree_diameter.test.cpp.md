...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/tree_diameter.test.cpp\"\n#define PROBLEM\
    ...
    \ */\n\n// (a, b, ga)\n// a, b: \u7AEF\u70B9\u3001ga: a \u3092\u6839\u3068\u3059\
    \u308B\u6839\u3064\u304D\u6728\ntemplate <class Pair>\ntuple<int, int, RootedTree>\
    \ tree_diameter(int n, const vc<Pair> &es)\n{\n  RootedTree g(n, es, 0);\n  int\
    \ a = ARGMAX(GEN_VEC(n, i, g.depth(i)));\n  RootedTree ga(n, es, a);\n  int b\
    \ = ARGMAX(GEN_VEC(n, i, ga.depth(i)));\n  return {a, b, ga};\n}\n\n// (a, b,\
    \ ga, wdsa)\n// a, b: \u7AEF\u70B9\u3001ga: a \u3092\u6839\u3068\u3059\u308B\u6839\
    \u3064\u304D\u6728\u3001wdsa: a \u3092\u6839\u3068\u3057\u305F\u3068\u304D\u306E\
    \u5404\u9802\u70B9\u306E\u91CD\u307F\u3064\u304D\u6DF1\u3055\ntemplate <class\
    \ Pair, class Cost>\ntuple<int, int, RootedTree, vc<Cost>> tree_diameter_weighted(int\
    \ n, const vc<Pair> &es, const vc<Cost> &costs)\n{\n  assert(MIN(costs) >= 0);\n\
    \  RootedTree g(n, es, 0);\n  vc<Cost> wds0 = g.weighted_depths(g.reordered_edge_info(es,\
    ...
    \ 19 \"verify/yosupo/tree_diameter.test.cpp\"\n\nvoid init() {}\n\nvoid main2()\n\
    {\n  LL(N);\n  VEC(tlll, N - 1, ABC);\n  UNZIP(ABC, A, B, C);\n  ZIP(AB, A, B);\n\
    \  RootedTree G(N, AB, 0);\n\n  auto [a, b, Ga, Da] = tree_diameter_weighted(N,\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 42 \"verify/yosupo/tree_diameter.test.cpp\"\
