...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/kronecker_power_zeta_mobius.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/bitwise_and_convolution\"\n\n#define\
    ...
    \    else\n      return std::hash<mint>{}(x);\n  }\n};\n#line 19 \"verify/yosupo/kronecker_power_zeta_mobius.test.cpp\"\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 53 \"verify/yosupo/kronecker_power_zeta_mobius.test.cpp\"\
...
layout: document
redirect_from:
- /verify/verify/yosupo/kronecker_power_zeta_mobius.test.cpp
- /verify/verify/yosupo/kronecker_power_zeta_mobius.test.cpp.html
