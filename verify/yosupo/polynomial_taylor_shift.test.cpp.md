...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/polynomial_taylor_shift.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/polynomial_taylor_shift\"\n\n#define\
    ...
    \ c); }\n};\n#line 18 \"verify/yosupo/polynomial_taylor_shift.test.cpp\"\nusing\
    \ mint = modint998244353;\nusing fps = FormalPowerSeries<mint>;\n#line 2 \"math/fps/taylor_shift.hpp\"\
    ...
    \ * g.egf()).pre(n).rev().egf();\n}\n#line 21 \"verify/yosupo/polynomial_taylor_shift.test.cpp\"\
    \n\nvoid init() {}\n\nvoid main2()\n{\n  LL(N);\n  IN(mint, c);\n  VEC(mint, N,\
    \ a);\n  fps f(a);\n  fps g = taylor_shift(f, c);\n  PRINT(g);\n}\n\nvoid test()\n\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 40 \"verify/yosupo/polynomial_taylor_shift.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/yosupo/polynomial_taylor_shift.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo/polynomial_taylor_shift.test.cpp
- /verify/verify/yosupo/polynomial_taylor_shift.test.cpp.html
