...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/unionfind_potential_non_commutative.test.cpp\"\
    ...
    \ res[i] = randint<T>(T(l), T(r) - T(k));\n  sort(ALL(res));\n  repi(i, k) res[i]\
    \ += i;\n  if (!does_sort)\n    shuffle(ALL(res), mt);\n  return res;\n}\n#line\
    \ 17 \"verify/yosupo/unionfind_potential_non_commutative.test.cpp\"\n\n#line 2\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 55 \"verify/yosupo/unionfind_potential_non_commutative.test.cpp\"\
...
layout: document
redirect_from:
- /verify/verify/yosupo/unionfind_potential_non_commutative.test.cpp
- /verify/verify/yosupo/unionfind_potential_non_commutative.test.cpp.html
