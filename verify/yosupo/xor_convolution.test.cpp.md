...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/xor_convolution.test.cpp\"\n#define PROBLEM\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 2 \"math/set/xor_convolution.hpp\"\n\n\
    ...
    \n// G \u306F\u53EF\u63DB\u7FA4\n// \u7834\u58CA\u7684\u5909\u66F4\u3092\u884C\
    \u3046\ntemplate <class G>\nvoid hadamard_abel_group_destructive(vc<typename G::S>\
    ...
    \ b_);\n  return a_;\n}\n#line 18 \"verify/yosupo/xor_convolution.test.cpp\"\n\
    ...
    \    else\n      return std::hash<mint>{}(x);\n  }\n};\n#line 20 \"verify/yosupo/xor_convolution.test.cpp\"\
    \nusing mint = modint998244353;\n\nvoid init() {}\n\nvoid main2()\n{\n  LL(N);\n\
    \  VEC(mint, 1 << N, A, B);\n  auto C = xor_convolution<FieldAddSubMulDiv<mint>>(A,\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 35 \"verify/yosupo/xor_convolution.test.cpp\"\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/bitwise_xor_convolution\"\
    ...
    \ init() {}\n\nvoid main2()\n{\n  LL(N);\n  VEC(mint, 1 << N, A, B);\n  auto C\
    \ = xor_convolution<FieldAddSubMulDiv<mint>>(A, B);\n  PRINT(C);\n}\n\nvoid test()\
  ...
  verifiedWith: []
documentation_of: verify/yosupo/xor_convolution.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo/xor_convolution.test.cpp
- /verify/verify/yosupo/xor_convolution.test.cpp.html
