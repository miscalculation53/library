...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/lca_euler_tour.test.cpp\"\n#define PROBLEM\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 17 \"verify/yosupo/lca_euler_tour.test.cpp\"\
    ...
    \  {\n    assert(0 <= u && u < n);\n    assert(0 <= v && v < n);\n    return in[u]\
    \ <= in[v] && out[v] <= out[u];\n  }\n};\n#line 19 \"verify/yosupo/lca_euler_tour.test.cpp\"\
    \n\nvoid init() {}\n\nvoid main2()\n{\n  LL(N, Q);\n  VEC(ll, N - 1, P);\n  P.insert(P.begin(),\
    \ -1);\n  EulerTour G(N, P);\n  rep(_, Q)\n  {\n    LL(u, v);\n    PRINT(G.lca(u,\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 38 \"verify/yosupo/lca_euler_tour.test.cpp\"\
...
layout: document
redirect_from:
- /verify/verify/yosupo/lca_euler_tour.test.cpp
- /verify/verify/yosupo/lca_euler_tour.test.cpp.html
