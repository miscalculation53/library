...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/2d_segtree.test.cpp\"\n#define PROBLEM \"\
    ...
    \           l++;\n          }\n        }\n        return l - siz;\n      }\n \
    \   } while ((l & -l) != l);\n    return n;\n  }\n\n  // g \u304C\u5358\u8ABF\u306E\
    \u3068\u304D g( prod[l, r) ) == true \u3068\u306A\u308B\u6700\u5C0F\u306E l\n\
    \  // \u5236\u7D04: g( e() ) == true\n  template <class I = ll, class G>\n  I\
    \ min_left(int r, const G &g)\n  {\n    assert(0 <= r && r <= n);\n    assert(g(M::e()));\n\
    \    if (r == 0)\n      return 0;\n    r += siz;\n    S sm = M::e();\n    do\n\
    \    {\n      r--;\n      while (r > 1 && (r % 2))\n        r >>= 1;\n      if\
    \ (!g(M::op(dat[r], sm)))\n      {\n        while (r < siz)\n        {\n     \
    \     r = 2 * r + 1;\n          if (g(M::op(dat[r], sm)))\n          {\n     \
    ...
    \u52D5\u3067\u306F\u3084\u3089\u306A\u3044**\n// .\n// \u30BB\u30B0\u30E1\u30F3\
    \u30C8\u6728\u306B\u30C7\u30FC\u30BF\u69CB\u9020 DS \u3092\u8F09\u305B\u308B\n\
    // DS \u306F\u5178\u578B\u7684\u306B\u306F SegmentTree<M> \u3092\u8F09\u305B\u308B\
    \ (M \u306F 2 \u56DE\u66F8\u304F\u3053\u3068\u306B\u306A\u308B)\n// \u66F4\u65B0\
    \u304C\u306A\u3044\u306A\u3089 (disjoint) sparse table \u3068\u304B\u3082\n//\
    \ DS \u306B set, get, prod \u304C\u3042\u308B\u306A\u3089 set, get, prod \u304C\
    \u4F7F\u3048\u308B\n// I: \u5EA7\u6A19\u306E\u578B\ntemplate <class DS, class\
    ...
    \npublic:\n  SegmentTree2DSparse() {}\n  SegmentTree2DSparse(const vc<tuple<I,\
