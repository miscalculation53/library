...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/2d_segtree.test.cpp\"\n#define PROBLEM \"\
    ...
    \ vc<S> &vec) : n(vec.size()), siz(bit_ceil(vec.size())), dat(2 * siz, M::e())\n\
    ...
    **\n// .\n// \u30BB\u30B0\u30E1\u30F3\u30C8\u6728\u306B\u30C7\u30FC\u30BF\u69CB\
    ...
    \          continue;\n        S s = get(x, y);\n        if (s != M::e())\n   \
    \       res.eb(x, y, s);\n      }\n    }\n    return res;\n  }\n\n  #undef lb\n\
    };\n#line 18 \"verify/yosupo/2d_segtree.test.cpp\"\n\nvoid init() {}\n\nvoid main2()\n\
    {\n  LL(N, Q);\n  VEC(tlll, N, XYW);\n  vl X;\n  vc<tuple<ll, ll, ll, ll, ll>>\
    \ qs;\n  fec([ x, y, w ] : XYW) X.eb(x);\n  rep(_, Q)\n  {\n    LL(t);\n    if\
    \ (t == 0)\n    {\n      LL(x, y, w);\n      qs.eb(0, x, y, w, -1);\n      X.eb(x);\n\
    \    }\n    else if (t == 1)\n    {\n      LL(lx, ly, rx, ry);\n      qs.eb(1,\
    \ lx, rx, ly, ry);\n    }\n  }\n  sortunique(X);\n  vtlll IYW;\n  fec([ x, y,\
    \ w ] : XYW) IYW.eb(LB(X, x), y, w);\n  fec(q : qs)\n  {\n    ll t = get<0>(q);\n\
    \    if (t == 0)\n    {\n      auto &[_, x, y, w, __] = q;\n      IYW.eb(LB(X,\
    \ x), y, 0);\n    }\n  }\n\n  SegmentTree2DSparse<SegmentTree<MonoidAdd<ll>>,\
    \ MonoidAdd<ll>, ll> seg(IYW);\n  fec(q : qs)\n  {\n    ll t = get<0>(q);\n  \
    \  if (t == 0)\n    {\n      auto [_, x, y, w, __] = q;\n      int i = LB(X, x);\n\
    \      seg.set(i, y, seg.get(i, y) + w);\n    }\n    else if (t == 1)\n    {\n\
    \      auto [_, lx, rx, ly, ry] = q;\n      PRINT(seg.prod(LB(X, lx), LB(X, rx),\
    \ ly, ry));\n    }\n    dump(seg.content());\n  }\n}\n\nvoid test() {}\n\n#line\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 78 \"verify/yosupo/2d_segtree.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/yosupo/2d_segtree.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo/2d_segtree.test.cpp
- /verify/verify/yosupo/2d_segtree.test.cpp.html
