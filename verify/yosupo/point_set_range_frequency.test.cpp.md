...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/point_set_range_frequency.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/point_set_range_frequency\"\n\n#define\
    ...
    ** (\u306A\u3051\u308C\u3070 size())\n  template <class T, class I = ll>\n  inline\
    ...
    \ ri));\n      }\n    }\n    return res;\n  }\n};\n#line 18 \"verify/yosupo/point_set_range_frequency.test.cpp\"\
    \n\nvoid init() {}\n\nvoid main2()\n{\n  LL(N, Q);\n  VEC(ll, N, A);\n  PointSetRangeFrequency\
    \ rf(A);\n  rep(_, Q)\n  {\n    LL(t);\n    if (t == 0)\n    {\n      LL(k, v);\n\
    \      rf.point_set(k, v);\n    }\n    else if (t == 1)\n    {\n      LL(l, r,\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 49 \"verify/yosupo/point_set_range_frequency.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/yosupo/point_set_range_frequency.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo/point_set_range_frequency.test.cpp
- /verify/verify/yosupo/point_set_range_frequency.test.cpp.html
