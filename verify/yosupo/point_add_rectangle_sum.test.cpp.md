...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/point_add_rectangle_sum.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/point_add_rectangle_sum\"\n\n#define\
    ...
    \   qs[i] = P(x, y, f(res[qi]));\n        }\n      }\n      dfs(dfs, m, r, mi,\
    \ ri);\n    };\n    dfs(dfs, 0, qs.size(), 0, qn);\n    return res;\n  }\n};\n\
    #line 18 \"verify/yosupo/point_add_rectangle_sum.test.cpp\"\n\nvoid init() {}\n\
    \nvoid main2()\n{\n  LL(N, Q);\n  VEC(tlll, N, XYW);\n  PointAddRectangleSum<GroupAddSub<ll>,\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 51 \"verify/yosupo/point_add_rectangle_sum.test.cpp\"\
...
layout: document
redirect_from:
- /verify/verify/yosupo/point_add_rectangle_sum.test.cpp
- /verify/verify/yosupo/point_add_rectangle_sum.test.cpp.html
