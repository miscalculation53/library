...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/point_add_range_sum_sqrt.test.cpp\"\n#define\
    ...
    #line 18 \"verify/yosupo/point_add_range_sum_sqrt.test.cpp\"\n\nvoid init() {}\n\
    \nvoid main2()\n{\n  LL(N, Q);\n  VEC(ll, N, A);\n\n  SqrtDecompositionRangeSum<GroupAddSub<ll>>\
    \ sq(A);\n  rep(_, Q)\n  {\n    LL(t);\n    if (t == 0)\n    {\n      LL(p, x);\n\
    \      sq.add(p, x);\n    }\n    else if (t == 1)\n    {\n      LL(l, r);\n  \
    \    PRINT(sq.sum(l, r));\n    }\n  }\n}\n\nvoid test()\n{\n  \n}\n\n#line 2 \"\
    ...
    n[MULTI_TESTCASE]\\n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"\
    T\");\n      IN(uint, T);\n      while (T--)\n      {\n        dump(\"new testcase\"\
    );\n        main2();\n      }\n    }\n    #endif\n  }\n};\n#line 49 \"verify/yosupo/point_add_range_sum_sqrt.test.cpp\"\
...
layout: document
redirect_from:
- /verify/verify/yosupo/point_add_range_sum_sqrt.test.cpp
- /verify/verify/yosupo/point_add_range_sum_sqrt.test.cpp.html
