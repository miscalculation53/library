...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/enumerate_cliques.test.cpp\"\n#define PROBLEM\
    ...
    \    else\n      return std::hash<mint>{}(x);\n  }\n};\n#line 18 \"verify/yosupo/enumerate_cliques.test.cpp\"\
    ...
    \      adj[i][i] = true;\n      fec(e : g.out_edges(vs[i])) if (id[e.to] >= 0)\
    \ adj[i][id[e.to]] = true;\n    }\n    vc<int> cur;\n    auto dfs = [&](auto dfs,\
    \ int i) -> void\n    {\n      if (i == k)\n      {\n        if (!cur.empty())\n\
    \          f(GEN_VEC(cur.size(), h, I(vs[cur[h]])));\n        return;\n      }\n\
    \      if (i != j)\n        dfs(dfs, i + 1);\n      if (all_of(ALL(cur), [&](int\
    \ h) { return adj[i][h]; }))\n      {\n        cur.eb(i);\n        dfs(dfs, i\
    \ + 1);\n        cur.pop_back();\n      }\n    };\n    dfs(dfs, 0);\n    fec(v\
    \ : vs) id[v] = -1;\n  };\n  while (true)\n  {\n    repi(v, n + 1)\n    {\n  \
    \    if (v == n)\n      {\n        vc<int> vs;\n        repi(v, n) if (id[v] !=\
    \ -2) vs.eb(v);\n        check(vs, -1);\n        return;\n      }\n      if (id[v]\
    \ == -2)\n        continue;\n      vc<int> vs = {v};\n      vs.reserve(g.out_edges(v).size()\
    \ + 1);\n      fec(e : g.out_edges(v)) if (id[e.to] != -2) vs.eb(e.to);\n    \
    \  sortunique(vs);\n      const int k = vs.size();\n      if (k <= b)\n      {\n\
    \        check(vs, v);\n        id[v] = -2;\n        break;\n      }\n    }\n\
    \  }\n}\n#line 21 \"verify/yosupo/enumerate_cliques.test.cpp\"\n\nvoid init()\n\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 46 \"verify/yosupo/enumerate_cliques.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/yosupo/enumerate_cliques.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo/enumerate_cliques.test.cpp
- /verify/verify/yosupo/enumerate_cliques.test.cpp.html
