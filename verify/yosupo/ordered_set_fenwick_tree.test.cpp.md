...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/ordered_set_fenwick_tree.test.cpp\"\n#define\
    ...
    ** (\u306A\u3051\u308C\u3070 size())\n  template <class T, class I = ll>\n  inline\
    ...
    };\n#line 19 \"verify/yosupo/ordered_set_fenwick_tree.test.cpp\"\n\nvoid init()\
    \ {}\n\nvoid main2()\n{\n  LL(N, Q);\n  VEC(ll, N, A);\n  VEC(pll, Q, TX);\n \
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 83 \"verify/yosupo/ordered_set_fenwick_tree.test.cpp\"\
...
layout: document
redirect_from:
- /verify/verify/yosupo/ordered_set_fenwick_tree.test.cpp
- /verify/verify/yosupo/ordered_set_fenwick_tree.test.cpp.html
