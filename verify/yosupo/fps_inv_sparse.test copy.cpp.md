...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/fps_inv_sparse.test copy.cpp\"\n#define PROBLEM\
    ...
    \    return res;\n  }\n  // \u5404\u4FC2\u6570 a_n \u306B n! \u3092\u304B\u3051\
    \u305F\u3082\u306E\n  F ogf() const\n  {\n    F res(*this);\n    repi(i, sz())\
    \ res[i] *= Binomial<mint>::fac(i);\n    return res;\n  }\n};\n#line 18 \"verify/yosupo/fps_inv_sparse.test\
    \ copy.cpp\"\nusing mint = modint998244353;\nusing fps = FormalPowerSeries<mint>;\n\
    #line 2 \"math/fps/taylor_shift.hpp\"\n\n#line 4 \"math/fps/taylor_shift.hpp\"\
    \n\n#line 6 \"math/fps/taylor_shift.hpp\"\n\n/**\n * @brief Taylor Shift\n * @docs\
    \ docs/math/fps/taylor_shift.md\n */\n\n// f(x + c) \u3092\u8FD4\u3059\ntemplate\
    \ <class mint>\nFormalPowerSeries<mint> taylor_shift(const FormalPowerSeries<mint>\
    \ &f, const mint &c)\n{\n  const int n = f.size();\n  FormalPowerSeries<mint>\
    \ g(n);\n  g[0] = 1;\n  repi(i, 1, f.sz()) g[i] = c * g[i - 1];\n  return (f.ogf().rev()\
    \ * g.egf()).pre(n).rev().egf();\n}\n#line 21 \"verify/yosupo/fps_inv_sparse.test\
    \ copy.cpp\"\n\nvoid init() {}\n\nvoid main2()\n{\n  LL(N);\n  IN(mint, c);\n\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 40 \"verify/yosupo/fps_inv_sparse.test\
  ...
  verifiedWith: []
documentation_of: verify/yosupo/fps_inv_sparse.test copy.cpp
layout: document
redirect_from:
- /library/verify/yosupo/fps_inv_sparse.test copy.cpp
- /library/verify/yosupo/fps_inv_sparse.test copy.cpp.html
