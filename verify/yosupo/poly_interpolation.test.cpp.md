...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/poly_interpolation.test.cpp\"\n#define PROBLEM\
    ...
    \ c); }\n};\n#line 18 \"verify/yosupo/poly_interpolation.test.cpp\"\nusing mint\
    \ = modint998244353;\nusing bi = Binomial<mint>;\nusing fps = FormalPowerSeries<mint>;\n\
    #line 2 \"math/fps/interpolation.hpp\"\n\n#line 4 \"math/fps/interpolation.hpp\"\
    ...
    \ n).first;\n}\n#line 22 \"verify/yosupo/poly_interpolation.test.cpp\"\n\nvoid\
    \ init() {}\n\nvoid main2()\n{\n  LL(N);\n  VEC(mint, N, x, y);\n  PRINT(interpolation(x,\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 38 \"verify/yosupo/poly_interpolation.test.cpp\"\
...
layout: document
redirect_from:
- /verify/verify/yosupo/poly_interpolation.test.cpp
- /verify/verify/yosupo/poly_interpolation.test.cpp.html
