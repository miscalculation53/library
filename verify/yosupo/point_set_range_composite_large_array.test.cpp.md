...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/point_set_range_composite_large_array.test.cpp\"\
    ...
    #line 4 \"ds/segtree/sparse_segtree.hpp\"\n\n/**\n * @brief \u5FC5\u8981\u306A\
    \u3068\u3053\u308D\u3060\u3051\u4F5C\u308B\u30BB\u30B0\u30E1\u30F3\u30C8\u6728\
    ...
    \ a = c;\n    }\n    return M::e();\n  }\n\n  // [l, r)\n  S prod(ll l, ll r)\
    \ const\n  {\n    assert(0 <= l && l <= r && r <= n);\n    auto dfs = [&](auto\
    \ dfs, ll a, ll b, int i) -> S\n    {\n      if (i == -1)\n        return M::e();\n\
    \      if (b <= l || r <= a)\n        return M::e();\n      if (l <= a && b <=\
    \ r)\n        return nodes[i].prod;\n      ll c = a + (b - a) / 2;\n      S sml\
    \ = dfs(dfs, a, c, nodes[i].chi[0]);\n      S smm = l <= nodes[i].p && nodes[i].p\
    ...
    \        return -1;\n      ll c = a + (b - a) / 2;\n      ll res = dfs(dfs, c,\
    \ b, nodes[i].chi[1]);\n      if (res != -1)\n        return res;\n      if (nodes[i].p\
    \ != -1 && nodes[i].p < r && !prepend(nodes[i].val))\n        return nodes[i].p;\n\
