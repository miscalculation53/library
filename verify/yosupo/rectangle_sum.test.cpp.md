...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/rectangle_sum.test.cpp\"\n#define PROBLEM\
    ...
    \ }\n};\n#line 18 \"verify/yosupo/rectangle_sum.test.cpp\"\n\nvoid init() {}\n\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 40 \"verify/yosupo/rectangle_sum.test.cpp\"\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/rectangle_sum\"\n\n#define\
    ...
    {\n  LL(N, Q);\n  VEC(tlll, N, XYW);\n  VEC(tllll, Q, LXLYRXRY);\n\n  RectangleSum<GroupAddSub<ll>,\
    \ ll> rs;\n  fec([ x, y, w ] : XYW) rs.point_add(x, y, w);\n  fec([ lx, ly, rx,\
    \ ry ] : LXLYRXRY) rs.rectangle_sum(lx, rx, ly, ry);\n  auto res = rs.run();\n\
  ...
  verifiedWith: []
documentation_of: verify/yosupo/rectangle_sum.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo/rectangle_sum.test.cpp
- /verify/verify/yosupo/rectangle_sum.test.cpp.html
