...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/counting_eularian_circuits.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/counting_eulerian_circuits\"\n\n#define\
    ...
    \    else\n      return std::hash<mint>{}(x);\n  }\n};\n#line 18 \"verify/yosupo/counting_eularian_circuits.test.cpp\"\
    ...
    #line 20 \"verify/yosupo/counting_eularian_circuits.test.cpp\"\n\nvoid init()\
    \ {}\n\nvoid main2()\n{\n  LL(N, M);\n  VEC(pll, M, UV);\n  GraphDirected<bool>\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 35 \"verify/yosupo/counting_eularian_circuits.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/yosupo/counting_eularian_circuits.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo/counting_eularian_circuits.test.cpp
- /verify/verify/yosupo/counting_eularian_circuits.test.cpp.html
