...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/big_integer_addition_hex.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/addition_of_hex_big_integers\"\n\n\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 17 \"verify/yosupo/big_integer_addition_hex.test.cpp\"\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 32 \"verify/yosupo/big_integer_addition_hex.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/yosupo/big_integer_addition_hex.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo/big_integer_addition_hex.test.cpp
- /verify/verify/yosupo/big_integer_addition_hex.test.cpp.html
