...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/convolution.test.cpp\"\n#define PROBLEM \"\
    ...
    \    else\n      return std::hash<mint>{}(x);\n  }\n};\n#line 18 \"verify/yosupo/convolution.test.cpp\"\
    ...
    \  repi(i, c.size()) c_[i] = c[i].val();\n  return c_;\n}\n#line 21 \"verify/yosupo/convolution.test.cpp\"\
    \n\nvoid init() {}\n\nvoid main2()\n{\n  LL(N, M);\n  VEC(mint, N, A);\n  VEC(mint,\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 36 \"verify/yosupo/convolution.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/yosupo/convolution.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo/convolution.test.cpp
- /verify/verify/yosupo/convolution.test.cpp.html
