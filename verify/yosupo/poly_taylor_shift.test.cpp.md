...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/poly_taylor_shift.test.cpp\"\n#define PROBLEM\
    ...
    \ c); }\n};\n#line 18 \"verify/yosupo/poly_taylor_shift.test.cpp\"\nusing mint\
    ...
    \ * g.egf()).pre(n).rev().egf();\n}\n#line 21 \"verify/yosupo/poly_taylor_shift.test.cpp\"\
    \n\nvoid init() {}\n\nvoid main2()\n{\n  LL(N);\n  IN(mint, c);\n  VEC(mint, N,\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 40 \"verify/yosupo/poly_taylor_shift.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/yosupo/poly_taylor_shift.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo/poly_taylor_shift.test.cpp
- /verify/verify/yosupo/poly_taylor_shift.test.cpp.html
