...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/gcd_convolution.test.cpp\"\n#define PROBLEM\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 17 \"verify/yosupo/gcd_convolution.test.cpp\"\
    ...
    \    else\n      return std::hash<mint>{}(x);\n  }\n};\n#line 19 \"verify/yosupo/gcd_convolution.test.cpp\"\
    ...
    }\n#line 22 \"verify/yosupo/gcd_convolution.test.cpp\"\n\nvoid init() {}\n\nvoid\
    \ main2()\n{\n  LL(N);\n  VEC(mint, N, A, B);\n  A.insert(A.begin(), 0);\n  B.insert(B.begin(),\
    \ 0);\n  auto C = gcd_convolution<RingAddSubMul<mint>>(A, B);\n  C.erase(C.begin());\n\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 42 \"verify/yosupo/gcd_convolution.test.cpp\"\
...
layout: document
redirect_from:
- /verify/verify/yosupo/gcd_convolution.test.cpp
- /verify/verify/yosupo/gcd_convolution.test.cpp.html
