...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/range_affine_range.sum.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/range_affine_range_sum\"\n\n#define\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 17 \"verify/yosupo/range_affine_range.sum.test.cpp\"\
    ...
    \    else\n      return std::hash<mint>{}(x);\n  }\n};\n#line 19 \"verify/yosupo/range_affine_range.sum.test.cpp\"\
    ...
    \ sm)))\n          {\n            sm = AM::op(dat[r], sm);\n            r--;\n\
    \          }\n        }\n        return r + 1 - siz;\n      }\n      sm = AM::op(dat[r],\
    \ sm);\n    } while ((r & -r) != r);\n    return 0;\n  }\n};\n#line 2 \"math/algebra/acted_monoid/affine_sum.hpp\"\
    \n\n#line 4 \"math/algebra/acted_monoid/affine_sum.hpp\"\n\n#line 6 \"math/algebra/acted_monoid/affine_sum.hpp\"\
    \n\n/**\n * @brief \u4F5C\u7528\u3064\u304D\u30E2\u30CE\u30A4\u30C9\uFF1A\u4E00\
    ...
    \ a, S b) { return {a.len + b.len, a.val + b.val}; }\n  static constexpr S e()\
    \ { return {0, 0}; }\n  struct F\n  {\n    T b, c;\n    F() {}\n    F(T b, T c)\
    \ : b(b), c(c) {}\n  };\n  static constexpr S mapping(F f, S x) { return {x.len,\
    ...
    #endif\n#line 23 \"verify/yosupo/range_affine_range.sum.test.cpp\"\n\nvoid init()\n\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 57 \"verify/yosupo/range_affine_range.sum.test.cpp\"\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/range_affine_range_sum\"\
    ...
    }\n\nvoid main2()\n{\n  LL(N, Q);\n  VEC(mint, N, A);\n  LazySegmentTree<ActedMonoidAffineSum<mint>>\
    \ seg(ALL(A));\n  rep(_, Q)\n  {\n    LL(t);\n    if (t == 0)\n    {\n      LL(l,\
    \ r, b, c);\n      seg.apply(l, r, {b, c});\n    }\n    else if (t == 1)\n   \
  ...
  verifiedWith: []
documentation_of: verify/yosupo/range_affine_range.sum.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo/range_affine_range.sum.test.cpp
- /verify/verify/yosupo/range_affine_range.sum.test.cpp.html
