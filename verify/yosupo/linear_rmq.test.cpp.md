...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/linear_rmq.test.cpp\"\n#define PROBLEM \"\
    ...
    \ - 1] & ~((Word(1) << (l % B)) - 1))];\n  }\n};\n#line 19 \"verify/yosupo/linear_rmq.test.cpp\"\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 37 \"verify/yosupo/linear_rmq.test.cpp\"\
...
layout: document
redirect_from:
- /verify/verify/yosupo/linear_rmq.test.cpp
- /verify/verify/yosupo/linear_rmq.test.cpp.html
