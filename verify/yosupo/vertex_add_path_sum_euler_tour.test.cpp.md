...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/vertex_add_path_sum_euler_tour.test.cpp\"\n\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 17 \"verify/yosupo/vertex_add_path_sum_euler_tour.test.cpp\"\
    \n\n#line 2 \"graph/tree/euler_tour_path_sum.hpp\"\n\n#line 4 \"graph/tree/euler_tour_path_sum.hpp\"\
    \n\n/**\n * @brief \u6728\u306E\u30AA\u30A4\u30E9\u30FC\u30C4\u30A2\u30FC\u3067\
    ...
    };\n#line 12 \"graph/tree/euler_tour_path_sum.hpp\"\n\n// G \u306F\u53EF\u63DB\
    \u7FA4 (\u53EF\u63DB\u6027\u306E\u8981\u6C42\u306F Fenwick Tree \u306B\u7531\u6765\
    )\n// \u6839\u304B\u3089\u306E\u30D1\u30B9\u3060\u3051\u306A\u3089 LCA \u3044\u3089\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 47 \"verify/yosupo/vertex_add_path_sum_euler_tour.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/yosupo/vertex_add_path_sum_euler_tour.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo/vertex_add_path_sum_euler_tour.test.cpp
- /verify/verify/yosupo/vertex_add_path_sum_euler_tour.test.cpp.html
