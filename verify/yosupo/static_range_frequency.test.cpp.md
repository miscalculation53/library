...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/static_range_frequency.test.cpp\"\n#define\
    ...
    \ res[i] = randrange<T>(T(l), T(r) - T(k));\n  sort(ALL(res));\n  repi(i, k) res[i]\
    \ += i;\n  if (!does_sort)\n    shuffle(ALL(res), mt);\n  return res;\n}\n#line\
    \ 15 \"verify/yosupo/static_range_frequency.test.cpp\"\n\n#line 2 \"ds/coordinate_compression.hpp\"\
    ...
    };\n#line 18 \"verify/yosupo/static_range_frequency.test.cpp\"\n\nvoid init()\
    \ {}\n\nvoid main2()\n{\n  LL(N, Q);\n  VEC(ll, N, A);\n  CoordinateCompression\
    ...
    \ MULTI_TESTCASE\n    CERR(\"\\n[MULTI_TESTCASE]\\n\\n\", \"33\");\n    dump(\"\
    T\");\n    IN(uint, T);\n    while (T--)\n    {\n      dump(\"new testcase\");\n\
    \      main2();\n    }\n    #endif\n  }\n};\n#line 41 \"verify/yosupo/static_range_frequency.test.cpp\"\
