...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/rectangle_add_point_get.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/rectangle_add_point_get\"\n\n#define\
    ...
    \ }\n  // \u524D\u306E rectangle sum \u306E\u30AF\u30A8\u30EA\u3092\u53C2\u7167\
    \u3057\u305F\u91CD\u307F\u306E\u70B9\u3092\u8FFD\u52A0\n  // f \u306F S(S) \u3067\
    \u3001res[qi] \u3092\u5F15\u6570\u306B\u3068\u308A\u3001\u91CD\u307F\u3092\u8FD4\
    \u3059\u95A2\u6570\n  template <class F>\n  void point_add_fn(I x, I y, int qi,\
    \ F f)\n  {\n    qs.eb(PF(x, y, qi, f));\n  }\n  // (-\u221E, rx) \xD7 (-\u221E\
    , ry) \u306E\u91CD\u307F\u548C\u3092\u7B54\u3048\u308B\u30AF\u30A8\u30EA\u3092\
    \u8FFD\u52A0\n  void rectangle_sum(I rx, I ry)\n  {\n    qs.eb(Q(rx, ry));\n \
    \   qn++;\n  }\n  // \u30AF\u30A8\u30EA\u306B\u307E\u3068\u3081\u3066\u7B54\u3048\
    \u308B\n  vc<S> run()\n  {\n    vc<S> res(qn, M::e());\n    auto dfs = [&](auto\
    \ dfs, int l, int r, int li, int ri) -> void\n    {\n      if (r - l == 1)\n \
    \       return;\n      const int m = (l + r) / 2;\n      int mi = li;\n      repi(i,\
    ...
    \ rx, ly, ry);\n        }\n      }\n      vc<S> tmp = rs.run();\n      repi(i,\
    \ mi, ri) res[i] = G::op(res[i], tmp[i - mi]);\n      repi(i, m, r)\n      {\n\
    \        if (holds_alternative<PF>(qs[i]))\n        {\n          cauto & [ x,\
    \ y, qi, f ] = get<PF>(qs[i]);\n          if (li <= qi && qi < mi)\n         \
    \   qs[i] = P(x, y, f(res[qi]));\n        }\n      }\n      dfs(dfs, m, r, mi,\
    \ ri);\n    };\n    dfs(dfs, 0, qs.size(), 0, qn);\n    return res;\n  }\n};\n\
    ...
    \u63DB\u7FA4\n// I: \u5EA7\u6A19\u306E\u578B\ntemplate <class G, class I>\nstruct\
    \ RectangleAddPointGet\n{\n  using S = typename G::S;\n\nprivate:\n  PointAddLowerLeftSum<G,\
    \ I> rs;\n\npublic:\n  // [lx, rx) \xD7 [ly, ry) \u306B\u91CD\u307F w \u306E\u9577\
    \u65B9\u5F62\u3092\u8FFD\u52A0\n  void rectangle_add(I lx, I rx, I ly, I ry, const\
    \ S &w)\n  {\n    assert(lx <= rx && ly <= ry);\n    S iw = G::inv(w);\n    rs.point_add(lx,\
    ...
    \u30A8\u30EA\u306B\u307E\u3068\u3081\u3066\u7B54\u3048\u308B\n  vc<S> run() {\
    \ return rs.run(); }\n};\n#line 18 \"verify/yosupo/rectangle_add_point_get.test.cpp\"\
    \n\nvoid init() {}\n\nvoid main2()\n{\n  LL(N, Q);\n  RectangleAddPointGet<GroupAddSub<ll>,\
    \ ll> rs;\n  rep(_, N)\n  {\n    LL(lx, ly, rx, ry, w);\n    rs.rectangle_add(lx,\
    \ rx, ly, ry, w);\n  }\n  rep(_, Q)\n  {\n    LL(t);\n    if (t == 0)\n    {\n\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 53 \"verify/yosupo/rectangle_add_point_get.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/yosupo/rectangle_add_point_get.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo/rectangle_add_point_get.test.cpp
- /verify/verify/yosupo/rectangle_add_point_get.test.cpp.html
