...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/vertex_add_path_sum.test.cpp\"\n#define PROBLEM\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 17 \"verify/yosupo/vertex_add_path_sum.test.cpp\"\
    ...
    };\n#line 20 \"verify/yosupo/vertex_add_path_sum.test.cpp\"\n\nvoid init() {}\n\
    \nvoid main2()\n{\n  LL(N, Q);\n  VEC(ll, N, A);\n  VEC(pll, N - 1, UV);\n  RootedTree\
    \ G(N, UV, randrange(0, N));\n  FenwickTree<GroupAddSub<ll>> fw(G.reordered_vertex_info(A));\n\
    \  rep(_, Q)\n  {\n    LL(t);\n    if (t == 0)\n    {\n      LL(p, x);\n     \
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 52 \"verify/yosupo/vertex_add_path_sum.test.cpp\"\
