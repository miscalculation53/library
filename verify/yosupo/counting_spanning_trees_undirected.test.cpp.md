...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/counting_spanning_trees_undirected.test.cpp\"\
    ...
    \    else\n      return std::hash<mint>{}(x);\n  }\n};\n#line 18 \"verify/yosupo/counting_spanning_trees_undirected.test.cpp\"\
    ...
    #line 20 \"verify/yosupo/counting_spanning_trees_undirected.test.cpp\"\n\nvoid\
    \ init() {}\n\nvoid main2()\n{\n  LL(N, M);\n  VEC(pll, M, UV);\n  GraphUndirected<bool>\
    \ G(N, UV);\n  PRINT(count_spanning_trees_undirected<mint>(G.adj_matrix_ecnt()));\n\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 34 \"verify/yosupo/counting_spanning_trees_undirected.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/yosupo/counting_spanning_trees_undirected.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo/counting_spanning_trees_undirected.test.cpp
- /verify/verify/yosupo/counting_spanning_trees_undirected.test.cpp.html
