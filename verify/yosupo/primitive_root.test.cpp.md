...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/primitive_root.test.cpp\"\n#define PROBLEM\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 17 \"verify/yosupo/primitive_root.test.cpp\"\
    ...
    \ 19 \"verify/yosupo/primitive_root.test.cpp\"\n\nvoid init() {}\n\nvoid main2()\n\
    {\n  LL(p);\n  PRINT(primitive_root(p, factorize(p - 1)));\n}\n\nvoid test() {}\n\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 31 \"verify/yosupo/primitive_root.test.cpp\"\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/primitive_root\"\n\n//\
    ...
    \n\nvoid init() {}\n\nvoid main2()\n{\n  LL(p);\n  PRINT(primitive_root(p, factorize(p\
  ...
  verifiedWith: []
documentation_of: verify/yosupo/primitive_root.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo/primitive_root.test.cpp
- /verify/verify/yosupo/primitive_root.test.cpp.html
