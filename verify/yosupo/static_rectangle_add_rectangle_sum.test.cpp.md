...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/static_rectangle_add_rectangle_sum.test.cpp\"\
    ...
    \    else\n      return std::hash<mint>{}(x);\n  }\n};\n#line 18 \"verify/yosupo/static_rectangle_add_rectangle_sum.test.cpp\"\
    \nusing mint = modint998244353;\n#line 2 \"ds/2d/offline/static_rectangle_add_rectangle_sum.hpp\"\
    \n\n#line 4 \"ds/2d/offline/static_rectangle_add_rectangle_sum.hpp\"\n\n#line\
    \ 2 \"ds/2d/offline/rectangle_sum.hpp\"\n\n#line 4 \"ds/2d/offline/rectangle_sum.hpp\"\
    ...
    \ }\n};\n#line 6 \"ds/2d/offline/static_rectangle_add_rectangle_sum.hpp\"\n\n\
    /**\n * @brief \u77E9\u5F62\u52A0\u7B97 \u2192 \u77E9\u5F62\u548C\uFF08\u30AA\u30D5\
    \u30E9\u30A4\u30F3\uFF09\n * @docs docs/ds/2d/offline/static_rectangle_add_rectangle_sum.md\n\
    \ */\n\n// rectangle add \u3092\u3059\u3079\u3066\u3084\u3063\u305F\u3042\u3068\
    \u306B rectangle sum \u3092\u3084\u308B\n// S: \u6574\u6570\u3084 mint \u306A\u3069\
    \ (\u52A0\u6E1B\u7B97\u304A\u3088\u3073\u6574\u6570\u500D\u304C\u53EF\u80FD)\n\
    // I: \u5EA7\u6A19\u306E\u578B\ntemplate <class S, class I>\nstruct StaticRectangleAddRectangleSum\n\
    {\nprivate:\n  LowerLeftSum<GroupAddSub<S>, I> rs1, rs2, rs3, rs4;\n  vc<tuple<int,\
    \ int, I, I>> qi_coef_rx_ry;\n  int qn = 0;\n  void lower_left_sum_internal(I\
    \ rx, I ry, int qi, int coef)\n  {\n    rs1.rectangle_sum(rx, ry);\n    rs2.rectangle_sum(rx,\
    ...
    \ [ly, ry) \u306B\u91CD\u307F w \u3092\u52A0\u7B97\n  void rectangle_add(I lx,\
    \ I rx, I ly, I ry, const S &w)\n  {\n    upper_right_add(lx, ly, w);\n    upper_right_add(lx,\
    \ ry, -w);\n    upper_right_add(rx, ly, -w);\n    upper_right_add(rx, ry, w);\n\
    \  }\n  // (-\u221E, rx) \xD7 (-\u221E, ry) \u306E\u91CD\u307F\u306E\u7DCF\u548C\
    \u3092\u7B54\u3048\u308B\u30AF\u30A8\u30EA\u3092\u8FFD\u52A0\n  void lower_left_sum(I\
    \ rx, I ry)\n  {\n    lower_left_sum_internal(rx, ry, qn, 1);\n    qn++;\n  }\n\
    \  // [lx, rx) \xD7 [ly, ry) \u306E\u91CD\u307F\u306E\u7DCF\u548C\u3092\u7B54\u3048\
    \u308B\u30AF\u30A8\u30EA\u3092\u8FFD\u52A0\n  void rectangle_sum(I lx, I rx, I\
    \ ly, I ry)\n  {\n    lower_left_sum_internal(lx, ly, qn, 1);\n    lower_left_sum_internal(lx,\
    \ ry, qn, -1);\n    lower_left_sum_internal(rx, ly, qn, -1);\n    lower_left_sum_internal(rx,\
    \ ry, qn, 1);\n    qn++;\n  }\n  // \u3059\u3079\u3066\u306E\u30AF\u30A8\u30EA\
    \u306B\u7B54\u3048\u308B\n  vc<S> run()\n  {\n    auto res1 = rs1.run(), res2\
    \ = rs2.run(), res3 = rs3.run(), res4 = rs4.run();\n    vc<S> res(qn, 0);\n  \
    \  repi(i, res1.size())\n    {\n      auto [qi, coef, rx, ry] = qi_coef_rx_ry[i];\n\
    \      res[qi] += res1[i] * rx * ry * coef;\n      res[qi] -= res2[i] * rx * coef;\n\
    \      res[qi] -= res3[i] * ry * coef;\n      res[qi] += res4[i] * coef;\n   \
    \ }\n    return res;\n  }\n};\n#line 20 \"verify/yosupo/static_rectangle_add_rectangle_sum.test.cpp\"\
    \n\nvoid init() {}\n\nvoid main2()\n{\n  LL(N, Q);\n  StaticRectangleAddRectangleSum<mint,\
    \ ll> rs;\n  rep(_, N)\n  {\n    LL(lx, ly, rx, ry, w);\n    rs.rectangle_add(lx,\
    \ rx, ly, ry, w);\n  }\n  rep(_, Q)\n  {\n    LL(lx, ly, rx, ry);\n    rs.rectangle_sum(lx,\
    \ rx, ly, ry);\n  }\n  auto ans = rs.run();\n  PRINTV(ans);\n}\n\nvoid test()\n\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 47 \"verify/yosupo/static_rectangle_add_rectangle_sum.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/yosupo/static_rectangle_add_rectangle_sum.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo/static_rectangle_add_rectangle_sum.test.cpp
- /verify/verify/yosupo/static_rectangle_add_rectangle_sum.test.cpp.html
