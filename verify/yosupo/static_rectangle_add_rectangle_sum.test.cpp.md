...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/static_rectangle_add_rectangle_sum.test.cpp\"\
    ...
    \ }\n  };\n  struct Q\n  {\n    I x, y;\n    int qi, coef;\n    bool operator<(const\
    \ Q &rhs) const { return x < rhs.x; }\n  };\n  vc<P> ps;\n  vc<Q> qs;\n  vc<I>\
    \ ys;\n  int qn = 0;\n\n  void lower_left_sum_internal(I rx, I ry, int qi, int\
    \ coef)\n  {\n    qs.push_back({rx, ry, qi, coef});\n  }\n\npublic:\n  // [lx,\
    \ \u221E) \xD7 [ly, \u221E) \u306B\u91CD\u307F w \u3092\u52A0\u7B97\n  void upper_right_add(I\
    \ lx, I ly, const S &w)\n  {\n    ps.push_back({lx, ly, {w, w * ly, w * lx, w\
    \ * lx * ly}});\n    ys.push_back(ly);\n  }\n  // [lx, rx) \xD7 [ly, ry) \u306B\
    \u91CD\u307F w \u3092\u52A0\u7B97\n  void rectangle_add(I lx, I rx, I ly, I ry,\
    \ const S &w)\n  {\n    assert(lx <= rx && ly <= ry);\n    upper_right_add(lx,\
    ...
    \ ry, qn, 1);\n    qn++;\n  }\n  // [lx, rx) \xD7 [ly, ry) \u306E\u91CD\u307F\u306E\
    \u7DCF\u548C\u3092\u7B54\u3048\u308B\u30AF\u30A8\u30EA\u3092\u8FFD\u52A0\n  void\
    \ rectangle_sum(I lx, I rx, I ly, I ry)\n  {\n    assert(lx <= rx && ly <= ry);\n\
    ...
    \       s.a += fw[j].a;\n        s.b += fw[j].b;\n        s.c += fw[j].c;\n  \
    \      s.d += fw[j].d;\n        j -= j & -j;\n      }\n      res[q.qi] += (s.a\
    \ * q.x * q.y - s.b * q.x - s.c * q.y + s.d) * q.coef;\n    }\n    return res;\n\
