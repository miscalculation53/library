...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/rational_approximation.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/rational_approximation\"\n\n// #define\
    ...
    \ c -= n * d;\n  if (c > d)\n    return {n + 1, 1};\n  auto [p, q] = abc408g(d,\
    \ c, b, a);\n  return {p * n + q, p};\n}\n#line 18 \"verify/yosupo/rational_approximation.test.cpp\"\
    \n\nvoid init() {}\n\nvoid main2()\n{\n  INT(N, x, y);\n  auto judge = [&](int\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 46 \"verify/yosupo/rational_approximation.test.cpp\"\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/rational_approximation\"\
    ...
    \ init() {}\n\nvoid main2()\n{\n  INT(N, x, y);\n  auto judge = [&](int num, int\
    \ den) -> bool\n  {\n    return ll(num) * ll(y) <= ll(den) * ll(x);\n  };\n  auto\
    \ judge2 = [&](int num, int den) -> bool\n  {\n    return ll(num) * ll(y) >= ll(den)\
    \ * ll(x);\n  };\n  auto node = sbt_search<int>(judge, N);\n  dump(node);\n  int\
    \ p = node.p, q = node.q;\n  int r, s;\n  if (judge2(p, q))\n    r = p, s = q;\n\
    \  else\n    r = node.r, s = node.s;\n  PRINT(p, q, r, s);\n}\n\nvoid test() {}\n\
  ...
  verifiedWith: []
documentation_of: verify/yosupo/rational_approximation.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo/rational_approximation.test.cpp
- /verify/verify/yosupo/rational_approximation.test.cpp.html
