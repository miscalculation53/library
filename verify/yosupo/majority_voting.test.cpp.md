...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/majority_voting.test.cpp\"\n#define PROBLEM\
    ...
    \ res[i] = randint<T>(T(l), T(r) - T(k));\n  sort(ALL(res));\n  repi(i, k) res[i]\
    \ += i;\n  if (!does_sort)\n    shuffle(ALL(res), mt);\n  return res;\n}\n#line\
    \ 17 \"verify/yosupo/majority_voting.test.cpp\"\n\n#line 2 \"ds/segtree/segtree.hpp\"\
    ...
    math/algebra/majority_vote.hpp\"\n\n/**\n * @brief Boyer\u2013Moore majority vote\
    ...
    \u7684\u69CB\u9020\uFF08\u56DB\u5247\u6F14\u7B97\u3068 min, max\uFF09\n * @docs\
    \ docs/math/algebra/algebra_basic_ops.md\n */\n\ntemplate <class T>\nstruct MonoidMul\n\
    {\n  using S = T;\n  static constexpr S op(S a, S b) { return a * b; }\n  static\
    \ constexpr S e() { return 1; }\n};\n\ntemplate <class T>\nstruct GroupAddSub\n\
    {\n  using S = T;\n  static constexpr S op(S a, S b) { return a + b; }\n  static\
    \ constexpr S e() { return S(0); }\n  static constexpr S inv(S a) { return -a;\
    \ }\n};\ntemplate <class T>\nstruct GroupMulDiv\n{\n  using S = T;\n  static constexpr\
    ...
    \ = SemiRingFromMonoidMonoid<MonoidMax<T>, MonoidAdd<T>>;\ntemplate <class T>\n\
    ...
    \ Q>> qs;\n  vc<T> vs;\n\npublic:\n  PointSetRangeFrequency() {}\n  PointSetRangeFrequency(const\
    \ vc<T> &a) : n(a.size()), a(a), vs(a) {}\n\n  // p \u756A\u76EE\u3092 v \u306B\
    \u3059\u308B\u30AF\u30A8\u30EA\u3092\u8FFD\u52A0\u3059\u308B\n  void point_set(int\
    \ p, const T &v)\n  {\n    assert(0 <= p && p < n);\n    qs.eb(P(p, v));\n   \
    \ vs.eb(v);\n  }\n  // [l, r) \u3067\u306E x \u306E\u983B\u5EA6\u3092\u7B54\u3048\
    \u308B\u30AF\u30A8\u30EA\u3092\u8FFD\u52A0\u3059\u308B\n  void range_frequency(int\
    \ l, int r, const T &x)\n  {\n    assert(0 <= l && l <= r && r <= n);\n    qs.eb(Q(l,\
    \ r, x));\n  }\n\n  // \u30AF\u30A8\u30EA\u306B\u307E\u3068\u3081\u3066\u7B54\u3048\
    \u308B\n  template <class I = ll>\n  vc<I> run()\n  {\n    sortunique(vs);\n \
    \   vc<int> js(n);\n    vc<pair<int, int>> jps;\n    repi(p, n)\n    {\n     \
