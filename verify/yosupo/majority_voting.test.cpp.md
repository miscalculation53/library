...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/majority_voting.test.cpp\"\n#define PROBLEM\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 17 \"verify/yosupo/majority_voting.test.cpp\"\
    ...
    \  }\n};\n#line 2 \"math/algebra/majority_vote.hpp\"\n\n#line 2 \"math/algebra/algebra_base.hpp\"\
    ...
    \ auto inv = Gmul::inv;\n};\n#line 5 \"math/algebra/majority_vote.hpp\"\n\n/**\n\
    \ * @brief Boyer\u2013Moore majority vote algorithm\n * @docs docs/math/algebra/majority_vote.md\n\
    \ */\n\ntemplate <class T>\nstruct MajorityVote\n{\n  // \u76F8\u7570\u306A\u308B\
    \ 2 \u8981\u7D20\u3092\u30DA\u30A2\u306B\u3057\u3066\u6D88\u3059\u3053\u3068\u3092\
    \u7E70\u308A\u8FD4\u3057\u305F\u3089 cand \u304C cnt \u500B\u6B8B\u308B\n  //\
    \ \u3053\u306E\u3068\u304D cand \u3060\u3051\u304C\u904E\u534A\u6570\u5019\u88DC\
    \ (\u5B9F\u969B\u306B\u904E\u534A\u6570\u3068\u306F\u9650\u3089\u306A\u3044)\n\
    \  struct S\n  {\n    T cand;\n    int cnt;\n    S(T cand = T{}, int cnt = 1)\
    ...
    #endif\n#line 2 \"ds/query/point_set_range_frequency.hpp\"\n\n#line 4 \"ds/query/point_set_range_frequency.hpp\"\
    ...
    ** (\u306A\u3051\u308C\u3070 size())\n  template <class T, class I = ll>\n  inline\
    ...
    \ + kth_bit_pos(dat[i], w - v - 1);\n    return res;\n  }\n  // sum[0, r) >= w\
    \ \u3068\u306A\u308B\u6700\u5C0F\u306E r (\u306A\u3051\u308C\u3070 size())\n \
    \ template <class I = ll>\n  I geq_min(T w) const { return lt_max<I>(w) + 1; }\n\
    \  // sum[0, r) <= w \u3068\u306A\u308B\u6700\u5927\u306E r (\u306A\u3051\u308C\
    ...
    \ }\n  const vc<T> &get_elist() const { return elist; }\n};\n#line 7 \"ds/query/point_set_range_frequency.hpp\"\
    \n\n/**\n * @brief \u4E00\u70B9\u66F4\u65B0\u30FB\u533A\u9593\u983B\u5EA6\uFF08\
    ...
    \ ri));\n      }\n    }\n    return res;\n  }\n};\n#line 21 \"verify/yosupo/majority_voting.test.cpp\"\
    \n\nvoid init() {}\n\nvoid main2()\n{\n  LL(N, Q);\n  VEC(ll, N, A);\n  VEC(tlll,\
    ...
    \  auto res = rf.run();\n  rep(qi, res.size()) if (res.at(qi) * 2 <= len.at(qi))\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 76 \"verify/yosupo/majority_voting.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/yosupo/majority_voting.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo/majority_voting.test.cpp
- /verify/verify/yosupo/majority_voting.test.cpp.html
