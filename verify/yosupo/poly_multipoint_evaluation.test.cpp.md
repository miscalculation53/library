...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/poly_multipoint_evaluation.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/multipoint_evaluation\"\n\n#define\
    ...
    \ c); }\n};\n#line 18 \"verify/yosupo/poly_multipoint_evaluation.test.cpp\"\n\
    ...
    \  return res;\n}\n#line 21 \"verify/yosupo/poly_multipoint_evaluation.test.cpp\"\
    \n\nvoid init() {}\n\nvoid main2()\n{\n  LL(N, M);\n  VEC(mint, N, c);\n  VEC(mint,\
    \ M, p);\n  fps f(c);\n  PRINT(multipoint_evaluation(f, p));\n}\n\nvoid test()\n\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 39 \"verify/yosupo/poly_multipoint_evaluation.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/yosupo/poly_multipoint_evaluation.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo/poly_multipoint_evaluation.test.cpp
- /verify/verify/yosupo/poly_multipoint_evaluation.test.cpp.html
