...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/dijkstra.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/shortest_path\"\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 17 \"verify/yosupo/dijkstra.test.cpp\"\
    ...
    \  }\n};\n#line 19 \"verify/yosupo/dijkstra.test.cpp\"\n\nvoid init()\n{\n  oj(mt.seed(random_device()()));\n\
    }\n\nvoid main2()\n{\n  LL(N, M, s, t);\n  VEC(tlll, M, ABC);\n  ShortestPath<true,\
    ...
    n[MULTI_TESTCASE]\\n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"\
    T\");\n      IN(uint, T);\n      while (T--)\n      {\n        dump(\"new testcase\"\
    );\n        main2();\n      }\n    }\n    #endif\n  }\n};\n#line 44 \"verify/yosupo/dijkstra.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/yosupo/dijkstra.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo/dijkstra.test.cpp
- /verify/verify/yosupo/dijkstra.test.cpp.html
