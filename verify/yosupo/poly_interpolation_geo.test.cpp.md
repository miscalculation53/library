...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/poly_interpolation_geo.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/polynomial_interpolation_on_geometric_sequence\"\
    ...
    \ c); }\n};\n#line 18 \"verify/yosupo/poly_interpolation_geo.test.cpp\"\nusing\
    \ mint = modint998244353;\nusing bi = Binomial<mint>;\nusing fps = FormalPowerSeries<mint>;\n\
    #line 2 \"math/fps/interpolation_geo.hpp\"\n\n#line 4 \"math/fps/interpolation_geo.hpp\"\
    \n\n#line 2 \"math/fps/multipoint_evaluation_geo.hpp\"\n\n#line 4 \"math/fps/multipoint_evaluation_geo.hpp\"\
    ...
    \ = f.eval(a);\n    return res;\n  }\n  const int n = f.size();\n  auto calc_pw\
    \ = [&](int k, const mint &x) -> F\n  {\n    F res(k, 1);\n    repi(i, 1, k) res[i]\
    \ = res[i - 1] * x;\n    return res;\n  };\n  auto calc_tri = [&](int k, const\
    \ F &pw) -> F\n  {\n    F res(k, 1);\n    repi(i, k - 1) res[i + 1] = res[i] *\
    \ pw[i];\n    return res;\n  };\n  F pwa = calc_pw(n, a), pwr = calc_pw(n + m,\
    \ r), pwir = calc_pw(max(n, m), r.inv());\n  F trir = calc_tri(n + m, pwr), triir\
    \ = calc_tri(max(n, m), pwir);\n  F s(n);\n  repi(i, n) s[n - 1 - i] = f[i] *\
    ...
    \ n) ans[i] *= pwia[i];\n  return ans;\n}\n#line 22 \"verify/yosupo/poly_interpolation_geo.test.cpp\"\
    \n\nvoid init() {}\n\nvoid main2()\n{\n  LL(N);\n  IN(mint, a, r);\n  VEC(mint,\
    \ N, y);\n  PRINT(interpolation_geo(a, r, y));\n}\n\nvoid test()\n{\n  \n}\n\n\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 39 \"verify/yosupo/poly_interpolation_geo.test.cpp\"\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/polynomial_interpolation_on_geometric_sequence\"\
    ...
    \ mint = modint998244353;\nusing bi = Binomial<mint>;\nusing fps = FormalPowerSeries<mint>;\n\
    #include \"math/fps/interpolation_geo.hpp\"\n\nvoid init() {}\n\nvoid main2()\n\
    {\n  LL(N);\n  IN(mint, a, r);\n  VEC(mint, N, y);\n  PRINT(interpolation_geo(a,\
...
layout: document
redirect_from:
- /verify/verify/yosupo/poly_interpolation_geo.test.cpp
- /verify/verify/yosupo/poly_interpolation_geo.test.cpp.html
