...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/and_or_convolution.test.cpp\"\n#define PROBLEM\
    ...
    }\n#line 16 \"verify/yosupo/and_or_convolution.test.cpp\"\n\n#line 2 \"math/modint/modint.hpp\"\
    ...
    }\n#line 18 \"verify/yosupo/and_or_convolution.test.cpp\"\nusing mint = modint998244353;\n\
    \nvoid init() {}\n\nvoid main2()\n{\n  LL(N);\n  VEC(mint, 1 << N, A, B);\n  auto\
    \ C = and_convolution<RingAddSubMul<mint>>(A, B);\n  PRINT(C);\n  auto D = or_convolution<RingAddSubMul<mint>>(reversed(A),\
    \ reversed(B));\n  reverse(ALL(D));\n  dump(C, D);\n  assert(C == D);\n}\n\nvoid\
    \ test() {}\n\nint main()\n{\n  cauto CERR = [](string val, string color)\n  {\n\
    \    string s = \"\\033[\" + color + \"m\" + val + \"\\033[m\";\n    #ifdef LOCAL\n\
    \    cerr << s;\n    #endif\n    /* \u30B3\u30FC\u30C9\u30C6\u30B9\u30C8\u3067\
    \u78BA\u8A8D\u3059\u308B\u969B\u306B\u30B3\u30E1\u30F3\u30C8\u30A2\u30A6\u30C8\
    \u3059\u308B\n    cerr << val;\n    //*/\n  };\n\n  #if defined FAST_IO and not\
    \ defined LOCAL\n  CERR(\"\\n[FAST_IO]\\n\\n\", \"32\");\n  #endif\n  #if defined\
    \ FAST_CIO and not defined LOCAL\n  CERR(\"\\n[FAST_CIO]\\n\\n\", \"32\");\n \
