...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/and_or_convolution.test.cpp\"\n#define PROBLEM\
    ...
    \    else\n      return std::hash<mint>{}(x);\n  }\n};\n#line 20 \"verify/yosupo/and_or_convolution.test.cpp\"\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 39 \"verify/yosupo/and_or_convolution.test.cpp\"\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/bitwise_and_convolution\"\
    ...
    \ init() {}\n\nvoid main2()\n{\n  LL(N);\n  VEC(mint, 1 << N, A, B);\n  auto C\
    \ = and_convolution<RingAddSubMul<mint>>(A, B);\n  PRINT(C);\n  auto D = or_convolution<RingAddSubMul<mint>>(reversed(A),\
    \ reversed(B));\n  reverse(ALL(D));\n  dump(C, D);\n  assert(C == D);\n}\n\nvoid\
...
layout: document
redirect_from:
- /verify/verify/yosupo/and_or_convolution.test.cpp
- /verify/verify/yosupo/and_or_convolution.test.cpp.html
