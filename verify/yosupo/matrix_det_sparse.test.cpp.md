...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/matrix_det_sparse.test.cpp\"\n#define PROBLEM\
    ...
    \    else\n      return std::hash<mint>{}(x);\n  }\n};\n#line 18 \"verify/yosupo/matrix_det_sparse.test.cpp\"\
    ...
    \    }\n    return {true, sol, basis};\n  }\n};\n#line 20 \"verify/yosupo/matrix_det_sparse.test.cpp\"\
    \n\nvoid init() {}\n\nvoid main2()\n{\n  LL(N, K);\n  VEC(tlll, K, ABC);\n  Matrix<FieldAddSubMulDiv<mint>>\
    \ mat(N, N);\n  fec([ a, b, c ] : ABC) mat.at(a).at(b) = c;\n  dump(mat);\n  PRINT(mat.det_sparse());\n\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 36 \"verify/yosupo/matrix_det_sparse.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/yosupo/matrix_det_sparse.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo/matrix_det_sparse.test.cpp
- /verify/verify/yosupo/matrix_det_sparse.test.cpp.html
