...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/2d_fenwick_tree.test.cpp\"\n#define PROBLEM\
    ...
    \ res[i] = randint<T>(T(l), T(r) - T(k));\n  sort(ALL(res));\n  repi(i, k) res[i]\
    \ += i;\n  if (!does_sort)\n    shuffle(ALL(res), mt);\n  return res;\n}\n#line\
    \ 2 \"ds/2d/sparse/fenwick_tree.hpp\"\n\n#line 4 \"ds/2d/sparse/fenwick_tree.hpp\"\
    ...
    };\n#line 6 \"ds/2d/sparse/fenwick_tree.hpp\"\n\n/**\n * @brief $2$ \u6B21\u5143\
    \ Fenwick Tree\uFF08\u758E\u3001\u30AF\u30A8\u30EA\u70B9\u5148\u8AAD\u307F\uFF09\
    ...
    \ S = typename G::S;\n\nprivate:\n  int n;\n  vvc<I> ys;\n  vc<FenwickTree<G>>\
    \ fw;\n\npublic:\n  FenwickTree2DSparse() {}\n  FenwickTree2DSparse(const vc<pair<I,\
    ...
    \ s;\n  }\n  // \u9818\u57DF (-\u221E, rx) \xD7 [ly, ry) \u306E\u91CD\u307F\u548C\
    \u3092\u6C42\u3081\u308B\n  // \u7FA4\u3067\u3042\u308B\u3053\u3068\u304C\u5FC5\
    \u8981\n  S sum(I rx, I ly, I ry) const\n  {\n    rx = clamp(rx, I(0), I(n));\n\
    \    assert(ly <= ry);\n    int ri = rx;\n    S s = G::e();\n    while (ri > 0)\n\
    \    {\n      const int lj = LB(ys[ri], ly), rj = LB(ys[ri], ry);\n      s = G::op(s,\
    \ fw[ri].sum(lj, rj));\n      ri -= ri & -ri;\n    }\n    return s;\n  }\n  //\
    \ \u9818\u57DF (-\u221E, rx) \xD7 [ly, ry) \u306E\u91CD\u307F\u548C\u3092\u6C42\
    \u3081\u308B\n  // \u7FA4\u3067\u3042\u308B\u3053\u3068\u304C\u5FC5\u8981\n  S\
    \ sum(I lx, I rx, I ly, I ry) const\n  {\n    assert(lx <= rx);\n    return G::op(sum(rx,\
    \ ly, ry), G::inv(sum(lx, ly, ry)));\n  }\n\n  vc<tuple<I, I, S>> content() const\n\
    \  {\n    vc<tuple<I, I, S>> res;\n    repi(x, n)\n    {\n      fec(y : ys[x +\
    \ 1])\n      {\n        S s = sum(x, x + 1, y, y + 1);\n        if (s != G::e())\n\
    \          res.eb(x, y, s);\n      }\n    }\n    return res;\n  }\n};\n#line 18\
