...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/2d_fenwick_tree.test.cpp\"\n#define PROBLEM\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 2 \"ds/2d/sparse/fenwick_tree.hpp\"\n\n\
    ...
    \ */\n\n// G \u306F\u53EF\u63DB\u7FA4 (prefix \u3060\u3051\u306A\u3069\u3067\u3042\
    \u308C\u3070\u53EF\u63DB\u30E2\u30CE\u30A4\u30C9\u3067\u3082 OK)\ntemplate <class\
    \ G>\nstruct FenwickTree\n{\n  using S = typename G::S;\n\nprivate:\n  int n;\n\
    \  vc<S> dat;\n\npublic:\n  FenwickTree() {}\n  FenwickTree(int n) : n(n), dat(n\
    ...
    \u8CA0\u306E\u3068\u304D\n  // sum[0, r) <= w \u3068\u306A\u308B\u6700\u5927\u306E\
    \ r (\u306A\u3051\u308C\u3070 -1)\n  template <class I = ll>\n  inline I leq_max(S\
    \ w) const { return lt_max<I>(w + 1); }\n  // \u6574\u6570\u306E\u666E\u901A\u306E\
    \u8DB3\u3057\u7B97\u3067\u3001\u8981\u7D20\u304C\u975E\u8CA0\u306E\u3068\u304D\
    \n  // sum[0, r) > w \u3068\u306A\u308B\u6700\u5C0F\u306E r (\u306A\u3051\u308C\
    \u3070 n+1)\n  template <class I = ll>\n  inline I gt_min(S w) const { return\
    \ geq_min<I>(w + 1); }\n\n  // \u8981\u7D20\u304C [0, size()) \u306E\u591A\u91CD\
    \u96C6\u5408\u3092\u7BA1\u7406\u3059\u308B\u306E\u306B\u4F7F\u3063\u305F\u3068\
    \u304D\u3001\u591A\u91CD\u96C6\u5408\u306E\u30B5\u30A4\u30BA\u3092\u8FD4\u3059\
    ...
    \ [0, size()) \u306E\u591A\u91CD\u96C6\u5408\u3092\u7BA1\u7406\u3059\u308B\u306E\
    \u306B\u4F7F\u3063\u305F\u3068\u304D\u3001\u5024 x \u306F\u4F55\u756A\u76EE\u304B\
    \u3089\u4F55\u756A\u76EE\u304B [l, r)\n  inline pair<S, S> order_in_multiset(int\
    \ x) const { return {sum(x), sum(x + 1)}; }\n  // \u8981\u7D20\u304C [0, size())\
    \ \u306E\u591A\u91CD\u96C6\u5408\u3092\u7BA1\u7406\u3059\u308B\u306E\u306B\u4F7F\
    \u3063\u305F\u3068\u304D\u3001k \u756A\u76EE\u306E\u5024\n  // \u305F\u3060\u3057\
    ...
    \u3063\u305F\u3068\u304D\u3001x \u4EE5\u4E0B\u3067\u6700\u5927\u306E\u8981\u7D20\
    \u304C**\u4F55\u756A\u76EE\u304B** (\u306A\u3051\u308C\u3070 -1)\n  template <class\
    \ T, class I = ll>\n  inline I leq_max_in_multiset(T x) const { return lt_max_in_multiset<T,\
    \ I>(x + 1); }\n  // \u8981\u7D20\u304C [0, size()) \u306E\u591A\u91CD\u96C6\u5408\
    \u3092\u7BA1\u7406\u3059\u308B\u306E\u306B\u4F7F\u3063\u305F\u3068\u304D\u3001\
    x \u4EE5\u4E0A\u3067\u6700\u5C0F\u306E\u8981\u7D20\u304C**\u4F55\u756A\u76EE\u304B\
    ** (\u306A\u3051\u308C\u3070 size())\n  template <class T, class I = ll>\n  inline\
    \ I geq_min_in_multiset(T x) const\n  {\n    return sum(clamp(x, T(0), T(n)));\n\
    \  }\n  // \u8981\u7D20\u304C [0, size()) \u306E\u591A\u91CD\u96C6\u5408\u3092\
    \u7BA1\u7406\u3059\u308B\u306E\u306B\u4F7F\u3063\u305F\u3068\u304D\u3001x \u8D85\
    \u904E\u3067\u6700\u5C0F\u306E\u8981\u7D20\u304C**\u4F55\u756A\u76EE\u304B** (\u306A\
    ...
    }\n} // namespace sparse_2d\n#line 8 \"ds/2d/sparse/fenwick_tree.hpp\"\n\n/**\n\
    \ * @brief $2$ \u6B21\u5143 Fenwick Tree\uFF08\u758E\u3001\u30AF\u30A8\u30EA\u70B9\
    \u5148\u8AAD\u307F\uFF09\n * @docs docs/ds/2d/sparse/fenwick_tree.md\n */\n\n\
    // \u521D\u671F\u5316\u306E\u969B\u3001add \u30AF\u30A8\u30EA\u306E\u70B9\u3092\
    \u3059\u3079\u3066\u4E0E\u3048\u308B\n// \u70B9\u66F4\u65B0\u306F\u3001\u69CB\u7BC9\
    \u6642\u306B\u4E0E\u3048\u305F\u70B9\u306E\u6DFB\u5B57 point_id \u3067\u6307\u5B9A\
    \u3059\u308B\n// M: \u53EF\u63DB\u30E2\u30CE\u30A4\u30C9 (\u77E9\u5F62\u5DEE\u5206\
    \u3092\u53D6\u308B\u64CD\u4F5C\u3067\u306F\u53EF\u63DB\u7FA4)\n// I: \u5EA7\u6A19\
    \u306E\u578B\n// D: \u5404\u5916\u5074\u30CE\u30FC\u30C9\u306B\u8F09\u305B\u308B\
    ...
    \ [ly, ry) \u306E\u91CD\u307F\u548C\u3092\u6C42\u3081\u308B\n  // M \u304C\u7FA4\
    \u3067\u3042\u308B\u3053\u3068\u304C\u5FC5\u8981\n  S sum(I lx, I rx, I ly, I\
    \ ry) const\n  {\n    assert(lx <= rx);\n    return M::op(sum(rx, ly, ry), M::inv(sum(lx,\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 80 \"verify/yosupo/2d_fenwick_tree.test.cpp\"\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/point_add_rectangle_sum\"\
    ...
    \     qs.eb(1, lx, rx, ly, ry);\n    }\n  }\n  sortunique(X);\n  vpll IY;\n  fem(q\
    \ : qs)\n  {\n    ll t = get<0>(q);\n    if (t == 0)\n    {\n      auto &[_, x,\
    \ y, w, __] = q;\n      IY.eb(LB(X, x), y);\n    }\n  }\n\n  FenwickTree2DSparse<GroupAddSub<ll>,\
    \ ll> fw(IY);\n  fec(q : qs)\n  {\n    dump(fw.content());\n    ll t = get<0>(q);\n\
    \    if (t == 0)\n    {\n      auto [_, x, y, w, __] = q;\n      fw.add(LB(X,\
    \ x), y, w);\n    }\n    else if (t == 1)\n    {\n      auto [_, lx, rx, ly, ry]\
  ...
  verifiedWith: []
documentation_of: verify/yosupo/2d_fenwick_tree.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo/2d_fenwick_tree.test.cpp
- /verify/verify/yosupo/2d_fenwick_tree.test.cpp.html
