...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/find_linear_recurrence.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/find_linear_recurrence\"\n\n#define\
    ...
    \    else\n      return std::hash<mint>{}(x);\n  }\n};\n#line 19 \"verify/yosupo/find_linear_recurrence.test.cpp\"\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 39 \"verify/yosupo/find_linear_recurrence.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/yosupo/find_linear_recurrence.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo/find_linear_recurrence.test.cpp
- /verify/verify/yosupo/find_linear_recurrence.test.cpp.html
