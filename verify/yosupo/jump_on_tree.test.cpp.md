...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/jump_on_tree.test.cpp\"\n#define PROBLEM \"\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 17 \"verify/yosupo/jump_on_tree.test.cpp\"\
    ...
    \      f(l, r, false);\n    }\n  }\n};\n#line 19 \"verify/yosupo/jump_on_tree.test.cpp\"\
    \n\nvoid init() {}\n\nvoid main2()\n{\n  LL(N, Q);\n  VEC(pll, N - 1, AB);\n \
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 37 \"verify/yosupo/jump_on_tree.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/yosupo/jump_on_tree.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo/jump_on_tree.test.cpp
- /verify/verify/yosupo/jump_on_tree.test.cpp.html
