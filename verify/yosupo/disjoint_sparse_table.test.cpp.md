...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/disjoint_sparse_table.test.cpp\"\n#define\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 17 \"verify/yosupo/disjoint_sparse_table.test.cpp\"\
...
layout: document
redirect_from:
- /verify/verify/yosupo/disjoint_sparse_table.test.cpp
- /verify/verify/yosupo/disjoint_sparse_table.test.cpp.html
