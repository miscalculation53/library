...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/lower_left_sum.test.cpp\"\n#define PROBLEM\
    ...
    \ }\n};\n#line 18 \"verify/yosupo/lower_left_sum.test.cpp\"\n\nvoid init() {}\n\
    \nvoid main2()\n{\n  LL(N, Q);\n  VEC(tlll, N, XYW);\n  VEC(tllll, Q, LXLYRXRY);\n\
    \n  LowerLeftSum<GroupAddSub<ll>, ll> rs;\n  fec([ x, y, w ] : XYW) rs.point_add(x,\
    \ y, w);\n  fec([ lx, ly, rx, ry ] : LXLYRXRY)\n  {\n    rs.rectangle_sum(lx,\
    \ ly);\n    rs.rectangle_sum(lx, ry);\n    rs.rectangle_sum(rx, ly);\n    rs.rectangle_sum(rx,\
    \ ry);\n  }\n  auto res = rs.run();\n  dump(res);\n  rep(q, Q)\n  {\n    ll ans\
    \ = res.at(4 * q) - res.at(4 * q + 1) - res.at(4 * q + 2) + res.at(4 * q + 3);\n\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 51 \"verify/yosupo/lower_left_sum.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/yosupo/lower_left_sum.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo/lower_left_sum.test.cpp
- /verify/verify/yosupo/lower_left_sum.test.cpp.html
