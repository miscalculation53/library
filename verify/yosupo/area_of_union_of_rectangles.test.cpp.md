...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/area_of_union_of_rectangles.test.cpp\"\n#define\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 17 \"verify/yosupo/area_of_union_of_rectangles.test.cpp\"\
    \n\n#line 2 \"ds/2d/offline/area_of_union_of_rectangles.hpp\"\n\n#line 4 \"ds/2d/offline/area_of_union_of_rectangles.hpp\"\
    ...
    \ AM::op(dat[r], sm);\n            r--;\n          }\n        }\n        return\
    \ r + 1 - siz;\n      }\n      sm = AM::op(dat[r], sm);\n    } while ((r & -r)\
    \ != r);\n    return 0;\n  }\n};\n#line 2 \"math/algebra/acted_monoid/add_min_count.hpp\"\
    \n\n#line 4 \"math/algebra/acted_monoid/add_min_count.hpp\"\n\n/**\n * @brief\
    \ \u4F5C\u7528\u3064\u304D\u30E2\u30CE\u30A4\u30C9\uFF1A\u52A0\u7B97\u30FB\u6700\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 37 \"verify/yosupo/area_of_union_of_rectangles.test.cpp\"\
