...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/ordered_set.test.cpp\"\n#define PROBLEM \"\
    ...
    };\n#line 18 \"verify/yosupo/ordered_set.test.cpp\"\n\nvoid init() {}\n\nvoid\
    \ main2()\n{\n  LL(N, Q);\n  VEC(ll, N, A);\n  pbds_set<ll> st(ALL(A));\n  rep(_,\
    \ Q)\n  {\n    LL(t, x);\n    if (t == 0)\n      st.insert(x);\n    else if (t\
    \ == 1)\n      st.erase(x);\n    else if (t == 2)\n    {\n      x--;\n      auto\
    \ it = st.find_by_order(x);\n      if (it == st.end())\n        PRINT(-1);\n \
    \     else\n        PRINT(*it);\n    }\n    else if (t == 3)\n      PRINT(st.leq_cnt(x));\n\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 69 \"verify/yosupo/ordered_set.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/yosupo/ordered_set.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo/ordered_set.test.cpp
- /verify/verify/yosupo/ordered_set.test.cpp.html
