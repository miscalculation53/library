...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/block_sparse_table.test.cpp\"\n#define PROBLEM\
    ...
    #line 19 \"verify/yosupo/block_sparse_table.test.cpp\"\n\nvoid init() {}\n\nvoid\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 37 \"verify/yosupo/block_sparse_table.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/yosupo/block_sparse_table.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo/block_sparse_table.test.cpp
- /verify/verify/yosupo/block_sparse_table.test.cpp.html
