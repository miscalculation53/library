...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/associative_array_lower_bound.test.cpp\"\n\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 17 \"verify/yosupo/associative_array_lower_bound.test.cpp\"\
    ...
    \ vec.size())\n  {\n    int &tmp = id[cv[i]];\n    if (tmp == -1)\n      tmp =\
    \ j++;\n    res[i] = tmp;\n  }\n  return res;\n}\n#line 19 \"verify/yosupo/associative_array_lower_bound.test.cpp\"\
    \n\nvoid init() {}\n\nvoid main2()\n{\n  LL(Q);\n  vc<tlll> queries(Q);\n  vc<ll>\
    \ keys;\n  rep(i, Q)\n  {\n    LL(t);\n    if (t == 0)\n    {\n      LL(k, v);\n\
    \      queries.at(i) = {t, k, v};\n      keys.push_back(k);\n    }\n    else if\
    \ (t == 1)\n    {\n      LL(k);\n      queries.at(i) = {t, k, -1};\n    }\n  }\n\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 65 \"verify/yosupo/associative_array_lower_bound.test.cpp\"\
...
layout: document
redirect_from:
- /verify/verify/yosupo/associative_array_lower_bound.test.cpp
- /verify/verify/yosupo/associative_array_lower_bound.test.cpp.html
