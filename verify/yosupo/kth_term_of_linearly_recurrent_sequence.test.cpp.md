...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/kth_term_of_linearly_recurrent_sequence.test.cpp\"\
    ...
    \ q, k);\n}\n#line 18 \"verify/yosupo/kth_term_of_linearly_recurrent_sequence.test.cpp\"\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 39 \"verify/yosupo/kth_term_of_linearly_recurrent_sequence.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/yosupo/kth_term_of_linearly_recurrent_sequence.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo/kth_term_of_linearly_recurrent_sequence.test.cpp
- /verify/verify/yosupo/kth_term_of_linearly_recurrent_sequence.test.cpp.html
