...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/cycle_detection_directed.test.cpp\"\n#define\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 17 \"verify/yosupo/cycle_detection_directed.test.cpp\"\
    ...
    \ w = res.front().to;\n  while (v != w)\n  {\n    cauto &e = prv[v];\n    res.eb(e);\n\
    \    v = e.from;\n  }\n  return {true, reversed(res)};\n}\n#line 19 \"verify/yosupo/cycle_detection_directed.test.cpp\"\
    \n\nvoid init() {}\n\nvoid main2()\n{\n  LL(N, M);\n  VEC(pll, M, UV);\n  GraphDirected<ll>\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 37 \"verify/yosupo/cycle_detection_directed.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/yosupo/cycle_detection_directed.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo/cycle_detection_directed.test.cpp
- /verify/verify/yosupo/cycle_detection_directed.test.cpp.html
