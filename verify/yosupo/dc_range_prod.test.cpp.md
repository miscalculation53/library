...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/dc_range_prod.test.cpp\"\n#define PROBLEM\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 17 \"verify/yosupo/dc_range_prod.test.cpp\"\
...
layout: document
redirect_from:
- /verify/verify/yosupo/dc_range_prod.test.cpp
- /verify/verify/yosupo/dc_range_prod.test.cpp.html
