...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/poly_multipoint_evaluation_geo.test.cpp\"\n\
    ...
    \ c); }\n};\n#line 18 \"verify/yosupo/poly_multipoint_evaluation_geo.test.cpp\"\
    ...
    \ m) u[i] *= triir[i];\n  return u;\n}\n#line 21 \"verify/yosupo/poly_multipoint_evaluation_geo.test.cpp\"\
    \n\nvoid init() {}\n\nvoid main2()\n{\n  LL(N, M);\n  IN(mint, a, r);\n  VEC(mint,\
    \ N, c);\n  PRINT(multipoint_evaluation_geo(fps(c), M, a, r));\n}\n\nvoid test()\n\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 38 \"verify/yosupo/poly_multipoint_evaluation_geo.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/yosupo/poly_multipoint_evaluation_geo.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo/poly_multipoint_evaluation_geo.test.cpp
- /verify/verify/yosupo/poly_multipoint_evaluation_geo.test.cpp.html
