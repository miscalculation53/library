...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/matrix_inv_mod2.test.cpp\"\n#define PROBLEM\
    ...
    \    }\n    return {true, sol, basis};\n  }\n};\n#line 18 \"verify/yosupo/matrix_inv_mod2.test.cpp\"\
    \n\nvoid init() {}\n\nvoid main2()\n{\n  LL(N);\n  VEC(string, N, A_);\n  MatrixMod2<4096>\
    \ A(A_);\n  auto [ok, B] = A.inv();\n  if (!ok)\n    PRINT(-1);\n  else\n    PRINT(B.to_vstr());\n\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 36 \"verify/yosupo/matrix_inv_mod2.test.cpp\"\
...
layout: document
redirect_from:
- /verify/verify/yosupo/matrix_inv_mod2.test.cpp
- /verify/verify/yosupo/matrix_inv_mod2.test.cpp.html
