...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/subset_convolution.test.cpp\"\n#define PROBLEM\
    ...
    #line 17 \"verify/yosupo/subset_convolution.test.cpp\"\nusing mint = modint998244353;\n\
    ...
    \  repi(i, len) c[i] = fa[i][pc[i]];\n  return c;\n}\n#line 20 \"verify/yosupo/subset_convolution.test.cpp\"\
    \n\nvoid init() {}\n\nvoid main2()\n{\n  LL(N);\n  VEC(mint, 1 << N, A, B);\n\
    ...
    \ MULTI_TESTCASE\n    CERR(\"\\n[MULTI_TESTCASE]\\n\\n\", \"33\");\n    dump(\"\
    T\");\n    IN(uint, T);\n    while (T--)\n    {\n      dump(\"new testcase\");\n\
    \      main2();\n    }\n    #endif\n  }\n};\n#line 34 \"verify/yosupo/subset_convolution.test.cpp\"\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/subset_convolution\"\n\n\
    ...
    \  VEC(mint, 1 << N, A, B);\n  auto C = subset_convolution<RingAddSubMul<mint>>(A,\
