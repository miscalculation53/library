...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/subset_convolution.test.cpp\"\n#define PROBLEM\
    ...
    \    else\n      return std::hash<mint>{}(x);\n  }\n};\n#line 18 \"verify/yosupo/subset_convolution.test.cpp\"\
    ...
    \  repi(i, len) c[i] = fa[i][pc[i]];\n  return c;\n}\n#line 21 \"verify/yosupo/subset_convolution.test.cpp\"\
    \n\nvoid init() {}\n\nvoid main2()\n{\n  LL(N);\n  VEC(mint, 1 << N, A, B);\n\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 35 \"verify/yosupo/subset_convolution.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/yosupo/subset_convolution.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo/subset_convolution.test.cpp
- /verify/verify/yosupo/subset_convolution.test.cpp.html
