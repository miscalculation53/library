...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/double_ended_priority_queue.test.cpp\"\n#define\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 17 \"verify/yosupo/double_ended_priority_queue.test.cpp\"\
    \n\n#line 2 \"ds/double_ended_priority_queue.hpp\"\n\n#line 4 \"ds/double_ended_priority_queue.hpp\"\
    \n\n/**\n * @brief double ended priority queue\n * @docs docs/ds/double_ended_priority_queue.md\n\
    \ */\n\n#line 2 \"ds/erasable_priority_queue.hpp\"\n\n#line 4 \"ds/erasable_priority_queue.hpp\"\
    \n\n/**\n * @brief \u6D88\u305B\u308B priority queue\n * @docs docs/ds/erasable_priority_queue.md\n\
    \ */\n\n// Compare \u306F\u3001less \u304C\u6607\u9806\u3067 greater \u304C\u964D\
    \u9806\n// \u6D88\u3057\u3059\u304E\u306A\u3044\u65B9\u6CD5\u306F\u672A\u5B9F\u88C5\
    \ntemplate <class T, class Compare = less<T>>\nstruct ErasablePriorityQueue\n\
    {\nprivate:\n  struct ReverseCompare\n  {\n    Compare comp;\n    bool operator()(const\
    \ T &a, const T &b) const { return comp(b, a); }\n  };\n  priority_queue<T, vc<T>,\
    \ ReverseCompare> body, era;\n  void normalize()\n  {\n    while (!era.empty()\
    \ && body.top() == era.top())\n      body.pop(), era.pop();\n  }\n\npublic:\n\
    \  ErasablePriorityQueue() {}\n  template <class It>\n  ErasablePriorityQueue(It\
    \ begi, It endi) : body(begi, endi) {}\n  void push(const T &x)\n  {\n    body.push(x);\n\
    \    normalize();\n  }\n  void pop()\n  {\n    body.pop();\n    normalize();\n\
    \  }\n  // x \u304C\u5B58\u5728\u3059\u308B\u3053\u3068\u3092\u30E6\u30FC\u30B6\
    \u304C\u4FDD\u8A3C\u3059\u308B\n  void erase(const T &x)\n  {\n    era.push(x);\n\
    \    normalize();\n  }\n  bool empty() const { return body.empty(); }\n  T top()\
    \ const { return body.top(); }\n\n  vc<T> content() const\n  {\n    auto body2\
    \ = body, era2 = era;\n    vc<T> res;\n    while (!body2.empty())\n    {\n   \
    \   if (!era2.empty() && body2.top() == era2.top())\n        body2.pop(), era2.pop();\n\
    \      else\n        res.eb(body2.top()), body2.pop();\n    }\n    return res;\n\
    \  }\n};\n#line 11 \"ds/double_ended_priority_queue.hpp\"\n\ntemplate <class T>\n\
    struct DoubleEndedPriorityQueue\n{\nprivate:\n  ErasablePriorityQueue<T> mn;\n\
    \  ErasablePriorityQueue<T, greater<T>> mx;\n\npublic:\n  DoubleEndedPriorityQueue()\
    \ {}\n  template <class It>\n  DoubleEndedPriorityQueue(It begi, It endi) : mn(begi,\
    ...
    \ }\n\n  vc<T> content() const { return mn.content(); }\n};\n#line 19 \"verify/yosupo/double_ended_priority_queue.test.cpp\"\
    \n\nvoid init() {}\n\nvoid main2()\n{\n  LL(N, Q);\n  VEC(ll, N, S);\n  DoubleEndedPriorityQueue<ll>\
    \ pque(ALL(S));\n  rep(_, Q)\n  {\n    LL(t);\n    if (t == 0)\n    {\n      LL(x);\n\
    \      pque.push(x);\n    }\n    else if (t == 1)\n      PRINT(pque.extract_min());\n\
    \    else if (t == 2)\n      PRINT(pque.extract_max());\n  }\n}\n\nvoid test()\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 45 \"verify/yosupo/double_ended_priority_queue.test.cpp\"\
