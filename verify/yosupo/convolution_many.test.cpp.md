...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/convolution_many.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.yosupo.jp/problem/product_of_polynomial_sequence\"\n\n#define\
    ...
    \ 19 \"verify/yosupo/convolution_many.test.cpp\"\nusing mint = modint998244353;\n\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 47 \"verify/yosupo/convolution_many.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/yosupo/convolution_many.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo/convolution_many.test.cpp
- /verify/verify/yosupo/convolution_many.test.cpp.html
