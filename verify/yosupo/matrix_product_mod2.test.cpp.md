...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/matrix_product_mod2.test.cpp\"\n#define PROBLEM\
    ...
    \ res[i] = randint<T>(T(l), T(r) - T(k));\n  sort(ALL(res));\n  repi(i, k) res[i]\
    \ += i;\n  if (!does_sort)\n    shuffle(ALL(res), mt);\n  return res;\n}\n#line\
    \ 2 \"math/linalg/matrix_mod2.hpp\"\n\n#line 4 \"math/linalg/matrix_mod2.hpp\"\
    ...
    \    }\n    return {true, sol, basis};\n  }\n};\n#line 18 \"verify/yosupo/matrix_product_mod2.test.cpp\"\
    \n\nvoid init() {}\n\nvoid main2()\n{\n  LL(N, M, K);\n  VEC(string, N, A_);\n\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 34 \"verify/yosupo/matrix_product_mod2.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/yosupo/matrix_product_mod2.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo/matrix_product_mod2.test.cpp
- /verify/verify/yosupo/matrix_product_mod2.test.cpp.html
