...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/convolution_arbitrary_dynamic.test.cpp\"\n\
    ...
    \    else\n      return std::hash<mint>{}(x);\n  }\n};\n#line 18 \"verify/yosupo/convolution_arbitrary_dynamic.test.cpp\"\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 37 \"verify/yosupo/convolution_arbitrary_dynamic.test.cpp\"\
...
layout: document
redirect_from:
- /verify/verify/yosupo/convolution_arbitrary_dynamic.test.cpp
- /verify/verify/yosupo/convolution_arbitrary_dynamic.test.cpp.html
