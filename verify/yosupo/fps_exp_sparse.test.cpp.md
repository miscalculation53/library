...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/fps_exp_sparse.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.yosupo.jp/problem/exp_of_formal_power_series_sparse\"\n\n#define\
    ...
    \ c); }\n};\n#line 18 \"verify/yosupo/fps_exp_sparse.test.cpp\"\nusing mint =\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 43 \"verify/yosupo/fps_exp_sparse.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/yosupo/fps_exp_sparse.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo/fps_exp_sparse.test.cpp
- /verify/verify/yosupo/fps_exp_sparse.test.cpp.html
