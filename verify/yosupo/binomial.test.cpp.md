...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/binomial.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/binomial_coefficient_prime_mod\"\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 17 \"verify/yosupo/binomial.test.cpp\"\
    ...
    \    else\n      return std::hash<mint>{}(x);\n  }\n};\n#line 19 \"verify/yosupo/binomial.test.cpp\"\
    ...
    \  {\n    if (n == 0 && k == 0)\n      return 1;\n    return C(n + k - 1, k);\n\
    \  }\n};\n#line 24 \"verify/yosupo/binomial.test.cpp\"\nusing bi = Binomial<mint>;\n\
    \nvoid init() {}\n\nvoid main2()\n{\n  LL(T, M);\n  mint::set_mod(200003);\n \
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 48 \"verify/yosupo/binomial.test.cpp\"\
...
layout: document
redirect_from:
- /verify/verify/yosupo/binomial.test.cpp
- /verify/verify/yosupo/binomial.test.cpp.html
