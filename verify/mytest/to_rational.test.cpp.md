...
data:
  ...
  bundledCode: "#line 1 \"verify/mytest/to_rational.test.cpp\"\n#define PROBLEM \"\
    https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=ITP1_1_A\"\n\n#line\
    ...
    \    else\n      return std::hash<mint>{}(x);\n  }\n};\n#line 2 \"math/modint/to_rational.hpp\"\
    \n\n#line 4 \"math/modint/to_rational.hpp\"\n\n#line 2 \"math/svp2d.hpp\"\n\n\
    #line 4 \"math/svp2d.hpp\"\n\n#line 6 \"math/svp2d.hpp\"\n\n/**\n * @brief \u6700\
    \u77ED\u30D9\u30AF\u30C8\u30EB\u554F\u984C\uFF08$2$ \u6B21\u5143\uFF09\n * @docs\
    \ docs/math/svp2d.md\n */\n\n// \u5165\u529B: a = (a1, a2), b = (b1, b2)\n// \u51FA\
    \u529B: \u6574\u6570 x, y \u3092\u7528\u3044\u3066 v = (v1, v2) = xa + yb \u3068\
    \u8868\u3055\u308C\u308B\u30D9\u30AF\u30C8\u30EB\u306E\u3046\u3061\u3001\n// \
    \     \u30CE\u30EB\u30E0\u306E 2 \u4E57 v1^2 + v2^2 \u304C\u6700\u5C0F\u306E\u3082\
    \u306E\u306E\u3072\u3068\u3064 (\u7B26\u53F7\u306F\u4E0D\u5B9A)\n// T \u306F\u6574\
    \u6570\u3001U \u306F T \u306E 2 \u500D\u306E\u30D3\u30C3\u30C8\u6570\n// \u521D\
    \u671F\u5024\u306E \u221A2 \u500D\u304C T \u304B\u3089\u6EA2\u308C\u306A\u3044\
    ...
    \ = a;\n  auto [b1, b2] = b;\n  if ((U)a1 * a1 + (U)a2 * a2 < (U)b1 * b1 + (U)b2\
    \ * b2)\n    swap(a1, b1), swap(a2, b2);\n  while ((U)a1 * a1 + (U)a2 * a2 > (U)b1\
    \ * b1 + (U)b2 * b2)\n  {\n    swap(a1, b1), swap(a2, b2);\n    T k = divround<U>((U)a1\
    \ * b1 + (U)a2 * b2, (U)a1 * a1 + (U)a2 * a2);\n    b1 -= k * a1, b2 -= k * a2;\n\
    \  }\n  return {a1, a2};\n}\n#line 6 \"math/modint/to_rational.hpp\"\n\n/**\n\
    \ * @brief modint \u3092\u6709\u7406\u6570\u306B\n * @docs docs/math/modint/to_rational.md\n\
    \ */\n\ntemplate <class mint>\npair<decltype(mint(0).val()), decltype(mint(0).val())>\n\
    mint_to_rat(const mint &x)\n{\n  auto [p, q] = svp2d({x.val(), 1}, {mint::mod(),\
    \ 0});\n  if (q < 0)\n    p = -p, q = -q;\n  return {p, q};\n}\n\n#if __cplusplus\
    ...
    \    {\n      if constexpr (!std::ranges::range<T> && std::invocable<mint_to_rat_fn,\
    \ decltype(std::forward<T>(t))>)\n      {\n        return mint_to_rat_fn{}(std::forward<T>(t));\n\
    \      }\n      else if constexpr (std::ranges::range<T>)\n      {\n        using\
    \ Ref = std::ranges::range_reference_t<T>;\n\n        if constexpr (std::invocable<mint_to_rat_fn,\
    \ decltype(std::forward<Ref>(std::declval<Ref>()))>)\n        {\n          return\
    \ std::forward<T>(t) | std::views::transform(mint_to_rat_fn{});\n        }\n \
    \       else if constexpr (std::ranges::range<Ref>)\n        {\n          return\
    \ std::forward<T>(t) | std::views::transform([this](auto &&inner)\n          \
    \                                                  { return (*this)(std::forward<decltype(inner)>(inner));\
    \ });\n        }\n        else\n        {\n          static_assert(false);\n \
    \       }\n      }\n      else\n      {\n        static_assert(false);\n     \
    \ }\n    }\n  };\n\n  template <typename T>\n    requires(!std::ranges::range<T>\
    \ && std::invocable<mint_to_rat_fn, T>)\n  constexpr auto operator|(T &&t, const\
  ...
  verifiedWith: []
documentation_of: verify/mytest/to_rational.test.cpp
layout: document
redirect_from:
- /verify/verify/mytest/to_rational.test.cpp
- /verify/verify/mytest/to_rational.test.cpp.html
