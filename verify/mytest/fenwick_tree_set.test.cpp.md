...
data:
  ...
  bundledCode: "#line 1 \"verify/mytest/fenwick_tree_set.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=ITP1_1_A\"\n\n#line\
    ...
    ** (\u306A\u3051\u308C\u3070 size())\n  template <class T, class I = ll>\n  inline\
    ...
    };\n#line 5 \"verify/mytest/fenwick_tree_set.test.cpp\"\n\n// fenwick tree \u306E\
    \u4E8C\u5206\u63A2\u7D22\nvoid test1()\n{\n  ll n = randint(1, 10);\n  vl a(n);\n\
    ...
    \ k) == fw.gt_min_in_multiset(k));\n    assert(geq_min(a, k) == fw.geq_min_in_multiset(k));\n\
    \  }\n}\n\n// fenwick tree 01 \u3092\u4F7F\u3063\u305F\u96C6\u5408\u306E\u7BA1\
    \u7406\nvoid test4()\n{\n  ll n = randint(1, 20);\n  vl a(n);\n  rep(i, n) a[i]\
    \ = randint(1, 10);\n  sortunique(a);\n  n = a.size();\n  FenwickTree01<ll, uint8_t>\
  ...
  verifiedWith: []
documentation_of: verify/mytest/fenwick_tree_set.test.cpp
layout: document
redirect_from:
- /verify/verify/mytest/fenwick_tree_set.test.cpp
- /verify/verify/mytest/fenwick_tree_set.test.cpp.html
