...
data:
  ...
  bundledCode: "#line 1 \"verify/mytest/modint_set_map.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=ITP1_1_A\"\n\n#line\
    ...
    \    else\n      return std::hash<mint>{}(x);\n  }\n};\n#line 4 \"verify/mytest/modint_set_map.test.cpp\"\
    \n\nint main()\n{\n  \n  PRINT(\"Hello World\");\n}\n"
  ...
  verifiedWith: []
documentation_of: verify/mytest/modint_set_map.test.cpp
layout: document
redirect_from:
- /verify/verify/mytest/modint_set_map.test.cpp
- /verify/verify/mytest/modint_set_map.test.cpp.html
