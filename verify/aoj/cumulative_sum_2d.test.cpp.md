...
data:
  ...
  bundledCode: "#line 1 \"verify/aoj/cumulative_sum_2d.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=0560\"\n\n#define\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 17 \"verify/aoj/cumulative_sum_2d.test.cpp\"\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 46 \"verify/aoj/cumulative_sum_2d.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/aoj/cumulative_sum_2d.test.cpp
layout: document
redirect_from:
- /verify/verify/aoj/cumulative_sum_2d.test.cpp
- /verify/verify/aoj/cumulative_sum_2d.test.cpp.html
