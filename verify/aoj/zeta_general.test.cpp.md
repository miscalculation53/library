...
data:
  ...
  attributes:
    ...
    PROBLEM: https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=3184
    links:
    - https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=3184
  bundledCode: "#line 1 \"verify/aoj/zeta_general.test.cpp\"\n#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=3184\"\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 17 \"verify/aoj/zeta_general.test.cpp\"\
    ...
    \ */\n\n// \u7DDA\u578B\u5199\u50CF linear_map: T^k \u2192 T^k \u306E\u30C6\u30F3\
    \u30BD\u30EB\u51AA\u3092 k^n \u6B21\u5143\u30D9\u30AF\u30C8\u30EB v \u306B\u4F5C\
    \u7528\u3055\u305B\u308B\n// linear_map \u306F array<T, k>(array<T, k>) \u3068\
    \u3057\u3066\u6E21\u3059 (\u7834\u58CA\u7684\u306B\u5909\u66F4\u3057\u3066\u3082\
    \ OK)\n// v \u3092\u7834\u58CA\u7684\u306B\u5909\u66F4\u3059\u308B\n// linear_map\
    \ \u306E\u547C\u3073\u51FA\u3057\u304C O(n k^{n-1}) \u56DE\ntemplate <int k, class\
    \ F, class T>\nvoid tensor_power_array_destructive(const F &linear_map, vc<T>\
    \ &v)\n{\n  static_assert(k >= 2);\n  const int len = v.size();\n  if (len ==\
    \ 0)\n    return;\n  {\n    int len_ = len;\n    while (len_ % k == 0)\n     \
    \ len_ /= k;\n    assert(len_ == 1 && \"v.size() must be a power of k\");\n  }\n\
    \  for (int d = 1; d < len; d *= k)\n  {\n    repi(iu, 0, len, d * k) repi(i,\
    \ iu, iu + d)\n    {\n      array<T, k> tmp;\n      repi(j, k) tmp[j] = v[i +\
    \ j * d];\n      tmp = linear_map(tmp);\n      repi(j, k) v[i + j * d] = tmp[j];\n\
    \    }\n  }\n}\n\n// \u7DDA\u578B\u5199\u50CF linear_map: T^k \u2192 T^k \u306E\
    \u30C6\u30F3\u30BD\u30EB\u51AA\u3092 k^n \u6B21\u5143\u30D9\u30AF\u30C8\u30EB\
    \ v \u306B\u4F5C\u7528\u3055\u305B\u308B\n// linear_map \u306F array<T, k>(array<T,\
    \ k>) \u3068\u3057\u3066\u6E21\u3059 (\u7834\u58CA\u7684\u306B\u5909\u66F4\u3057\
    \u3066\u3082 OK)\n// linear_map \u306E\u547C\u3073\u51FA\u3057\u304C O(n k^{n-1})\
    \ \u56DE\ntemplate <int k, class F, class T>\nvc<T> tensor_power_array(const F\
    \ &linear_map, vc<T> v)\n{\n  tensor_power_array_destructive<k>(linear_map, v);\n\
    \  return v;\n}\n\n// SR \u306F\u534A\u74B0\n// k \xD7 k \u884C\u5217 mat \u306E\
    \u30AF\u30ED\u30CD\u30C3\u30AB\u30FC\u51AA\u3092 k^n \u6B21\u5143\u30D9\u30AF\u30C8\
    \u30EB v \u306B\u4F5C\u7528\u3055\u305B\u308B\n// v \u3092\u7834\u58CA\u7684\u306B\
    \u5909\u66F4\u3059\u308B\n// O(n k^{n+1}) \u6642\u9593\ntemplate <class SR, int\
    \ k>\nvoid kronecker_power_array_destructive(const array<array<typename SR::S,\
    \ k>, k> &mat, vc<typename SR::S> &v)\n{\n  using S = typename SR::S;\n  auto\
    \ linear_map = [&](const array<S, k> &arr) -> array<S, k>\n  {\n    array<S, k>\
    \ res;\n    fill(ALL(res), SR::e0());\n    repi(i, k) repi(j, k) res[i] = SR::add(res[i],\
    \ SR::mul(mat[i][j], arr[j]));\n    return res;\n  };\n  tensor_power_array_destructive<k>(linear_map,\
    \ v);\n}\n\n// SR \u306F\u534A\u74B0\n// k \xD7 k \u884C\u5217 mat \u306E\u30AF\
    \u30ED\u30CD\u30C3\u30AB\u30FC\u51AA\u3092 k^n \u6B21\u5143\u30D9\u30AF\u30C8\u30EB\
    \ v \u306B\u4F5C\u7528\u3055\u305B\u308B\n// O(n k^{n+1}) \u6642\u9593\ntemplate\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 61 \"verify/aoj/zeta_general.test.cpp\"\
    \nMain<init, main2, test> main_dummy;\nint main() {}\n"
  code: "#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=3184\"\
    \n\n#define SINGLE_TESTCASE\n// #define MULTI_TESTCASE\n// #define AOJ_TESTCASE\n\
    \n#ifndef LOCAL\n#define FAST_IO\n// #define FAST_CIO\n// #define INTERACTIVE\n\
    #endif\n\n#define INF 4'000'000'000'000'000'037LL\n#define EPS 1e-11\n\n#include\
    ...
    \  rep(i, Q) A.at(i) = stol(S.at(i), nullptr, 3);\n  dump(S, A);\n\n  vl f(ipow(3,\
    \ M), INF);\n  rep(i, Q) chmin(f.at(A.at(i)), i);\n  auto g = zeta_supset_general<MonoidMin<ll>,\
    \ 3>(f);\n  dump(g | cp::index());\n  string ans(Q, '0');\n  rep(i, Q)\n  {\n\
  ...
  verifiedWith: []
documentation_of: verify/aoj/zeta_general.test.cpp
layout: document
redirect_from:
- /verify/verify/aoj/zeta_general.test.cpp
- /verify/verify/aoj/zeta_general.test.cpp.html
