...
data:
  ...
  bundledCode: "#line 1 \"verify/aoj/rooted_tree_from_edges.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=ALDS1_7_A&lang=ja\"\
    ...
    \ res[i] = randint<T>(T(l), T(r) - T(k));\n  sort(ALL(res));\n  repi(i, k) res[i]\
    \ += i;\n  if (!does_sort)\n    shuffle(ALL(res), mt);\n  return res;\n}\n#line\
    \ 17 \"verify/aoj/rooted_tree_from_edges.test.cpp\"\n\n#line 2 \"graph/tree/rooted_tree.hpp\"\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 65 \"verify/aoj/rooted_tree_from_edges.test.cpp\"\
  ...
  code: "#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=ALDS1_7_A&lang=ja\"\
    ...
    \  }\n  RootedTree<ll> G(N, UV, root);\n  rep(v, N)\n  {\n    WRITE(\"node \"\
    , v, \": parent = \", G.parent(v), \", depth = \", G.depth(v), \", \");\n    if\
    \ (G.parent(v) == -1)\n      WRITE(\"root\");\n    else if (G.children(v).empty())\n\
    \      WRITE(\"leaf\");\n    else\n      WRITE(\"internal node\");\n    WRITE(\"\
    , [\");\n    auto chi = G.children(v);\n    rep(i, chi.size())\n    {\n      if\
    \ (i)\n        WRITE(\", \");\n      WRITE(chi.at(i));\n    }\n    WRITE(\"]\\\
  ...
  verifiedWith: []
documentation_of: verify/aoj/rooted_tree_from_edges.test.cpp
layout: document
redirect_from:
- /verify/verify/aoj/rooted_tree_from_edges.test.cpp
- /verify/verify/aoj/rooted_tree_from_edges.test.cpp.html
