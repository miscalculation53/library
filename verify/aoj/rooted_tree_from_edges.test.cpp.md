...
data:
  ...
  bundledCode: "#line 1 \"verify/aoj/rooted_tree_from_edges.test.cpp\"\n#define PROBLEM\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 17 \"verify/aoj/rooted_tree_from_edges.test.cpp\"\
    ...
    \      f(l, r, false);\n    }\n  }\n};\n#line 19 \"verify/aoj/rooted_tree_from_edges.test.cpp\"\
    \n\nvoid init()\n{\n  oj(mt.seed(random_device()()));\n}\n\nvoid main2()\n{\n\
    \  LL(N);\n  vpll UV;\n  ll root = 0;\n  rep(i, N) root ^= i;\n  vc<vc<int>> C(N);\n\
    \  rep(i, N)\n  {\n    LL(v, k);\n    VEC(int, k, cs);\n    C[v] = cs;\n    fe(c\
    \ : cs) root ^= c, UV.eb(v, c);\n  }\n  RootedTree G(N, UV, root);\n  rep(v, N)\n\
    \  {\n    WRITE(\"node \", v, \": parent = \", v == G.root() ? -1 : G.parent(v),\
    \ \", depth = \", G.depth(v), \", \");\n    if (v == G.root())\n      WRITE(\"\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 68 \"verify/aoj/rooted_tree_from_edges.test.cpp\"\
