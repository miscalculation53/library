...
data:
  ...
  bundledCode: "#line 1 \"verify/aoj/connected_components.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=ALDS1_11_D\"\n\n\
    ...
    \ res[i] = randint<T>(T(l), T(r) - T(k));\n  sort(ALL(res));\n  repi(i, k) res[i]\
    \ += i;\n  if (!does_sort)\n    shuffle(ALL(res), mt);\n  return res;\n}\n#line\
    \ 17 \"verify/aoj/connected_components.test.cpp\"\n\n#line 2 \"graph/connected_components.hpp\"\
    \n\n#line 4 \"graph/connected_components.hpp\"\n\n#line 2 \"graph/graph.hpp\"\n\
    \n#line 2 \"ds/csr.hpp\"\n\n#line 4 \"ds/csr.hpp\"\n\n/**\n * @brief CSR\n * @docs\
    ...
    \ */\n\n// \u7121\u5411\u30B0\u30E9\u30D5\u3092\u53D7\u3051\u53D6\u308A\u3001\u5404\
    \u9802\u70B9\u306E\u9023\u7D50\u6210\u5206\u306E\u756A\u53F7\u3092\u8FD4\u3059\
    \ntemplate <class I = ll, class Cost>\nvc<I> connected_component_ids(const GraphUndirected<Cost>\
    \ &g)\n{\n  const int n = g.size();\n  vc<I> res(n, -1);\n  int id = 0;\n  MyQueue<int>\
    \ que;\n  repi(sv, n)\n  {\n    if (res[sv] != -1)\n      continue;\n    res[sv]\
    \ = id;\n    que.clear();\n    que.push(sv);\n    while (!que.empty())\n    {\n\
    \      int v = que.front();\n      que.pop();\n      fe(nv : g.out_edges(v))\n\
    \      {\n        if (res[nv] != -1)\n          continue;\n        res[nv] = id;\n\
    \        que.push(nv);\n      }\n    }\n    id++;\n  }\n  return res;\n}\n#line\
    \ 19 \"verify/aoj/connected_components.test.cpp\"\n\nvoid init()\n{\n  oj(mt.seed(random_device()()));\n\
    ...
    n[MULTI_TESTCASE]\\n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"\
    T\");\n      IN(uint, T);\n      while (T--)\n      {\n        dump(\"new testcase\"\
    );\n        main2();\n      }\n    }\n    #endif\n  }\n};\n#line 47 \"verify/aoj/connected_components.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/aoj/connected_components.test.cpp
layout: document
redirect_from:
- /verify/verify/aoj/connected_components.test.cpp
- /verify/verify/aoj/connected_components.test.cpp.html
