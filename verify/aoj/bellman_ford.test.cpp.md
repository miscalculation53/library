...
data:
  ...
  bundledCode: "#line 1 \"verify/aoj/bellman_ford.test.cpp\"\n#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=GRL_1_B&lang=ja\"\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 17 \"verify/aoj/bellman_ford.test.cpp\"\
    \n\n#line 2 \"graph/sssp.hpp\"\n\n#line 4 \"graph/sssp.hpp\"\n\n#line 2 \"graph/graph.hpp\"\
    \n\n#line 2 \"ds/csr.hpp\"\n\n#line 4 \"ds/csr.hpp\"\n\n/**\n * @brief CSR\n *\
    ...
    \  }\n};\n#line 19 \"verify/aoj/bellman_ford.test.cpp\"\n\nvoid init()\n{\n  oj(mt.seed(random_device()()));\n\
    }\n\nvoid main2()\n{\n  LL(N, M, S);\n  VEC(tlll, M, UVW);\n  ShortestPath<true,\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 48 \"verify/aoj/bellman_ford.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/aoj/bellman_ford.test.cpp
layout: document
redirect_from:
- /verify/verify/aoj/bellman_ford.test.cpp
- /verify/verify/aoj/bellman_ford.test.cpp.html
