...
data:
  ...
  bundledCode: "#line 1 \"verify/aoj/range_upd_range_sum.test.cpp\"\n#define PROBLEM\
    \ \"https://onlinejudge.u-aizu.ac.jp/courses/library/3/DSL/2/DSL_2_I\"\n\n#define\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 17 \"verify/aoj/range_upd_range_sum.test.cpp\"\
    ...
    \ AM::op(dat[r], sm);\n            r--;\n          }\n        }\n        return\
    \ r + 1 - siz;\n      }\n      sm = AM::op(dat[r], sm);\n    } while ((r & -r)\
    \ != r);\n    return 0;\n  }\n};\n#line 2 \"math/algebra/acted_monoid/upd_sum.hpp\"\
    ...
    }\n\nvoid main2()\n{\n  LL(N, Q);\n  vl vec(N, 0);\n  LazySegmentTree<ActedMonoidUpdSum<ll>>\
    \ seg(ALL(vec));\n  rep(_, Q)\n  {\n    LL(t);\n    if (t == 0)\n    {\n     \
    \ LL(l, r, x);\n      r++;\n      seg.apply(l, r, x);\n    }\n    else if (t ==\
    ...
    n[MULTI_TESTCASE]\\n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"\
    T\");\n      IN(uint, T);\n      while (T--)\n      {\n        dump(\"new testcase\"\
    );\n        main2();\n      }\n    }\n    #endif\n  }\n};\n#line 56 \"verify/aoj/range_upd_range_sum.test.cpp\"\
  ...
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/3/DSL/2/DSL_2_I\"\
    ...
    \n#include \"math/algebra/acted_monoid/upd_sum.hpp\"\n\nvoid init()\n{\n  oj(mt.seed(random_device()()));\n\
    }\n\nvoid main2()\n{\n  LL(N, Q);\n  vl vec(N, 0);\n  LazySegmentTree<ActedMonoidUpdSum<ll>>\
    \ seg(ALL(vec));\n  rep(_, Q)\n  {\n    LL(t);\n    if (t == 0)\n    {\n     \
    \ LL(l, r, x);\n      r++;\n      seg.apply(l, r, x);\n    }\n    else if (t ==\
    \ 1)\n    {\n      LL(l, r);\n      r++;\n      PRINT(seg.prod(l, r).val);\n \
  ...
  verifiedWith: []
documentation_of: verify/aoj/range_upd_range_sum.test.cpp
layout: document
redirect_from:
- /verify/verify/aoj/range_upd_range_sum.test.cpp
- /verify/verify/aoj/range_upd_range_sum.test.cpp.html
