...
data:
  ...
  bundledCode: "#line 1 \"verify/aoj/aoj2995.test.cpp\"\n#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=2995\"\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 17 \"verify/aoj/aoj2995.test.cpp\"\n\n\
    ...
    \ / 2); }\n};\n#line 2 \"graph/tree/dsu_on_tree.hpp\"\n\n#line 2 \"graph/tree/rooted_tree.hpp\"\
    ...
    \    reset(v);\n  };\n  dfs(dfs, g.root(), true);\n}\n#line 20 \"verify/aoj/aoj2995.test.cpp\"\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 130 \"verify/aoj/aoj2995.test.cpp\"\
  ...
  code: "#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=2995\"\
    ...
    \    {\n      cmp_cnt = n;\n      min_leader = 0, max_leader = n - 1;\n      ans\
    \ = 0;\n    }\n  };\n  using EWeight = EWeight_;\n  template <class UF>\n  static\
    \ void add_edge_diff(UF &uf, int x, int y, EWeight w)\n  {\n    VData &xd = uf.vdat[x],\
    \ &yd = uf.vdat[y];\n    GData &gd = uf.gdat;\n\n    gd.ans -= min(xd.vsum, xd.esum);\n\
    \    gd.ans -= min(yd.vsum, yd.esum);\n\n    xd.vsum += yd.vsum;\n    xd.esum\
    \ += yd.esum + w;\n    if constexpr (need_vlist)\n    {\n      xd.vlist.insert(xd.vlist.end(),\
    \ ALL(yd.vlist));\n      yd.vlist.clear();\n    }\n    gd.cmp_cnt--;\n    while\
  ...
  verifiedWith: []
documentation_of: verify/aoj/aoj2995.test.cpp
layout: document
redirect_from:
- /verify/verify/aoj/aoj2995.test.cpp
- /verify/verify/aoj/aoj2995.test.cpp.html
