...
data:
  ...
  bundledCode: "#line 1 \"verify/aoj/segmented_sieve.test.cpp\"\n#define PROBLEM \"\
    ...
    \ r + 1, p) f(p, x);\n}\n#line 18 \"verify/aoj/segmented_sieve.test.cpp\"\n\n\
    void init() {}\n\nvoid main2()\n{\n  LL(L, R);\n  vl cnt(R - L + 1, 0);\n  vl\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 51 \"verify/aoj/segmented_sieve.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/aoj/segmented_sieve.test.cpp
layout: document
redirect_from:
- /verify/verify/aoj/segmented_sieve.test.cpp
- /verify/verify/aoj/segmented_sieve.test.cpp.html
