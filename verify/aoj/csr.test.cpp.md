...
data:
  ...
  bundledCode: "#line 1 \"verify/aoj/csr.test.cpp\"\n#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=ALDS1_11_A&lang=jp\"\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 17 \"verify/aoj/csr.test.cpp\"\n\n#line\
    \ 2 \"ds/csr.hpp\"\n\n#line 4 \"ds/csr.hpp\"\n\n/**\n * @brief CSR\n * @docs docs/ds/csr.md\n\
...
layout: document
redirect_from:
- /verify/verify/aoj/csr.test.cpp
- /verify/verify/aoj/csr.test.cpp.html
