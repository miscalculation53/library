...
data:
  ...
  bundledCode: "#line 1 \"verify/aoj/inversion.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/lesson/1/ALDS1/5/ALDS1_5_D\"\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 17 \"verify/aoj/inversion.test.cpp\"\n\
    ...
    ** (\u306A\u3051\u308C\u3070 size())\n  template <class T, class I = ll>\n  inline\
    ...
    \ nl, int nr)\n  {\n    while (nl < l)\n      lmm();\n    while (r < nr)\n   \
    \   rpp();\n    while (l < nl)\n      lpp();\n    while (nr < r)\n      rmm();\n\
    \  }\n};\n#line 19 \"verify/aoj/inversion.test.cpp\"\n\nvoid init() {}\n\nvoid\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 33 \"verify/aoj/inversion.test.cpp\"\
  ...
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/lesson/1/ALDS1/5/ALDS1_5_D\"\
    ...
    \n\nvoid init() {}\n\nvoid main2()\n{\n  assert(inversion_number(vl{1, 1}) ==\
    \ 0);\n  LL(N);\n  VEC(ll, N, A);\n  PRINT(inversion_number(A));\n}\n\nvoid test()\
  ...
  verifiedWith: []
documentation_of: verify/aoj/inversion.test.cpp
layout: document
redirect_from:
- /verify/verify/aoj/inversion.test.cpp
- /verify/verify/aoj/inversion.test.cpp.html
