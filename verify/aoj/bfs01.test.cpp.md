...
data:
  ...
  bundledCode: "#line 1 \"verify/aoj/bfs01.test.cpp\"\n#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=2945\"\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 17 \"verify/aoj/bfs01.test.cpp\"\n\n#line\
    ...
    \  }\n};\n#line 19 \"verify/aoj/bfs01.test.cpp\"\n\nvoid init()\n{\n  oj(mt.seed(random_device()()));\n\
    }\n\nvoid main2()\n{\n  LL(N);\n  if (N == 0)\n    exit(0);\n  LL(A, B, C, D);\n\
    \  A--, B--, C--, D--;\n  VEC(pll, N + 1, XY);\n  offset(XY, pll{-1, -1});\n \
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 74 \"verify/aoj/bfs01.test.cpp\"\n\
  ...
  code: "#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=2945\"\
    ...
    \ B, C, D, MAX(X), MAX(Y)}) + 1;\n  vtlll UVW;\n  rep(i, M) rep(j, M)\n  {\n \
    \   if (i != M - 1)\n    {\n      ll u = i * M + j;\n      ll v = (i + 1) * M\
    \ + j;\n      UVW.eb(u, v, A <= i + 1 && i + 1 <= C && B <= j && j <= D ? 0 :\
    \ 1);\n      UVW.eb(v, u, A <= i && i <= C && B <= j && j <= D ? 0 : 1);\n   \
    \ }\n    if (j != M - 1)\n    {\n      ll u = i * M + j;\n      ll v = i * M +\
    \ (j + 1);\n      UVW.eb(u, v, A <= i && i <= C && B <= j + 1 && j + 1 <= D ?\
    \ 0 : 1);\n      UVW.eb(v, u, A <= i && i <= C && B <= j && j <= D ? 0 : 1);\n\
    \    }\n  }\n  ShortestPath<true, ll> G(M * M, UVW);\n\n  ll ans = 0;\n  rep(i,\
    \ N)\n  {\n    ll s = X.at(i) * M + Y.at(i);\n    ll t = X.at(i + 1) * M + Y.at(i\
    \ + 1);\n    ll d = G.solve(s, t).at(t);\n    ans += d;\n  }\n  PRINT(ans);\n\
  ...
  verifiedWith: []
documentation_of: verify/aoj/bfs01.test.cpp
layout: document
redirect_from:
- /verify/verify/aoj/bfs01.test.cpp
- /verify/verify/aoj/bfs01.test.cpp.html
