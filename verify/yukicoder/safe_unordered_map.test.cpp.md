...
data:
  ...
  bundledCode: "#line 1 \"verify/yukicoder/safe_unordered_map.test.cpp\"\n#define\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 17 \"verify/yukicoder/safe_unordered_map.test.cpp\"\
    \n\n#line 2 \"ds/safe_unordered_map.hpp\"\n\n#line 4 \"ds/safe_unordered_map.hpp\"\
    \n\n/**\n * @brief unordered_map \u306E\u5B89\u5168\u306A\u30CF\u30C3\u30B7\u30E5\
    ...
    \    return splitmix64(x ^ FIXED_RANDOM);\n  }\n};\n#line 19 \"verify/yukicoder/safe_unordered_map.test.cpp\"\
    \n\nvoid init() {}\n\nvoid main2()\n{\n  LL(N, M);\n  VEC(ll, N, A);\n  VEC(ll,\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 42 \"verify/yukicoder/safe_unordered_map.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/yukicoder/safe_unordered_map.test.cpp
layout: document
redirect_from:
- /verify/verify/yukicoder/safe_unordered_map.test.cpp
- /verify/verify/yukicoder/safe_unordered_map.test.cpp.html
