...
data:
  ...
  bundledCode: "#line 1 \"verify/yukicoder/ordered_multiset_fenwick_tree.test.cpp\"\
    ...
    };\n#line 19 \"verify/yukicoder/ordered_multiset_fenwick_tree.test.cpp\"\n\nvoid\
    \ init() {}\n\nvoid main2()\n{\n  LL(Q, K);\n  K--;\n\n  vl vals;\n  vc<pll> queries(Q);\n\
    \  rep(q, Q)\n  {\n    LL(t);\n    if (t == 1)\n    {\n      LL(v);\n      vals.eb(v);\n\
    \      queries.at(q) = {t, v};\n    }\n    else if (t == 2)\n    {\n      queries.at(q)\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 72 \"verify/yukicoder/ordered_multiset_fenwick_tree.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/yukicoder/ordered_multiset_fenwick_tree.test.cpp
layout: document
redirect_from:
- /verify/verify/yukicoder/ordered_multiset_fenwick_tree.test.cpp
- /verify/verify/yukicoder/ordered_multiset_fenwick_tree.test.cpp.html
