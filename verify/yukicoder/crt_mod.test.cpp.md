...
data:
  ...
  bundledCode: "#line 1 \"verify/yukicoder/crt_mod.test.cpp\"\n#define PROBLEM \"\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 17 \"verify/yukicoder/crt_mod.test.cpp\"\
    ...
    \ = (x + u128(m) * (-im * ull(x))) >> 64;\n    if (t >= m) t -= m;\n    return\
    \ (ull)t;\n  }\n  ull inv_reduce(i128 v) const { return reduce(u128(v % m + m)\
    ...
    \    else\n      return std::hash<mint>{}(x);\n  }\n};\n#line 20 \"verify/yukicoder/crt_mod.test.cpp\"\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 54 \"verify/yukicoder/crt_mod.test.cpp\"\
  ...
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/187\"\n\n#define SINGLE_TESTCASE\n\
    ...
    \ ok2 = pre_crt(X_, Y_);\n  assert(ok == ok2);\n  if (!ok)\n    PRINTRETURN(-1);\n\
    \  auto res = crt_mod<mint>(X, Y);\n  auto [r, m] = res;\n  if (MAX(X) == 0)\n\
    \    PRINT(m);\n  else\n    PRINT(r);\n  rep(i, N)\n  {\n    X.at(i) += randint(-ipow(10,\
    \ 9), ipow(10, 9)) * Y.at(i);\n  }\n  auto res2 = crt_mod<mint>(X, Y);\n  auto\
    \ res3 = crt_mod<mint>(X_, Y_);\n  assert(res == res2);\n  assert(res == res3);\n\
...
layout: document
redirect_from:
- /verify/verify/yukicoder/crt_mod.test.cpp
- /verify/verify/yukicoder/crt_mod.test.cpp.html
