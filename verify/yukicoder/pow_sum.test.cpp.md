...
data:
  ...
  bundledCode: "#line 1 \"verify/yukicoder/pow_sum.test.cpp\"\n#define PROBLEM \"\
    ...
    \ c); }\n};\n#line 18 \"verify/yukicoder/pow_sum.test.cpp\"\nusing mint = modint998244353;\n\
    using bi = Binomial<mint>;\nusing fps = FormalPowerSeries<mint>;\n#line 2 \"math/fps/pow_sum.hpp\"\
    ...
    \ n);\n  return f;\n}\n#line 22 \"verify/yukicoder/pow_sum.test.cpp\"\n\nvoid\
    \ init() {}\n\nvoid main2()\n{\n  LL(N, M);\n  VEC(mint, N, A);\n  auto ans =\
    \ pow_sum(A, M + 1);\n  ans.erase(ans.begin());\n  PRINT(ans);\n}\n\nvoid test()\n\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 40 \"verify/yukicoder/pow_sum.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/yukicoder/pow_sum.test.cpp
layout: document
redirect_from:
- /verify/verify/yukicoder/pow_sum.test.cpp
- /verify/verify/yukicoder/pow_sum.test.cpp.html
