...
data:
  ...
  bundledCode: "#line 1 \"verify/yukicoder/poly_rational_sum.test.cpp\"\n#define PROBLEM\
    ...
    \ c); }\n};\n#line 18 \"verify/yukicoder/poly_rational_sum.test.cpp\"\nusing mint\
    ...
    \ res.second.pre(d)};\n  };\n  return dc(dc, 0, fs.size());\n}\n#line 22 \"verify/yukicoder/poly_rational_sum.test.cpp\"\
    \n\nvoid init() {}\n\nvoid main2()\n{\n  LL(N, S);\n  VEC(mint, N, P);\n  fem(p\
    \ : P) p /= S;\n  vc<pair<fps, fps>> fs(N);\n  rep(i, N) fs.at(i) = {{0, P.at(i)\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 49 \"verify/yukicoder/poly_rational_sum.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/yukicoder/poly_rational_sum.test.cpp
layout: document
redirect_from:
- /verify/verify/yukicoder/poly_rational_sum.test.cpp
- /verify/verify/yukicoder/poly_rational_sum.test.cpp.html
