...
data:
  ...
  bundledCode: "#line 1 \"verify/yukicoder/order_mod_euler_phi.test.cpp\"\n#define\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 17 \"verify/yukicoder/order_mod_euler_phi.test.cpp\"\
    ...
    \ 19 \"verify/yukicoder/order_mod_euler_phi.test.cpp\"\n\nvoid init() {}\n\nvoid\
    \ main2()\n{\n  LL(N);\n  if (N == 1)\n    PRINT(1);\n  else\n    PRINT(order_mod(2,\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 34 \"verify/yukicoder/order_mod_euler_phi.test.cpp\"\
  ...
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/1255\"\n\n// #define SINGLE_TESTCASE\n\
    ...
    {\n  LL(N);\n  if (N == 1)\n    PRINT(1);\n  else\n    PRINT(order_mod(2, 2 *\
    \ N - 1, factorize(euler_phi(factorize(2 * N - 1)))));\n}\n\nvoid test() {}\n\n\
