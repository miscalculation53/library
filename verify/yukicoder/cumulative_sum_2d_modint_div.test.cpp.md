...
data:
  ...
  bundledCode: "#line 1 \"verify/yukicoder/cumulative_sum_2d_modint_div.test.cpp\"\
    ...
    \ res[i] = randint<T>(T(l), T(r) - T(k));\n  sort(ALL(res));\n  repi(i, k) res[i]\
    \ += i;\n  if (!does_sort)\n    shuffle(ALL(res), mt);\n  return res;\n}\n#line\
    \ 17 \"verify/yukicoder/cumulative_sum_2d_modint_div.test.cpp\"\n\n#line 2 \"\
    ...
    \    else\n      return std::hash<mint>{}(x);\n  }\n};\n#line 19 \"verify/yukicoder/cumulative_sum_2d_modint_div.test.cpp\"\
    \nusing mint = modint1000000007;\n#line 2 \"math/modint/modint_div.hpp\"\n\n#line\
    \ 4 \"math/modint/modint_div.hpp\"\n\n/**\n * @brief \u96F6\u306E\u91CD\u8907\u5EA6\
    \u3064\u304D modint\n * @docs docs/math/modint/modint_div.md\n */\n\n// \u6709\
    \u7406\u6570\u3092 b*p^c (b \u306F\u5206\u6BCD\u5206\u5B50\u306B p \u304C\u306A\
    \u3044\u6709\u7406\u6570\u3001c \u306F\u6574\u6570)\n// \u3068\u8868\u3057\u305F\
    ...
    #line 2 \"ds/cumulative_sum/cumulative_sum_2d.hpp\"\n\n#line 4 \"ds/cumulative_sum/cumulative_sum_2d.hpp\"\
    ...
    \ 1;\n    const int m = SZ<int>(s[0]) - 1;\n    assert(0 <= li && li <= ri &&\
    \ ri <= n);\n    assert(0 <= lj && lj <= rj && rj <= m);\n    return G::op(G::op(s[ri][rj],\
    \ s[li][lj]), G::inv(G::op(s[ri][lj], s[li][rj])));\n  }\n};\n#line 23 \"verify/yukicoder/cumulative_sum_2d_modint_div.test.cpp\"\
    \n\nvoid init() {}\n\nvoid main2()\n{\n  LL(H, W);\n  VEC2(ll, H, W, A);\n  vvc<mintd>\
    \ B(H, vc<mintd>(W));\n  rep(i, H) rep(j, W) B.at(i).at(j) = mintd(A.at(i).at(j));\n\
    \  CumulativeSum2D<GroupMulDiv<mintd>> cum(B);\n  LL(Q);\n  rep(_, Q)\n  {\n \
    \   LL(r, c);\n    r--, c--;\n    dump(cum.sum(H, W));\n    dump(cum.sum(0, H,\
    \ c, c + 1));\n    dump(cum.sum(r, r + 1, 0, W));\n    dump(B.at(r).at(c));\n\
    \    mintd ans = cum.sum(H, W) / cum.sum(0, H, c, c + 1) / cum.sum(r, r + 1, 0,\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 51 \"verify/yukicoder/cumulative_sum_2d_modint_div.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/yukicoder/cumulative_sum_2d_modint_div.test.cpp
layout: document
redirect_from:
- /verify/verify/yukicoder/cumulative_sum_2d_modint_div.test.cpp
- /verify/verify/yukicoder/cumulative_sum_2d_modint_div.test.cpp.html
