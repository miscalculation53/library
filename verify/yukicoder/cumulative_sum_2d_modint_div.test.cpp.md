...
data:
  ...
  bundledCode: "#line 1 \"verify/yukicoder/cumulative_sum_2d_modint_div.test.cpp\"\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 17 \"verify/yukicoder/cumulative_sum_2d_modint_div.test.cpp\"\
    ...
    \ ModintDiv &rhs) const { return ModintDiv(*this) /= rhs; }\n  friend bool operator==(const\
    \ ModintDiv &lhs, const ModintDiv &rhs)\n  { return lhs.b == rhs.b && lhs.c ==\
    ...
    \ c);\n#endif\n#line 21 \"verify/yukicoder/cumulative_sum_2d_modint_div.test.cpp\"\
