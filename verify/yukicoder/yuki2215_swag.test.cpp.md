...
data:
  ...
  bundledCode: "#line 1 \"verify/yukicoder/yuki2215_swag.test.cpp\"\n#define PROBLEM\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 17 \"verify/yukicoder/yuki2215_swag.test.cpp\"\
    ...
    \  repi(i, c.size()) c_[i] = c[i].val();\n  return c_;\n}\n#line 19 \"verify/yukicoder/yuki2215_swag.test.cpp\"\
    ...
    \    auto tmp(*this);\n    vc<S> res;\n    while (!tmp.empty())\n    {\n     \
    \ res.eb(tmp.front());\n      tmp.pop_front();\n    }\n    return res;\n  }\n\
    };\n#line 42 \"verify/yukicoder/yuki2215_swag.test.cpp\"\n\nvoid init()\n{\n \
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 87 \"verify/yukicoder/yuki2215_swag.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/yukicoder/yuki2215_swag.test.cpp
layout: document
redirect_from:
- /verify/verify/yukicoder/yuki2215_swag.test.cpp
- /verify/verify/yukicoder/yuki2215_swag.test.cpp.html
