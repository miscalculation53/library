...
data:
  ...
  - icon: ':question:'
    ...
    title: "\u7D20\u3079\u304D\u69CB\u9020\u4F53"
  - icon: ':x:'
    path: math/prime/segmented_sieve.hpp
    title: "\u533A\u9593\u7BE9"
  - icon: ':question:'
  ...
  bundledCode: "#line 1 \"verify/yukicoder/segmented_sieve.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=2858\"\n\n#define\
    ...
    #line 5 \"math/prime/segmented_sieve.hpp\"\n\n/**\n * @brief \u533A\u9593\u7BE9\
    \n * @docs docs/math/prime/segmented_sieve.md\n */\n\n// l <= x <= r, p | x, p\
    \ != x \u3092\u6E80\u305F\u3059\u7D20\u6570 p \u3068\u6574\u6570 x \u306E\u7D44\
    \u3059\u3079\u3066\u306B\u5BFE\u3057\u3066 f(p, x) \u3092\u5B9F\u884C\n// m =\
    \ max(r - l, \u221Ar) \u3068\u3057\u3066 O(m loglog m)\ntemplate <class F>\nvoid\
    \ segmented_sieve(ll l, ll r, const F &f)\n{\n  LinearSieve::reserve(sqrtl(r)\
    \ + 1);\n  for(ll p : LinearSieve::primes) rep(x, max(2 * p, divceil(l, p) * p),\
    \ r + 1, p) f(p, x);\n}\n#line 18 \"verify/yukicoder/segmented_sieve.test.cpp\"\
    \n\nvoid init() {}\n\nvoid main2()\n{\n  LL(L, R);\n  vl cnt(R - L + 1, 0);\n\
    ...
    \                 y /= p;\n                      cnt.at(x - L)++;\n          \
    \          } \n                  });\n  ll ans = 0;\n  rep(x, L, R + 1)\n  {\n\
    \    if (val.at(x - L) != 1)\n      cnt.at(x - L)++;\n    if (LinearSieve::is_prime(cnt.at(x\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 51 \"verify/yukicoder/segmented_sieve.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/yukicoder/segmented_sieve.test.cpp
layout: document
redirect_from:
- /verify/verify/yukicoder/segmented_sieve.test.cpp
- /verify/verify/yukicoder/segmented_sieve.test.cpp.html
