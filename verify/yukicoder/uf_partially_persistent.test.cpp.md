...
data:
  ...
  bundledCode: "#line 1 \"verify/yukicoder/uf_partially_persistent.test.cpp\"\n#define\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 17 \"verify/yukicoder/uf_partially_persistent.test.cpp\"\
    \n\n#line 2 \"ds/uf/uf_partially_persistent.hpp\"\n\n#line 4 \"ds/uf/uf_partially_persistent.hpp\"\
    \n\n#line 2 \"ds/uf/uf.hpp\"\n\n#line 4 \"ds/uf/uf.hpp\"\n\n/**\n * @brief UnionFind\n\
    ...
    \   GData &gd = uf.gdat;\n\n    xd.vsum += yd.vsum;\n    xd.esum += yd.esum +\
    \ w;\n    if constexpr (need_vlist)\n    {\n      xd.vlist.insert(xd.vlist.end(),\
    \ ALL(yd.vlist));\n      yd.vlist.clear();\n    }\n    gd.cmp_cnt--;\n    while\
    \ (uf.leader(gd.min_leader) != gd.min_leader)\n      gd.min_leader++;\n    while\
    \ (uf.leader(gd.max_leader) != gd.max_leader)\n      gd.max_leader--;\n  }\n \
    ...
    \ main2()\n{\n  LL(H, W);\n  VEC2(ll, H, W, A);\n\n  UnionFindPartiallyPersistent<UFDataEmpty<>>\
    \ uf(H * W);\n  vc<tlll> UVW;\n  rep(i, H) rep(j, W)\n  {\n    ll u = i * W +\
    \ j;\n    if (i != H - 1)\n    {\n      ll v = (i + 1) * W + j;\n      ll w =\
    \ max(A.at(i).at(j), A.at(i + 1).at(j));\n      UVW.eb(u, v, w);\n    }\n    if\
    \ (j != W - 1)\n    {\n      ll v = i * W + (j + 1);\n      ll w = max(A.at(i).at(j),\
    \ A.at(i).at(j + 1));\n      UVW.eb(u, v, w);\n    }\n  }\n  sort(ALL(UVW), [&](tlll\
    \ t1, tlll t2)\n       { return get<2>(t1) < get<2>(t2); });\n  fec([ u, v, w\
    \ ] : UVW) uf.merge(u, v, w);\n\n  LL(Q);\n  rep(_, Q)\n  {\n    LL(si, sj, ti,\
    \ tj);\n    si--, sj--, ti--, tj--;\n    ll s = si * W + sj;\n    ll t = ti *\
    \ W + tj;\n    auto judge = [&](ll time)\n    { return uf.same(time, s, t); };\n\
    \    ll time = expsearch(judge, 0, true).first;\n    PRINT(get<2>(UVW.at(time\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 69 \"verify/yukicoder/uf_partially_persistent.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/yukicoder/uf_partially_persistent.test.cpp
layout: document
redirect_from:
- /verify/verify/yukicoder/uf_partially_persistent.test.cpp
- /verify/verify/yukicoder/uf_partially_persistent.test.cpp.html
