...
data:
  ...
  bundledCode: "#line 1 \"verify/yukicoder/uf_partially_persistent.test.cpp\"\n#define\
    ...
    \ vt;\n}\n// ----------\n#line 15 \"verify/yukicoder/uf_partially_persistent.test.cpp\"\
    ...
    \ 1};\n#line 22 \"verify/yukicoder/uf_partially_persistent.test.cpp\"\nusing bi\
    ...
    \   if (gid[l] == -1)\n        gid[l] = i++;\n      gid[v] = gid[l];\n    }\n\
    \    return gid;\n  }\n};\n#line 25 \"verify/yukicoder/uf_partially_persistent.test.cpp\"\
    \n\nvoid init() {}\n\nvoid main2()\n{\n  LL(H, W);\n  VEC2(ll, H, W, A);\n\n \
