...
data:
  ...
  bundledCode: "#line 1 \"verify/yukicoder/order_mod_carmichael.test.cpp\"\n#define\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 17 \"verify/yukicoder/order_mod_carmichael.test.cpp\"\
    \n\n#line 2 \"math/prime/large/order_primitive_root.hpp\"\n\n#line 2 \"math/modint/modint.hpp\"\
    ...
    }\n#line 2 \"math/prime/large/euler_phi_carmichael.hpp\"\n\n#line 8 \"math/prime/large/euler_phi_carmichael.hpp\"\
    \n\n/**\n * @brief \u30AA\u30A4\u30E9\u30FC\u306E\u30D5\u30A1\u30A4\u95A2\u6570\
    \u30FB\u30AB\u30FC\u30DE\u30A4\u30B1\u30EB\u95A2\u6570\n * @docs docs/math/prime/large/euler_phi_carmichael.md\n\
    \ */\n\ntemplate <class P>\nll euler_phi(const vc<PrimePower<P>> &fac)\n{\n  ll\
    \ res = 1;\n  fec(pp : fac)\n  {\n    res *= pp.pe / pp.p * (pp.p - 1);\n  }\n\
    \  return res;\n}\n\ntemplate <class P>\nll carmichael(const vc<PrimePower<P>>\
    \ &fac)\n{\n  ll res = 1;\n  fec(pp : fac)\n  {\n    ll tmp = pp.pe / pp.p * (pp.p\
    \ - 1);\n    if (pp.p == 2 && pp.e >= 3)\n      tmp /= 2;\n    res = lcm(res,\
    \ tmp);\n  }\n  return res;\n}\n#line 9 \"math/prime/large/order_primitive_root.hpp\"\
    \n\n/**\n * @brief \u5143\u306E\u4F4D\u6570\u3068\u539F\u59CB\u6839\n * @docs\
    \ docs/math/prime/large/order_primitive_root.md\n */\n\n// https://37zigen.com/primitive-root/#i-4\n\
    ...
    \ 2)\n    return 1;\n  while (true)\n  {\n    ll g = randrange(1, p);\n    if\
    \ (internal_is_primitive_root<mint>(g, p, fac))\n      return g;\n  }\n}\ntemplate\
    \ <class mint, class P>\nll internal_primitive_root_min(ll p, const vc<PrimePower<P>>\
    \ &fac)\n{\n  if (p == 2)\n    return 1;\n  for (int g = 2; g < p; g++)\n  {\n\
    \    if (internal_is_primitive_root<mint>(g, p, fac))\n      return g;\n  }\n\
    \  assert(false);\n}\n\ntemplate <class mint, class P>\nll internal_order_mod(ll\
    \ x, ll m, const vc<PrimePower<P>> &fac)\n{\n  const int k = fac.size();\n  mint::set_mod(m);\n\
    \  vc<ll> a(k);\n  repi(i, k) a[i] = fac[i].pe;\n  auto b = internal::lagrange_basis(a,\
    \ mint(x));\n  ll res = 1;\n  repi(i, k)\n  {\n    mint tmp = b[i];\n    repi(j,\
    \ fac[i].e + 1)\n    {\n      if (tmp == 1)\n        break;\n      tmp = tmp.pow(fac[i].p);\n\
    \      res *= fac[i].p;\n    }\n  }\n  return res;\n}\n\n}; // namespace internal\n\
    \n// m >= 2\n// mod m \u3067\u306E x \u306E\u4F4D\u6570\n// fac \u306B\u306F\u30AA\
    ...
    \ 19 \"verify/yukicoder/order_mod_carmichael.test.cpp\"\n\nvoid init() {}\n\n\
    void main2()\n{\n  LL(N);\n  if (N == 1)\n    PRINT(1);\n  else\n    PRINT(order_mod(2,\
    \ 2 * N - 1, factorize(carmichael(factorize(2 * N - 1)))));\n\n}\n\nvoid test()\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 35 \"verify/yukicoder/order_mod_carmichael.test.cpp\"\
  ...
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/1255\"\n\n// #define SINGLE_TESTCASE\n\
    ...
    {\n  LL(N);\n  if (N == 1)\n    PRINT(1);\n  else\n    PRINT(order_mod(2, 2 *\
    \ N - 1, factorize(carmichael(factorize(2 * N - 1)))));\n\n}\n\nvoid test() {}\n\
...
layout: document
redirect_from:
- /verify/verify/yukicoder/order_mod_carmichael.test.cpp
- /verify/verify/yukicoder/order_mod_carmichael.test.cpp.html
