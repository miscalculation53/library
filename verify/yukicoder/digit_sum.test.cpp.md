...
data:
  ...
  attributes:
    ...
    PROBLEM: https://yukicoder.me/problems/no/1168
    links:
    - https://yukicoder.me/problems/no/1168
  bundledCode: "#line 1 \"verify/yukicoder/digit_sum.test.cpp\"\n#define PROBLEM \"\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 17 \"verify/yukicoder/digit_sum.test.cpp\"\
    \n\n#line 2 \"algo/digit_sum.hpp\"\n\n#line 4 \"algo/digit_sum.hpp\"\n\n/**\n\
    \ * @brief \u6841\u548C\n * @docs docs/algo/digit_sum.md\n */\n\ntemplate <class\
    \ T>\nll digit_sum(T x)\n{\n  static const int LIM = 100000;\n  static int mem[LIM];\n\
    \  static bool memok = false;\n  if (!memok)\n  {\n    mem[0] = 0;\n    repi(x,\
    \ 1, LIM) mem[x] = x % 10 + mem[x / 10];\n    memok = true;\n  }\n  int ans =\
    \ 0;\n  while (x)\n    ans += mem[x % LIM], x /= LIM;\n  return ans;\n}\n#line\
    \ 19 \"verify/yukicoder/digit_sum.test.cpp\"\n\nvoid init() {}\n\nvoid main2()\n\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 32 \"verify/yukicoder/digit_sum.test.cpp\"\
    \nMain<init, main2, test> main_dummy;\nint main() {}\n"
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/1168\"\n\n#define SINGLE_TESTCASE\n\
  ...
  verifiedWith: []
documentation_of: verify/yukicoder/digit_sum.test.cpp
layout: document
redirect_from:
- /verify/verify/yukicoder/digit_sum.test.cpp
- /verify/verify/yukicoder/digit_sum.test.cpp.html
