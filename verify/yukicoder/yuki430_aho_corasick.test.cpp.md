...
data:
  ...
  bundledCode: "#line 1 \"verify/yukicoder/yuki430_aho_corasick.test.cpp\"\n#define\
    ...
    \    }\n  }\n\n  // v \u306E failure link \u306E\u884C\u304D\u5148 (\u6839 0 \u306B\
    \u5BFE\u3057\u3066\u306F -1)\n  // \u3053\u308C\u306F v \u306E\u6700\u9577 suffix\n\
    \  template <class I = ll>\n  I failure(int v)\n  {\n    assert(0 <= v && v <\
    \ n);\n    return fail[v];\n  }\n\n  // \u6587\u5B57 c \u3092\u8FFD\u52A0\u3067\
    \u304D\u306A\u3044\u9650\u308A failure link \u3092\u8FBF\u308B \u2192 \u521D\u3081\
    \u3066\u8FFD\u52A0\u3067\u304D\u305F\u3068\u304D\u306B\u3044\u308B\u9802\u70B9\
    \n  template <class I = ll>\n  I next(int v, int c)\n  {\n    assert(0 <= v &&\
    \ v < n);\n    assert(0 <= c && c < CHAR_NUM);\n    return nxt[v][c];\n  }\n};\n\
