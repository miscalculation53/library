...
data:
  ...
  bundledCode: "#line 1 \"verify/yukicoder/imos_2d.test.cpp\"\n#define PROBLEM \"\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 17 \"verify/yukicoder/imos_2d.test.cpp\"\
    \n\n#line 2 \"ds/cumulative_sum/imos_2d.hpp\"\n\n#line 4 \"ds/cumulative_sum/imos_2d.hpp\"\
...
layout: document
redirect_from:
- /verify/verify/yukicoder/imos_2d.test.cpp
- /verify/verify/yukicoder/imos_2d.test.cpp.html
