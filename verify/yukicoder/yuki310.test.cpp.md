...
data:
  ...
  bundledCode: "#line 1 \"verify/yukicoder/yuki310.test.cpp\"\n#define PROBLEM \"\
    ...
    \    else\n      return std::hash<mint>{}(x);\n  }\n};\n#line 18 \"verify/yukicoder/yuki310.test.cpp\"\
    ...
    #line 20 \"verify/yukicoder/yuki310.test.cpp\"\n\nvoid init()\n{\n  oj(mt.seed(random_device()()));\n\
    }\n\nvoid main2()\n{\n  LL(N, M);\n  VEC(pll, M, AB);\n  offset(AB, pll{-1, -1});\n\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 42 \"verify/yukicoder/yuki310.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/yukicoder/yuki310.test.cpp
layout: document
redirect_from:
- /verify/verify/yukicoder/yuki310.test.cpp
- /verify/verify/yukicoder/yuki310.test.cpp.html
