...
data:
  ...
  bundledCode: "#line 1 \"verify/yukicoder/rle.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1183\"\
    ...
    \ res[i] = randint<T>(T(l), T(r) - T(k));\n  sort(ALL(res));\n  repi(i, k) res[i]\
    \ += i;\n  if (!does_sort)\n    shuffle(ALL(res), mt);\n  return res;\n}\n#line\
    \ 17 \"verify/yukicoder/rle.test.cpp\"\n\n#line 2 \"algo/rle.hpp\"\n\n#line 4\
    \ \"algo/rle.hpp\"\n\n/**\n * @brief \u30E9\u30F3\u30EC\u30F3\u30B0\u30B9\u5727\
    \u7E2E\n * @docs docs/algo/rle.md\n */\n\n// \u533A\u9593\u306F [left, right)\n\
    template <class T, class I = ll>\nstruct rle_info\n{\n  T val;\n  I len, left,\
    \ right;\n  rle_info(T val, I len, I left, I right) : val(val), len(len), left(left),\
    ...
    \ rle(a);\n}\n#line 19 \"verify/yukicoder/rle.test.cpp\"\n\nvoid init()\n{\n \
    ...
    \ MULTI_TESTCASE\n    CERR(\"\\n[MULTI_TESTCASE]\\n\\n\", \"33\");\n    dump(\"\
    T\");\n    IN(uint, T);\n    while (T--)\n    {\n      dump(\"new testcase\");\n\
    \      main2();\n    }\n    #endif\n  }\n};\n#line 47 \"verify/yukicoder/rle.test.cpp\"\
  ...
  requiredBy: []
  timestamp: '2025-04-26 21:35:22+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: verify/yukicoder/rle.test.cpp
layout: document
redirect_from:
- /verify/verify/yukicoder/rle.test.cpp
- /verify/verify/yukicoder/rle.test.cpp.html
