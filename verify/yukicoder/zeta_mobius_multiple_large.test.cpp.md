...
data:
  ...
  bundledCode: "#line 1 \"verify/yukicoder/zeta_mobius_multiple_large.test.cpp\"\n\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 17 \"verify/yukicoder/zeta_mobius_multiple_large.test.cpp\"\
    ...
    \n\n#line 22 \"verify/yukicoder/zeta_mobius_multiple_large.test.cpp\"\nusing mint\
    \ = modint998244353;\n\nvoid init() {}\n\nvoid main2()\n{\n  LL(T, M);\n  ZetaMobiusDivisorMultipleLarge\
    \ zm(M);\n  rep(_, T)\n  {\n    LL(N, B, C, D);\n    VEC(ll, N, A);\n    vc<mint>\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 68 \"verify/yukicoder/zeta_mobius_multiple_large.test.cpp\"\
