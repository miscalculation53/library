...
data:
  ...
  bundledCode: "#line 1 \"verify/yukicoder/parallel_binsearch.test.cpp\"\n#define\
    ...
    \ res[i] = randint<T>(T(l), T(r) - T(k));\n  sort(ALL(res));\n  repi(i, k) res[i]\
    \ += i;\n  if (!does_sort)\n    shuffle(ALL(res), mt);\n  return res;\n}\n#line\
    \ 17 \"verify/yukicoder/parallel_binsearch.test.cpp\"\n\n#line 2 \"ds/uf/uf.hpp\"\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 87 \"verify/yukicoder/parallel_binsearch.test.cpp\"\
...
layout: document
redirect_from:
- /verify/verify/yukicoder/parallel_binsearch.test.cpp
- /verify/verify/yukicoder/parallel_binsearch.test.cpp.html
