...
data:
  ...
  bundledCode: "#line 1 \"verify/yukicoder/parallel_binsearch.test.cpp\"\n#define\
    ...
    \ vt;\n}\n// ----------\n#line 15 \"verify/yukicoder/parallel_binsearch.test.cpp\"\
    ...
    \ 1};\n#line 22 \"verify/yukicoder/parallel_binsearch.test.cpp\"\nusing bi = Binomial<mint>;\n\
    \n#line 2 \"ds/uf/uf.hpp\"\n\n#line 4 \"ds/uf/uf.hpp\"\n\n/**\n * @brief UnionFind\n\
    ...
    \    repi(i, q) (res[i] ? oks[i] : ngs[i]) = mids[i];\n  }\n  return oks;\n}\n\
    #line 26 \"verify/yukicoder/parallel_binsearch.test.cpp\"\n\nvoid init() {}\n\n\
    void main2()\n{\n  LL(H, W);\n  VEC2(ll, H, W, A);\n  vc<tlll> UVW;\n  rep(i,\
    \ H) rep(j, W)\n  {\n    ll u = i * W + j;\n    if (i != H - 1)\n    {\n     \
