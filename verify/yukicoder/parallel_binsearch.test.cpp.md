...
data:
  ...
  bundledCode: "#line 1 \"verify/yukicoder/parallel_binsearch.test.cpp\"\n#define\
    ...
    \ res[i] = randrange<T>(T(l), T(r) - T(k));\n  sort(ALL(res));\n  repi(i, k) res[i]\
    \ += i;\n  if (!does_sort)\n    shuffle(ALL(res), mt);\n  return res;\n}\n#line\
    \ 15 \"verify/yukicoder/parallel_binsearch.test.cpp\"\n\n#line 2 \"ds/uf/uf.hpp\"\
    ...
    \    repi(i, q) (res[i] ? oks[i] : ngs[i]) = mids[i];\n  }\n  return oks;\n}\n\
    #line 18 \"verify/yukicoder/parallel_binsearch.test.cpp\"\n\nvoid init() {}\n\n\
    void main2()\n{\n  LL(H, W);\n  VEC2(ll, H, W, A);\n  vc<tlll> UVW;\n  rep(i,\
    \ H) rep(j, W)\n  {\n    ll u = i * W + j;\n    if (i != H - 1)\n    {\n     \
    ...
    \ MULTI_TESTCASE\n    CERR(\"\\n[MULTI_TESTCASE]\\n\\n\", \"33\");\n    dump(\"\
    T\");\n    IN(uint, T);\n    while (T--)\n    {\n      dump(\"new testcase\");\n\
    \      main2();\n    }\n    #endif\n  }\n};\n#line 85 \"verify/yukicoder/parallel_binsearch.test.cpp\"\
