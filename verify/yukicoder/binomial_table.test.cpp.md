...
data:
  ...
  attributes:
    ...
    PROBLEM: https://yukicoder.me/problems/no/129
    links:
    - https://yukicoder.me/problems/no/129
  bundledCode: "#line 1 \"verify/yukicoder/binomial_table.test.cpp\"\n#define PROBLEM\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 15 \"verify/yukicoder/binomial_table.test.cpp\"\
    ...
    \    else\n      return std::hash<mint>{}(x);\n  }\n};\n#line 17 \"verify/yukicoder/binomial_table.test.cpp\"\
    \n// using mint = modint998244353;\n// using mint = modint1000000007;\nusing mint\
    \ = static_modint32<1000000000>;\n// using mint = modint;\n#line 2 \"math/modint/binomial_table.hpp\"\
    \n\n#line 4 \"math/modint/binomial_table.hpp\"\n\n/**\n * @brief \u4E8C\u9805\u4FC2\
    \u6570\u30C6\u30FC\u30D6\u30EB\n * @docs docs/math/modint/binomial_table.md\n\
    \ */\n\ntemplate <class mint>\nstruct BinomialTable\n{\nprivate:\n  static decltype(mint::mod())\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 41 \"verify/yukicoder/binomial_table.test.cpp\"\
    \nMain<init, main2, test> main_dummy;\nint main() {}\n"
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/129\"\n\n#define SINGLE_TESTCASE\n\
  ...
  verifiedWith: []
documentation_of: verify/yukicoder/binomial_table.test.cpp
layout: document
redirect_from:
- /verify/verify/yukicoder/binomial_table.test.cpp
- /verify/verify/yukicoder/binomial_table.test.cpp.html
