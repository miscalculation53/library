...
data:
  ...
  bundledCode: "#line 1 \"verify/yukicoder/zeta_mobius_divisor_large.test.cpp\"\n\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 17 \"verify/yukicoder/zeta_mobius_divisor_large.test.cpp\"\
    \n\n#line 2 \"math/prime/large/zeta_mobius_divisor_multiple_large.hpp\"\n\n#line\
    \ 2 \"math/prime/large/factorize.hpp\"\n\n#line 2 \"math/modint/modint.hpp\"\n\
    ...
    \ /= p; }\n};\n#ifdef LOCAL\nCPP_DUMP_DEFINE_EXPORT_OBJECT(PrimePower<int>, p,\
    ...
    \ internal::is_prime_impl<mint>(n, bases64);\n  }\n}\n#line 7 \"math/prime/large/factorize.hpp\"\
    ...
    \ GroupMulDiv<T>>;\n#line 6 \"math/prime/large/zeta_mobius_divisor_multiple_large.hpp\"\
    \n\n/**\n * @brief \u7D04\u6570\u30FB\u500D\u6570 \u30BC\u30FC\u30BF\u30FB\u30E1\
    \u30D3\u30A6\u30B9\u5909\u63DB\uFF08\u5927\u304D\u3044 $m$ \u306E\u7D04\u6570\uFF09\
    ...
    \  ZetaMobiusDivisorMultipleLarge(ll m, const vc<PrimePower<I>> &fac) : m(m),\
    \ fac(ALL(fac))\n  {\n    pnum = fac.size();\n    dnum = 1;\n    fec(pp : fac)\
    ...
    \ &zm)\n    : zm(zm), v(zm.dnum) {}\n    template <class F>\n    DivisorMap(const\
    \ ZetaMobiusDivisorMultipleLarge &zm, const F &func)\n    : zm(zm), v(zm.dnum)\
    \ { repi(i, zm.dnum) v[i] = func(zm.ds[i]); }\n\n    // m \u306E\u7D04\u6570 d\
    \ \u306B\u5BFE\u3057\u3066\u5024\u3092\u53D6\u5F97\n    // \u5909\u66F4\u3082\u53EF\
    \u80FD\n    // O(loglog d)\n    T &get_by_d(ll d) { return v[zm.dtoi(d)]; }\n\
    \    // m \u306E\u7D04\u6570 d \u306B\u5BFE\u3057\u3066\u5024\u3092\u53D6\u5F97\
    \n    // \u5909\u66F4\u3082\u53EF\u80FD\n    // O(loglog d)\n    const T &get_by_d(ll\
    \ d) const { return v[zm.dtoi(d)]; }\n\n    // m \u306E\u7D04\u6570 d \u306B\u5BFE\
    \u3057\u3001i = dtoi(d) \u304B\u3089\u5024\u3092\u53D6\u5F97\n    // \u5909\u66F4\
    \u3082\u53EF\u80FD\n    T &get_by_i(ll i) { return v[i]; }\n    // m \u306E\u7D04\
    \u6570 d \u306B\u5BFE\u3057\u3001i = dtoi(d) \u304B\u3089\u5024\u3092\u53D6\u5F97\
    \n    // \u5909\u66F4\u3082\u53EF\u80FD\n    const T &get_by_i(ll i) const { return\
    \ v[i]; }\n\n    map<ll, T> to_map()\n    {\n      map<ll, T> res;\n      fec(d\
    \ : zm.ds) res[d] = get_by_d(d);\n      return res;\n    }\n  };\n\n  template\
    \ <class T>\n  DivisorMap<T> divisor_map() const\n  { return DivisorMap<T>(*this);\
    \ }\n  template <class F>\n  auto divisor_map(const F &func) -> DivisorMap<decltype(func(0))>\
    ...
    \ DivisorMap<typename G::S> &a) const\n  {\n    auto b = a;\n    for (int j =\
    \ pnum - 1, k = 1; j >= 0; k *= fac[j].e + 1, j--)\n    {\n      repi(i, dnum\
    \ - 1, -1, -1)\n      {\n        if (!btest(f01[i], j))\n          b.v[i + k]\
    ...
    \ = G::e();\n    int si = dtoi(n);\n    repi(bit, 1 << pnum)\n    {\n      int\
    \ i = si;\n      bool ok = true;\n      for (int j = pnum - 1, k = 1; j >= 0;\
    \ k *= fac[j].e + 1, j--)\n      {\n        if (btest(bit, j))\n        {\n  \
    \        if (!btest(f01[i], j))\n            i += k;\n          else\n       \
    \   {\n            ok = false;\n            break;\n          }\n        }\n \
    \     }\n      if (!ok)\n        continue;\n      if (popcount(bit) % 2 == 0)\n\
    \        res = G::op(res, a.v[i]);\n      else\n        res = G::op(res, G::inv(a.v[i]));\n\
    \    }\n    return res;\n  }\n};\n#line 20 \"verify/yukicoder/zeta_mobius_divisor_large.test.cpp\"\
    \n\n#line 22 \"verify/yukicoder/zeta_mobius_divisor_large.test.cpp\"\nusing mint\
    \ = modint998244353;\n\nvoid init() {}\n\nvoid main2()\n{\n  LL(T, M);\n  ZetaMobiusDivisorMultipleLarge\
    \ zm(M);\n  rep(_, T)\n  {\n    LL(N, B, C, D);\n    VEC(ll, N, A);\n    vc<mint>\
    ...
    n\\n\", \"33\");\n    local(while (true))\n    {\n      dump(\"T\");\n      IN(uint,\
    \ T);\n      while (T--)\n      {\n        dump(\"new testcase\");\n        main2();\n\
    \      }\n    }\n    #endif\n  }\n};\n#line 68 \"verify/yukicoder/zeta_mobius_divisor_large.test.cpp\"\
...
layout: document
redirect_from:
- /verify/verify/yukicoder/zeta_mobius_divisor_large.test.cpp
- /verify/verify/yukicoder/zeta_mobius_divisor_large.test.cpp.html
