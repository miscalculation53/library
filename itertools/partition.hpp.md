...
data:
  ...
  attributes:
    _deprecated_at_docs: docs/itertools/partition.md
    document_title: "\u6574\u6570\u306E\u5206\u5272\u3092\u5168\u63A2\u7D22"
    links: []
  bundledCode: "#line 2 \"itertools/partition.hpp\"\n\n#line 2 \"template/template_all_but_modint.hpp\"\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 4 \"itertools/partition.hpp\"\n\n/**\n\
  ...
  verifiedWith: []
documentation_of: itertools/partition.hpp
layout: document
redirect_from:
- /library/itertools/partition.hpp
- /library/itertools/partition.hpp.html
title: "\u6574\u6570\u306E\u5206\u5272\u3092\u5168\u63A2\u7D22"
---
## 整数の分割を全探索
...
```cpp
vvc<I> partitions(I n)
```

整数 $n$ の分割すべてを格納した vector を返す。
