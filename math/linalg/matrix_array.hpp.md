...
data:
  ...
  bundledCode: "#line 2 \"math/linalg/matrix_array.hpp\"\n\n#line 2 \"template/template_all_but_modint.hpp\"\
    ...
    \      return hash(x.val());\n    else\n      return hash(x);\n  }\n};\n#line\
    \ 8 \"math/linalg/matrix_array.hpp\"\n\n/**\n * @brief \u884C\u5217\uFF08array\uFF09\
    \n * @docs docs/math/linalg/matrix_array.md\n */\n\n// F \u306F\u4F53\uFF08\u4E00\
    \u90E8\u306E\u64CD\u4F5C\u306F\u74B0\u3084\u534A\u74B0\u3067 OK\uFF09\ntemplate\
    \ <class F, int n, int m, int BS = 32>\nstruct MatrixArray : array<array<typename\
    \ F::S, m>, n>\n{\n  using S = typename F::S;\n  using M = MatrixArray;\n  using\
    \ Vn = array<S, n>;\n  using Vm = array<S, m>;\n\n  MatrixArray(const S &diag\
    \ = F::e0(), const S &non_diag = F::e0())\n  {\n    repi(i, n) repi(j, m)(*this)[i][j]\
    \ = i == j ? diag : non_diag;\n  }\n  MatrixArray(const array<array<S, m>, n>\
    \ &a) { *this = a; }\n\n  M operator-() const\n  {\n    M res(*this);\n    repi(i,\
    \ n) repi(j, m) res[i][j] = F::minus(res[i][j]);\n    return res;\n  }\n  M &operator+=(const\
    ...
    \ n) repi(j, p) res[i][j] = F::e0();\n    repi(ii, 0, n, BS) repi(kk, 0, m, BS)\
    \ repi(jj, 0, p, BS)\n    {\n      repi(i, ii, min(ii + BS, n)) repi(k, kk, min(kk\
    \ + BS, m))\n      {\n        S aik = (*this)[i][k];\n        if (aik == F::e0())\n\
