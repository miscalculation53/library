...
data:
  ...
  attributes:
    ...
    links: []
  bundledCode: "#line 2 \"math/convolution/convolution_many.hpp\"\n\n#line 2 \"template/template_all_but_modint.hpp\"\
  ...
  code: "#pragma once\n\n#include \"../../template/template_all_but_modint.hpp\"\n\
    ...
    \ vc<mint> \u307E\u305F\u306F fps\n// d \u306F\u8FD4\u3063\u3066\u304F\u308B vector\
    \ \u306E\u6700\u5927\u9577\u3055\n// \u8A08\u7B97\u91CF: \u6B21\u6570\u306E\u7DCF\
    \u548C\u3092 n \u3068\u3057\u3066 O(n log^2 n)\ntemplate <class F>\nF convolution_many(const\
    \ vc<F> &fs, int d = -1)\n{\n  auto pre = [&](F f) -> F\n  {\n    if (d >= 0 &&\
    \ d < (int)f.size())\n      f.resize(d);\n    return f;\n  };\n  auto dc = [&](auto\
    \ dc, int l, int r) -> F\n  {\n    if (r - l == 0)\n      return pre(F{1});\n\
    \    if (r - l == 1)\n      return pre(fs[l]);\n    const int m = (l + r) / 2;\n\
...
layout: document
redirect_from:
- /library/math/convolution/convolution_many.hpp
- /library/math/convolution/convolution_many.hpp.html
title: "\u591A\u9805\u5F0F\u306E\u7DCF\u7A4D"
---
## 多項式の総積
