...
data:
  ...
  attributes:
    _deprecated_at_docs: docs/math/modint/to_rational.md
    document_title: "modint \u3092\u6709\u7406\u6570\u306B"
    links: []
  bundledCode: "#line 2 \"math/modint/to_rational.hpp\"\n\n#line 2 \"template/template_all_but_modint.hpp\"\
    ...
    \ b2)\n// \u51FA\u529B: \u6574\u6570 x, y \u3092\u7528\u3044\u3066 v = (v1, v2)\
    \ = xa + yb \u3068\u8868\u3055\u308C\u308B\u30D9\u30AF\u30C8\u30EB\u306E\u3046\
    \u3061\u3001\n//      \u30CE\u30EB\u30E0\u306E 2 \u4E57 v1^2 + v2^2 \u304C\u6700\
    \u5C0F\u306E\u3082\u306E\u306E\u3072\u3068\u3064 (\u7B26\u53F7\u306F\u4E0D\u5B9A\
    )\n// T \u306F\u6574\u6570\u3001U \u306F T \u306E 2 \u500D\u306E\u30D3\u30C3\u30C8\
    \u6570\n// \u521D\u671F\u5024\u306E \u221A2 \u500D\u304C T \u304B\u3089\u6EA2\u308C\
    \u306A\u3044\u306A\u3089\u6B63\u3057\u304F\u52D5\u304F\ntemplate <class T = ll,\
    \ class U = larger_int_t<T>>\npair<T, T> svp2d(const pair<T, T> &a, const pair<T,\
  ...
  code: "#pragma once\n\n#include \"../../template/template_all_but_modint.hpp\"\n\
    \n#include \"../svp2d.hpp\"\n\n/**\n * @brief modint \u3092\u6709\u7406\u6570\u306B\
    \n * @docs docs/math/modint/to_rational.md\n */\n\ntemplate <class mint>\npair<decltype(mint(0).val()),\
    \ decltype(mint(0).val())>\nmint_to_rat(const mint &x)\n{\n  auto [p, q] = svp2d({x.val(),\
    \ 1}, {mint::mod(), 0});\n  if (q < 0)\n    p = -p, q = -q;\n  return {p, q};\n\
    }\n\n#if __cplusplus >= 202302L\nnamespace cpp_dump\n{\n  struct mint_to_rat_fn\n\
    \  {\n    template <class T>\n    constexpr auto operator()(const T &x) const\
    \ -> decltype(mint_to_rat(x))\n    {\n      return mint_to_rat(x);\n    }\n  };\n\
    \n  struct rat_closure : std::ranges::range_adaptor_closure<rat_closure>\n  {\n\
    \    template <typename T>\n    constexpr auto operator()(T &&t) const\n    {\n\
    \      if constexpr (!std::ranges::range<T> && std::invocable<mint_to_rat_fn,\
    \ decltype(std::forward<T>(t))>)\n      {\n        return mint_to_rat_fn{}(std::forward<T>(t));\n\
...
documentation_of: math/modint/to_rational.hpp
layout: document
redirect_from:
- /library/math/modint/to_rational.hpp
- /library/math/modint/to_rational.hpp.html
title: "modint \u3092\u6709\u7406\u6570\u306B"
---
