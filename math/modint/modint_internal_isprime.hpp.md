...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"math/modint/modint_internal_isprime.hpp\"\n\n#line 2 \"\
    ...
    \ res[i] = randint<T>(T(l), T(r) - T(k));\n  sort(ALL(res));\n  repi(i, k) res[i]\
    \ += i;\n  if (!does_sort)\n    shuffle(ALL(res), mt);\n  return res;\n}\n#line\
    \ 4 \"math/modint/modint_internal_isprime.hpp\"\n\n#line 2 \"utils/larger_int.hpp\"\
...
documentation_of: math/modint/modint_internal_isprime.hpp
layout: document
redirect_from:
- /library/math/modint/modint_internal_isprime.hpp
- /library/math/modint/modint_internal_isprime.hpp.html
