...
data:
  ...
  attributes:
    _deprecated_at_docs: docs/math/modint/inv_many.md
    document_title: "\u9006\u5143\u3092\u307E\u3068\u3081\u3066\u6C42\u3081\u308B"
    links: []
  bundledCode: "#line 2 \"math/modint/inv_many.hpp\"\n\n#line 2 \"template/template_all_but_modint.hpp\"\
    ...
    \ * @brief \u9006\u5143\u3092\u307E\u3068\u3081\u3066\u6C42\u3081\u308B\n * @docs\
    \ docs/math/modint/inv_many.md\n */\n\ntemplate <class mint>\nvc<mint> inv_many(const\
    \ vc<mint> &a)\n{\n  const int n = a.size();\n  vc<mint> p(n + 1, 1);\n  repi(i,\
    \ n) p[i + 1] = p[i] * a[i];\n  mint ip = p.back().inv();\n  vc<mint> res(n);\n\
    \  repi(i, n - 1, -1, -1)\n  {\n    res[i] = ip * p[i];\n    ip *= a[i];\n  }\n\
    \  return res;\n}\n"
...
layout: document
redirect_from:
- /library/math/modint/inv_many.hpp
- /library/math/modint/inv_many.hpp.html
title: "\u9006\u5143\u3092\u307E\u3068\u3081\u3066\u6C42\u3081\u308B"
---
## 逆元をまとめて求める
