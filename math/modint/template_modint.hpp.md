...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"math/modint/template_modint.hpp\"\n\n#line 2 \"math/modint/modint.hpp\"\
    ...
    \ vc<T> fac_, finv_, inv_;\n  static void reserve(int n)\n  {\n    if constexpr\
    \ (is_dynamic_modint_v<T>)\n    {\n      if (mod != T::mod())\n      {\n     \
    \   mod = T::mod();\n        fac_ = {1, 1}, finv_ = {1, 1}, inv_ = {0, 1};\n \
    \     }\n    }\n    else\n    {\n      if (fac_.empty())\n        fac_ = {1, 1},\
    \ finv_ = {1, 1}, inv_ = {0, 1};\n    }\n    if (n < SZ(fac_))\n      return;\n\
    \    chmin(n, T::mod() - 1);\n    int si = fac_.size();\n    fac_.resize(n + 1),\
    \ finv_.resize(n + 1), inv_.resize(n + 1);\n    repi(i, si, n + 1)\n    {\n  \
  ...
  verifiedWith: []
documentation_of: math/modint/template_modint.hpp
layout: document
redirect_from:
- /library/math/modint/template_modint.hpp
- /library/math/modint/template_modint.hpp.html
