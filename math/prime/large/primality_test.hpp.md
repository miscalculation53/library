...
data:
  ...
  attributes:
    ...
    document_title: "\u7D20\u6570\u5224\u5B9A"
    links: []
  bundledCode: "#line 2 \"math/prime/large/primality_test.hpp\"\n\n#line 2 \"template/template_all_but_modint.hpp\"\
  ...
  code: "#pragma once\n\n#include \"template/template_all_but_modint.hpp\"\n#include\
    ...
    \ docs/math/prime/large/primality_test.md\n */\n\nnamespace internal\n{\n\ntemplate\
    \ <class mint, class Array>\nbool is_prime_impl(ll n, const Array &bases)\n{\n\
    \  if (n <= 1)\n    return false;\n  if (n == 2 || n == 7 || n == 61)\n    return\
    ...
    \ static constexpr array<ll, 7> bases64 = {2, 325, 9375, 28178, 450775, 9780504,\
...
layout: document
redirect_from:
- /library/math/prime/large/primality_test.hpp
- /library/math/prime/large/primality_test.hpp.html
title: "\u7D20\u6570\u5224\u5B9A"
---
## 素数判定
