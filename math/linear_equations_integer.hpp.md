...
data:
  ...
  attributes:
    _deprecated_at_docs: docs/math/linear_equations_integer.md
    document_title: "\u4E8C\u5143\u4E00\u6B21\u9023\u7ACB\u65B9\u7A0B\u5F0F\u306E\u6574\
      \u6570\u89E3"
    links: []
  bundledCode: "#line 2 \"math/linear_equations_integer.hpp\"\n\n#line 2 \"template/template_all_but_modint.hpp\"\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 4 \"math/linear_equations_integer.hpp\"\
    ...
    \ = typename larger_int<T>::type;\n#line 7 \"math/linear_equations_integer.hpp\"\
    \n\n/**\n * @brief \u4E8C\u5143\u4E00\u6B21\u9023\u7ACB\u65B9\u7A0B\u5F0F\u306E\
    ...
    \ f \u306E\u6574\u6570\u89E3\u5168\u4F53\u3092\u8FD4\u3059\n// dim == -1 \u306A\
    \u3089\u89E3\u306A\u3057\u3002\u305D\u308C\u4EE5\u5916\u3067\u306F sol + \u03A3\
    \ k_i basis[i] (k_i \u306F\u6574\u6570) \u304C\u5168\u89E3\ntemplate <class T\
    \ = ll, class U = larger_int_t<T>,\n          class A, class B, class C, class\
    \ D, class E, class F>\nLinearEquationsIntegerResult<T>\nlinear_equations_integer(A\
    \ a, B b, C c, D d, E e, F f)\n{\n  const U aa = a, bb = b, cc = c, dd = d, ee\
    \ = e, ff = f;\n  const U det = aa * ee - bb * dd;\n  if (det != 0)\n  {\n   \
    \ const U x = cc * ee - bb * ff;\n    const U y = aa * ff - cc * dd;\n    if (x\
    \ % det != 0 || y % det != 0)\n      return {};\n    return {0, {T(x / det), T(y\
  ...
  verifiedWith: []
documentation_of: math/linear_equations_integer.hpp
layout: document
redirect_from:
- /library/math/linear_equations_integer.hpp
- /library/math/linear_equations_integer.hpp.html
title: "\u4E8C\u5143\u4E00\u6B21\u9023\u7ACB\u65B9\u7A0B\u5F0F\u306E\u6574\u6570\u89E3"
---
