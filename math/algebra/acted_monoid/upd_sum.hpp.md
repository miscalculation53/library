...
data:
  ...
  attributes:
    _deprecated_at_docs: docs/math/algebra/acted_monoid/upd_sum.md
    document_title: "\u4F5C\u7528\u3064\u304D\u30E2\u30CE\u30A4\u30C9\uFF1A\u66F4\u65B0\
      \u30FB\u548C\u53D6\u5F97"
    links: []
  bundledCode: "#line 2 \"math/algebra/acted_monoid/upd_sum.hpp\"\n\n#line 2 \"template/template_all_but_modint.hpp\"\
    ...
    \    assert(g(AM::e()));\n    if (l == n)\n      return n;\n    l += siz;\n  \
    \  repi(i, lg, 0, -1) push(l >> i);\n    S sm = AM::e();\n    do\n    {\n    \
    \  while (l % 2 == 0)\n        l >>= 1;\n      if (!g(AM::op(sm, dat[l])))\n \
    \     {\n        while (l < siz)\n        {\n          push(l);\n          l *=\
    \ 2;\n          if (g(AM::op(sm, dat[l])))\n          {\n            sm = AM::op(sm,\
    \ dat[l]);\n            l++;\n          }\n        }\n        return l - siz;\n\
    \      }\n      sm = AM::op(sm, dat[l]);\n      l++;\n    } while ((l & -l) !=\
    \ l);\n    return n;\n  }\n\n  // g(prod(l, r)) \u304C true \u3068\u306A\u308B\
    \u6700\u5C0F\u306E l \u3092\u8FD4\u3059\n  template <class G>\n  int min_left_ok(int\
    \ r, const G &g)\n  {\n    assert(0 <= r && r <= n);\n    assert(g(AM::e()));\n\
    \    if (r == 0)\n      return 0;\n    r += siz;\n    repi(i, lg, 0, -1) push((r\
    \ - 1) >> i);\n    S sm = AM::e();\n    do\n    {\n      r--;\n      while (r\
    \ > 1 && (r % 2))\n        r >>= 1;\n      if (!g(AM::op(dat[r], sm)))\n     \
    \ {\n        while (r < siz)\n        {\n          push(r);\n          r = 2 *\
    \ r + 1;\n          if (g(AM::op(dat[r], sm)))\n          {\n            sm =\
    \ AM::op(dat[r], sm);\n            r--;\n          }\n        }\n        return\
    \ r + 1 - siz;\n      }\n      sm = AM::op(dat[r], sm);\n    } while ((r & -r)\
    \ != r);\n    return 0;\n  }\n};\n#line 6 \"math/algebra/acted_monoid/upd_sum.hpp\"\
    \n\n/**\n * @brief \u4F5C\u7528\u3064\u304D\u30E2\u30CE\u30A4\u30C9\uFF1A\u66F4\
    \u65B0\u30FB\u548C\u53D6\u5F97\n * @docs docs/math/algebra/acted_monoid/upd_sum.md\n\
    \ */\n\ntemplate <class T>\nstruct ActedMonoidUpdSum\n{\n  struct S\n  {\n   \
    \ int len;\n    T val;\n    S() {}\n    S(T val) : len(1), val(val) {}\n    S(int\
    \ len, T val) : len(len), val(val) {}\n  };\n  static constexpr S op(S a, S b)\
    \ { return {a.len + b.len, a.val + b.val}; }\n  static constexpr S e() { return\
    \ {0, T{}}; }\n  struct F\n  {\n    bool is_id;\n    T val;\n    F() {}\n    F(T\
    \ val) : is_id(false), val(val) {}\n    F(bool is_id, T val) : is_id(is_id), val(val)\
    \ {}\n  };\n  static constexpr S mapping(F f, S x) { return f.is_id ? x : S{x.len,\
    \ f.val * x.len}; }\n  static constexpr F composition(F f, F g) { return f.is_id\
  ...
  code: "#pragma once\n\n#include \"../../../template/template_all_but_modint.hpp\"\
    ...
    \u5F97\n * @docs docs/math/algebra/acted_monoid/upd_sum.md\n */\n\ntemplate <class\
    \ T>\nstruct ActedMonoidUpdSum\n{\n  struct S\n  {\n    int len;\n    T val;\n\
    \    S() {}\n    S(T val) : len(1), val(val) {}\n    S(int len, T val) : len(len),\
    \ val(val) {}\n  };\n  static constexpr S op(S a, S b) { return {a.len + b.len,\
    \ a.val + b.val}; }\n  static constexpr S e() { return {0, T{}}; }\n  struct F\n\
    \  {\n    bool is_id;\n    T val;\n    F() {}\n    F(T val) : is_id(false), val(val)\
    \ {}\n    F(bool is_id, T val) : is_id(is_id), val(val) {}\n  };\n  static constexpr\
    \ S mapping(F f, S x) { return f.is_id ? x : S{x.len, f.val * x.len}; }\n  static\
    \ constexpr F composition(F f, F g) { return f.is_id ? g : f; }\n  static constexpr\
    \ F id() { return {true, T{}}; }\n};\n\n#ifdef LOCAL\nCPP_DUMP_DEFINE_EXPORT_OBJECT_GENERIC(len,\
    \ val);\n#endif\n\n"
  dependsOn:
...
documentation_of: math/algebra/acted_monoid/upd_sum.hpp
layout: document
redirect_from:
- /library/math/algebra/acted_monoid/upd_sum.hpp
- /library/math/algebra/acted_monoid/upd_sum.hpp.html
title: "\u4F5C\u7528\u3064\u304D\u30E2\u30CE\u30A4\u30C9\uFF1A\u66F4\u65B0\u30FB\u548C\
  \u53D6\u5F97"
---
