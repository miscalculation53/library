...
data:
  ...
  attributes:
    ...
    links: []
  bundledCode: "#line 2 \"math/fps/taylor_shift.hpp\"\n\n#line 2 \"template/template_all_but_modint.hpp\"\
    ...
    \ c); }\n};\n#line 6 \"math/fps/taylor_shift.hpp\"\n\n/**\n * @brief Taylor Shift\n\
    \ * @docs docs/math/fps/taylor_shift.md\n */\n\n// f(x + c) \u3092\u8FD4\u3059\
    \ntemplate <class mint, class mint2>\nFormalPowerSeries<mint> taylor_shift(const\
    \ FormalPowerSeries<mint> &f, mint2 c)\n{\n  const int n = f.size();\n  if (n\
  ...
  code: "#pragma once\n\n#include \"../../template/template_all_but_modint.hpp\"\n\
    ...
    \ taylor_shift(const FormalPowerSeries<mint> &f, mint2 c)\n{\n  const int n =\
    \ f.size();\n  if (n == 0)\n    return {};\n  FormalPowerSeries<mint> g(n);\n\
