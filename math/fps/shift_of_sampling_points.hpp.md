...
data:
  ...
  bundledCode: "#line 2 \"math/fps/shift_of_sampling_points.hpp\"\n\n#line 2 \"template/template_all_but_modint.hpp\"\
    ...
    \u3044\u3066 f(c) \u3092\u6C42\u3081\u308B\n// O(n)\ntemplate <class mint>\nmint\
    \ shift_of_sampling_points_one(const vc<mint> &ys, const mint &c)\n{\n  const\
    \ int n = ys.size();\n  assert(n > 0);\n  vc<mint> prodr(n + 1);\n  prodr[n] =\
    \ 1;\n  repi(i, n - 1, -1, -1) prodr[i] = prodr[i + 1] * (c - i);\n  mint res\
    \ = 0, prodl = 1;\n  repi(i, n)\n  {\n    res += prodl * prodr[i + 1] * ys[i]\
    \ * ipow(-1, n - 1 - i) * Binomial<mint>::finv(i) * Binomial<mint>::finv(n - 1\
    \ - i);\n    prodl *= c - i;\n  }\n  return res;\n}\n\n// f(i) = ys[i] (0 <= i\
    \ < n) \u3067\u5B9A\u307E\u308B n \u6B21\u672A\u6E80\u306E f(x) \u306B\u3064\u3044\
    \u3066 f(c), ..., f(c + m - 1) \u3092\u6C42\u3081\u308B\n// O((n+m) log (n+m))\n\
    template <class mint>\nvc<mint> shift_of_sampling_points_many(const vc<mint> &ys,\
  ...
  code: "#pragma once\n\n#include \"../../template/template_all_but_modint.hpp\"\n\
    ...
    \ f(x) \u306B\u3064\u3044\u3066 f(c) \u3092\u6C42\u3081\u308B\n// O(n)\ntemplate\
    \ <class mint>\nmint shift_of_sampling_points_one(const vc<mint> &ys, const mint\
    \ &c)\n{\n  const int n = ys.size();\n  assert(n > 0);\n  vc<mint> prodr(n + 1);\n\
    \  prodr[n] = 1;\n  repi(i, n - 1, -1, -1) prodr[i] = prodr[i + 1] * (c - i);\n\
    \  mint res = 0, prodl = 1;\n  repi(i, n)\n  {\n    res += prodl * prodr[i + 1]\
    \ * ys[i] * ipow(-1, n - 1 - i) * Binomial<mint>::finv(i) * Binomial<mint>::finv(n\
    \ - 1 - i);\n    prodl *= c - i;\n  }\n  return res;\n}\n\n// f(i) = ys[i] (0\
    \ <= i < n) \u3067\u5B9A\u307E\u308B n \u6B21\u672A\u6E80\u306E f(x) \u306B\u3064\
    \u3044\u3066 f(c), ..., f(c + m - 1) \u3092\u6C42\u3081\u308B\n// O((n+m) log\
