...
data:
  ...
  attributes:
    _deprecated_at_docs: docs/math/fps/bmbm.md
    document_title: BMBM
    links: []
  bundledCode: "#line 2 \"math/fps/bmbm.hpp\"\n\n#line 2 \"template/template_all_but_modint.hpp\"\
    ...
    \ https://codeforces.com/blog/entry/61306\n\n// F \u306F\u4F53 (FieldAddSubMulDiv<mint>\
    \ \u306A\u3069)\n// \u5165\u529B: a[0], ..., a[n-1]\n// \u51FA\u529B: c[1], ...,\
    \ c[d] \u3067\u3042\u3063\u3066 a[i] = sum[j=1..d] c[j]a[i-j] \u3092\u6E80\u305F\
    \u3059\u3082\u306E\u306E\u3046\u3061 d \u304C\u6700\u5C0F\u306E\u3082\u306E\n\
    //   (c[0] == -1 \u3068\u3059\u308B)\n// \u8A08\u7B97\u91CF: O(n^2) \u6642\u9593\
    \u3001n = 10000 \u3067 86 ms \u304F\u3089\u3044\ntemplate <class F>\nvc<typename\
    \ F::S> berlekamp_massey(const vc<typename F::S> &a)\n{\n  using S = typename\
    \ F::S;\n  const int n = a.size();\n  vc<S> b, c;\n  int pos = -1;\n  S x = F::e0();\n\
    \  repi(i, n)\n  {\n    const int d = c.size();\n    S y = a[i];\n    repi(j,\
    \ d) y = F::add(y, F::minus(F::mul(c[j], a[i - 1 - j])));\n    if (y == F::e0())\n\
    \      continue;\n    \n    if (c.empty())\n    {\n      c.assign(i + 1, F::e0());\n\
    \      pos = i;\n      x = y;\n      continue;\n    }\n\n    S z = F::mul(y, F::inv(x));\n\
    \    int d2 = i - pos + b.size();\n    vc<S> tmp;\n    if (d2 >= d)\n    {\n \
    \     tmp = c;\n      c.resize(d2, F::e0());\n    }\n    c[i - 1 - pos] = F::add(c[i\
    \ - 1 - pos], z);\n    repi(j, b.size()) c[i - pos + j] = F::add(c[i - pos + j],\
    \ F::minus(F::mul(z, b[j])));\n    if (d2 >= d)\n      pos = i, x = y, swap(tmp,\
    \ b);\n  }\n  c.insert(c.begin(), F::minus(F::e1()));\n  return c;\n}\n#line 2\
    \ \"math/fps/bostan_mori.hpp\"\n\n#line 4 \"math/fps/bostan_mori.hpp\"\n\n#line\
    \ 2 \"bit/bit_reverse.hpp\"\n\n#line 4 \"bit/bit_reverse.hpp\"\n\n/**\n * @brief\
    \ \u30D3\u30C3\u30C8\u30EA\u30D0\u30FC\u30B9\n * @docs docs/bit/bit_reverse.md\n\
    \ */\n\nuint32_t bit_reverse32(uint32_t x)\n{\n  x = ((x & 0x55555555) << 1) |\
    \ ((x & 0xAAAAAAAA) >> 1);\n  x = ((x & 0x33333333) << 2) | ((x & 0xCCCCCCCC)\
    \ >> 2);\n  x = ((x & 0x0F0F0F0F) << 4) | ((x & 0xF0F0F0F0) >> 4);\n  x = ((x\
    \ & 0x00FF00FF) << 8) | ((x & 0xFF00FF00) >> 8);\n  return (x << 16) | (x >> 16);\n\
    }\n// [0, pw2) \u306E\u7BC4\u56F2\u306E i \u3092\u30D3\u30C3\u30C8\u30EA\u30D0\
    \u30FC\u30B9\nint bitrev(int pw2, int i)\n{\n  assert(pw2 > 0 && has_single_bit((uint)pw2));\n\
    \  assert(0 <= i && i < pw2);\n  if (pw2 == 1)\n    return 0;\n  return bit_reverse32(i)\
    \ >> (32 - countr_zero((uint)pw2));\n}\n#line 2 \"math/fps/fps.hpp\"\n\n#line\
    ...
    \  std::array<mint, std::max(3, rank2 + 1)> root;  // root[i]^(2^i) == 1 (i <=\
    \ rank2)\n  std::array<mint, std::max(3, rank2 + 1)> iroot; // root[i] * iroot[i]\
    \ == 1 (i <= rank2)\n\n  std::array<mint, std::max(1, rank2 - 2 + 1)> rate2;\n\
    \  std::array<mint, std::max(1, rank2 - 2 + 1)> irate2;\n\n  std::array<mint,\
    \ std::max(1, rank2 - 3 + 1)> rate3;\n  std::array<mint, std::max(1, rank2 - 3\
    ...
    \u58CA\u7684\u306B\u5909\u66F4\u3059\u308B\ntemplate <auto mod>\nvoid ntt(vc<internal::modint_impl<internal::policy_static<mod>>>\
    ...
    \      }\n      len += 2;\n    }\n  }\n}\n\n// \u7834\u58CA\u7684\u306B\u5909\u66F4\
    \u3059\u308B\ntemplate <auto mod>\nvoid intt(vc<internal::modint_impl<internal::policy_static<mod>>>\
    \ &a)\n{\n  using mint = internal::modint_impl<internal::policy_static<mod>>;\n\
    \  int n = int(a.size());\n  assert(n > 0);\n  int h = countr_zero((unsigned int)n);\n\
    \  assert(n == (1 << h));\n  assert(ntt_ok<mint>(n));\n\n  static const internal::fft_info<mint>\
    ...
    \n\n#line 2 \"math/prime/large/primality_test.hpp\"\n\n#line 5 \"math/prime/large/primality_test.hpp\"\
    ...
    \ + 1) / 2);\n  while (t != 1)\n  {\n    int m2 = 1;\n    for (mint tmp = t *\
    \ t; tmp != 1; tmp *= tmp, m2++)\n      ;\n    mint b = c.pow(ull(1) << (m - m2\
    \ - 1));\n    m = m2, c = b * b, t *= c, r *= b;\n  }\n  return {true, r};\n}\n\
    #line 8 \"math/fps/fps.hpp\"\n\n/**\n * @brief \u5F62\u5F0F\u7684\u51AA\u7D1A\u6570\
    ...
    \    if ((*this)[i] != 0)\n      {\n        F res = (((*this / (*this)[i]) >>\
    \ i).log(d) * mint(k)).exp(d);\n        return (res * (*this)[i].pow(k) << (i\
    ...
    \ FormalPowerSeries<mint>> linear_recurrence_gf(const vc<mint> &a, const vc<mint>\
    \ &c)\n{\n  using F = FormalPowerSeries<mint>;\n  const int d = SZ(c) - 1;\n \
    \ assert(d >= 0);\n  assert(SZ(a) >= d);\n  F q = -F(c);\n  q[0] = 1;\n  F p =\
    \ (F(a) * q).pre(d);\n  return {p, q};\n}\n\n// \u7DDA\u578B\u6F38\u5316\u7684\
    \u6570\u5217 a[0], a[1], ... \u306E\u7B2C k \u9805\u3092\u63A8\u6E2C\u3059\u308B\
...
documentation_of: math/fps/bmbm.hpp
layout: document
redirect_from:
- /library/math/fps/bmbm.hpp
- /library/math/fps/bmbm.hpp.html
title: BMBM
---
## BMBM
