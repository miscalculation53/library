...
data:
  ...
  attributes:
    _deprecated_at_docs: docs/math/fps/interpolation.md
    document_title: "\u591A\u9805\u5F0F\u88DC\u9593"
    links: []
  bundledCode: "#line 2 \"math/fps/interpolation.hpp\"\n\n#line 2 \"template/template_all_but_modint.hpp\"\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 4 \"math/fps/interpolation.hpp\"\n\n#line\
    ...
    \ c); }\n};\n#line 2 \"math/convolution/convolution_many.hpp\"\n\n#line 4 \"math/convolution/convolution_many.hpp\"\
    \n\n#line 6 \"math/convolution/convolution_many.hpp\"\n\n/**\n * @brief \u591A\
    \u9805\u5F0F\u306E\u7DCF\u7A4D\n * @docs docs/math/convolution/convolution_many.md\n\
    \ */\n\n// F \u306F vc<mint> \u307E\u305F\u306F fps\n// d \u306F\u8FD4\u3063\u3066\
    \u304F\u308B vector \u306E\u6700\u5927\u9577\u3055\n// \u8A08\u7B97\u91CF: \u6B21\
    \u6570\u306E\u7DCF\u548C\u3092 n \u3068\u3057\u3066 O(n log^2 n)\ntemplate <class\
    \ F>\nF convolution_many(const vc<F> &fs, int d = -1)\n{\n  auto pre = [&](F f)\
    \ -> F\n  {\n    if (d >= 0 && d < (int)f.size())\n      f.resize(d);\n    return\
    \ f;\n  };\n  auto dc = [&](auto dc, int l, int r) -> F\n  {\n    if (r - l ==\
    \ 0)\n      return pre(F{1});\n    if (r - l == 1)\n      return pre(fs[l]);\n\
    \    const int m = (l + r) / 2;\n    F f = convolution(dc(dc, l, m), dc(dc, m,\
    \ r));\n    return pre(move(f));\n  };\n  return dc(dc, 0, fs.size());\n}\n#line\
    \ 2 \"math/fps/multipoint_evaluation.hpp\"\n\n#line 4 \"math/fps/multipoint_evaluation.hpp\"\
    \n\n#line 6 \"math/fps/multipoint_evaluation.hpp\"\n\n/**\n * @brief \u591A\u9805\
    \u5F0F\u306E\u591A\u70B9\u8A55\u4FA1\n * @docs docs/math/fps/multipoint_evaluation.md\n\
    \ */\n\ntemplate <class mint>\nvc<mint> multipoint_evaluation(const FormalPowerSeries<mint>\
    \ &f, const vc<mint> &xs)\n{\n  using F = FormalPowerSeries<mint>;\n  const int\
    \ m0 = xs.size();\n  if (m0 == 0)\n    return {};\n  if (m0 == 1)\n    return\
    \ {f.eval(xs[0])};\n  const int m = bit_ceil(m0), h = min(6, (int)bit_width(m0)\
    \ - 1);\n  vc<F> node(2 * m, {1});\n  repi(i, m0) node[m + i] = {-xs[i], 1};\n\
    \  repi(i, m - 1, 0, -1) node[i] = convolution(node[2 * i], node[2 * i + 1]);\n\
    \  node[1] = f % node[1];\n  repi(i, 2, m >> (h - 1)) node[i] = node[i / 2] %\
    \ node[i];\n  vc<mint> res(m0);\n  repi(i, m0) res[i] = node[(m + i) >> h].eval(xs[i]);\n\
    \  return res;\n}\n#line 2 \"math/fps/rational_sum.hpp\"\n\n#line 4 \"math/fps/rational_sum.hpp\"\
    \n\n#line 6 \"math/fps/rational_sum.hpp\"\n\n/**\n * @brief \u6709\u7406\u5F0F\
    ...
    \ pair<FormalPowerSeries<mint>, FormalPowerSeries<mint>> &g\n)\n{\n  using F =\
    \ FormalPowerSeries<mint>;\n  cauto &[p_, q_] = f;\n  cauto &[r_, s_] = g;\n \
    \ const int k = p_.size(), l = q_.size(), m = r_.size(), n = s_.size();\n  const\
    \ int pz = bit_ceil(k + n - 1), rz = bit_ceil(l + m - 1);\n  const int z = bit_ceil(max({k\
    \ + n - 1, l + m - 1, l + n - 1}));\n  // (ps + qr) / qs\n  if (!ntt_ok<mint>(z)\
    \ || min({p_.cnt_nz(), q_.cnt_nz(), r_.cnt_nz(), s_.cnt_nz()}) <= 60)\n    return\
    \ {p_ * s_ + q_ * r_, q_ * s_};\n  // NTT \u3092\u4F7F\u3044\u56DE\u3059\n  F\
    \ p = p_, q = q_, r = r_, s = s_;\n  p.resize(pz), q.resize(z), r.resize(rz),\
    ...
    \ rational_sum\n(const vc<pair<FormalPowerSeries<mint>, FormalPowerSeries<mint>>>\
    \ &fs, int d = -1)\n{\n  using F = FormalPowerSeries<mint>;\n  using R = pair<F,\
    \ F>;\n  auto dc = [&](auto dc, int l, int r) -> R\n  {\n    if (r - l == 0)\n\
    \      return {{}, {1}};\n    if (r - l == 1)\n      return fs[l];\n    const\
    \ int m = (l + r) / 2;\n    R res = rational_plus(dc(dc, l, m), dc(dc, m, r));\n\
    \    if (d < 0)\n      return res;\n    else\n      return {res.first.pre(d),\
    ...
    \ interpolation(const vc<mint> &xs, const vc<mint> &ys)\n{\n  using F = FormalPowerSeries<mint>;\n\
    \  assert(xs.size() == ys.size());\n  const int n = xs.size();\n  vc<F> fs(n);\n\
    \  repi(i, n) fs[i] = {-xs[i], 1};\n  F g = convolution_many(fs);\n  vc<mint>\
    \ a = multipoint_evaluation(g.diff(), xs);\n  vc<mint> ia = inv_many(a);\n  vc<pair<F,\
    \ F>> rs(n);\n  repi(i, n) rs[i] = {{ys[i] * ia[i]}, fs[i]};\n  return rational_sum(rs,\
    \ n).first;\n}\n"
  code: "#pragma once\n\n#include \"../../template/template_all_but_modint.hpp\"\n\
    ...
    \n\n/**\n * @brief \u591A\u9805\u5F0F\u88DC\u9593\n * @docs docs/math/fps/interpolation.md\n\
    \ */\n\ntemplate <class mint>\nFormalPowerSeries<mint> interpolation(const vc<mint>\
    \ &xs, const vc<mint> &ys)\n{\n  using F = FormalPowerSeries<mint>;\n  assert(xs.size()\
    \ == ys.size());\n  const int n = xs.size();\n  vc<F> fs(n);\n  repi(i, n) fs[i]\
    \ = {-xs[i], 1};\n  F g = convolution_many(fs);\n  vc<mint> a = multipoint_evaluation(g.diff(),\
    \ xs);\n  vc<mint> ia = inv_many(a);\n  vc<pair<F, F>> rs(n);\n  repi(i, n) rs[i]\
...
documentation_of: math/fps/interpolation.hpp
layout: document
redirect_from:
- /library/math/fps/interpolation.hpp
- /library/math/fps/interpolation.hpp.html
title: "\u591A\u9805\u5F0F\u88DC\u9593"
---
## 多項式補間
