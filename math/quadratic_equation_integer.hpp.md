...
data:
  ...
  bundledCode: "#line 2 \"math/quadratic_equation_integer.hpp\"\n\n#line 2 \"template/template_all_but_modint.hpp\"\
    ...
    \ res[i] = randint<T>(T(l), T(r) - T(k));\n  sort(ALL(res));\n  repi(i, k) res[i]\
    \ += i;\n  if (!does_sort)\n    shuffle(ALL(res), mt);\n  return res;\n}\n#line\
    \ 4 \"math/quadratic_equation_integer.hpp\"\n\n/**\n * @brief \u4E8C\u6B21\u65B9\
  ...
  code: "#pragma once\n\n#include \"../template/template_all_but_modint.hpp\"\n\n\
    /**\n * @brief \u4E8C\u6B21\u65B9\u7A0B\u5F0F\u306E\u6574\u6570\u89E3\n * @docs\
    \ docs/math/quadratic_equation_integer.md\n */\n\n// \u4E8C\u6B21\u65B9\u7A0B\u5F0F\
    ...
    \u3063\u3066\uFF09\u53CE\u307E\u308B\u7BC4\u56F2\u306E\u578B\n// U \u306F T \u306E\
    \ 2 \u4E57\u304C\u53CE\u307E\u308B\u7BC4\u56F2\u306E\u578B\ntemplate <class T\
    \ = ll, class U = i128, class A, class B, class C>\npair<int, array<T, 2>> quadratic_equation_integer(A\
    \ a, B b, C c)\n{\n  U D = U(b) * U(b) - U(4) * U(a) * U(c);\n  if (D < 0)\n \
    \   return {0, {}};\n  if (D == 0)\n  {\n    if (-T(b) % (T(2) * T(a)) == 0)\n\
