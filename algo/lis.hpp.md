...
data:
  ...
  bundledCode: "#line 2 \"algo/lis.hpp\"\n\n#line 2 \"template/template_all_but_modint.hpp\"\
    ...
    \  return res2;\n  }\n};\n#line 11 \"algo/lis.hpp\"\n\nstruct LIS\n{\nprivate:\n\
    \  int n, len;\n  vc<int> pos;\n  GroupIndex<int> grp;\n\npublic:\n  LIS() {}\n\
    \  template <class T, class Compare = less<T>>\n  LIS(const vc<T> &a, Compare\
    \ comp = Compare()) : n(a.size()), pos(n)\n  {\n    vc<T> dp;\n    dp.reserve(n);\n\
  ...
  code: "#pragma once\n\n#include \"../template/template_all_but_modint.hpp\"\n\n\
    ...
    private:\n  int n, len;\n  vc<int> pos;\n  GroupIndex<int> grp;\n\npublic:\n \
    \ LIS() {}\n  template <class T, class Compare = less<T>>\n  LIS(const vc<T> &a,\
    \ Compare comp = Compare()) : n(a.size()), pos(n)\n  {\n    vc<T> dp;\n    dp.reserve(n);\n\
    \    repi(i, n)\n    {\n      auto it = lower_bound(ALL(dp), a[i], comp);\n  \
    \    pos[i] = it - dp.begin();\n      if (it == dp.end())\n        dp.eb(a[i]);\n\
    \      else\n        *it = a[i];\n    }\n\n    len = dp.size();\n    vc<int> candback(len,\
    \ -1);\n    repi(i, n - 1, -1, -1)\n    {\n      const int j = pos[i];\n     \
  ...
  verifiedWith: []
documentation_of: algo/lis.hpp
layout: document
redirect_from:
- /library/algo/lis.hpp
- /library/algo/lis.hpp.html
title: "\u6700\u9577\u5897\u52A0\u90E8\u5206\u5217\uFF08LIS\uFF09"
---
