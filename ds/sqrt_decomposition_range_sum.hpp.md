...
data:
  ...
  attributes:
    _deprecated_at_docs: docs/ds/sqrt_decomposition_range_sum.md
    document_title: "\u5E73\u65B9\u5206\u5272\u306B\u3088\u308B\u4E00\u70B9\u52A0\u7B97\
      \u30FB\u533A\u9593\u548C\u30AF\u30A8\u30EA $\\langle O(1), O(\\sqrt{N}) \\rangle$"
    links: []
  bundledCode: "#line 2 \"ds/sqrt_decomposition_range_sum.hpp\"\n\n#line 2 \"template/template_all_but_modint.hpp\"\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 4 \"ds/sqrt_decomposition_range_sum.hpp\"\
    ...
    \ GroupMulDiv<T>>;\n#line 6 \"ds/sqrt_decomposition_range_sum.hpp\"\n\n/**\n *\
    \ @brief \u5E73\u65B9\u5206\u5272\u306B\u3088\u308B\u4E00\u70B9\u52A0\u7B97\u30FB\
    \u533A\u9593\u548C\u30AF\u30A8\u30EA $\\langle O(1), O(\\sqrt{N}) \\rangle$\n\
    ...
    \  SqrtDecompositionRangeSum() {}\n  SqrtDecompositionRangeSum(int n) : SqrtDecompositionRangeSum(vc<S>(n,\
    \ G::e())) {}\n  SqrtDecompositionRangeSum(const vc<S> &vec) : n(vec.size()),\
    \ dat(vec)\n  {\n    block.resize(divceil(n, B), G::e());\n    repi(bid, block.size())\n\
    \    {\n      const int l = bid * B, r = min(n, (bid + 1) * B);\n      repi(i,\
    \ l, r)\n      {\n        auto &b = block[bid];\n        b = G::op(b, dat[i]);\n\
    \      }\n    }\n  }\n\n  // \u30E2\u30CE\u30A4\u30C9\u3067\u3088\u3044\n  S get(int\
    \ p) const { return dat[p]; }\n  // \u30E2\u30CE\u30A4\u30C9\u3067\u3088\u3044\
  ...
  code: "#pragma once\n\n#include \"../template/template_all_but_modint.hpp\"\n\n\
    ...
    \u5206\u5272\u306B\u3088\u308B\u4E00\u70B9\u52A0\u7B97\u30FB\u533A\u9593\u548C\
    \u30AF\u30A8\u30EA $\\langle O(1), O(\\sqrt{N}) \\rangle$\n * @docs docs/ds/sqrt_decomposition_range_sum.md\n\
    \ */\n\n// G \u306F\u53EF\u63DB\u7FA4 (\u4E00\u90E8\u306E\u64CD\u4F5C\u306F\u30E2\
    \u30CE\u30A4\u30C9\u3067\u3088\u3044)\ntemplate <class G, int B = 512>\nstruct\
    \ SqrtDecompositionRangeSum\n{\n  using S = typename G::S;\n\nprivate:\n  int\
    \ n;\n  vc<S> dat, block;\n\npublic:\n  SqrtDecompositionRangeSum() {}\n  SqrtDecompositionRangeSum(int\
    \ n) : SqrtDecompositionRangeSum(vc<S>(n, G::e())) {}\n  SqrtDecompositionRangeSum(const\
    \ vc<S> &vec) : n(vec.size()), dat(vec)\n  {\n    block.resize(divceil(n, B),\
    \ G::e());\n    repi(bid, block.size())\n    {\n      const int l = bid * B, r\
    \ = min(n, (bid + 1) * B);\n      repi(i, l, r)\n      {\n        auto &b = block[bid];\n\
    \        b = G::op(b, dat[i]);\n      }\n    }\n  }\n\n  // \u30E2\u30CE\u30A4\
...
documentation_of: ds/sqrt_decomposition_range_sum.hpp
layout: document
redirect_from:
- /library/ds/sqrt_decomposition_range_sum.hpp
- /library/ds/sqrt_decomposition_range_sum.hpp.html
title: "\u5E73\u65B9\u5206\u5272\u306B\u3088\u308B\u4E00\u70B9\u52A0\u7B97\u30FB\u533A\
  \u9593\u548C\u30AF\u30A8\u30EA $\\langle O(1), O(\\sqrt{N}) \\rangle$"
---
