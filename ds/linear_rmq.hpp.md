...
data:
  ...
  attributes:
    _deprecated_at_docs: docs/ds/linear_rmq.md
    document_title: "\u7DDA\u5F62 RMQ"
    links: []
  bundledCode: "#line 2 \"ds/linear_rmq.hpp\"\n\n#line 2 \"template/template_all_but_modint.hpp\"\
...
documentation_of: ds/linear_rmq.hpp
layout: document
redirect_from:
- /library/ds/linear_rmq.hpp
- /library/ds/linear_rmq.hpp.html
title: "\u7DDA\u5F62 RMQ"
---
## 線形 RMQ
...
モノイドを渡すようにしているが、これは UI を類似のデータ構造（sparse table 等）と揃えるためである。
