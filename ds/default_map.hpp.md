...
data:
  ...
  attributes:
    _deprecated_at_docs: docs/ds/default_map.md
    document_title: "\u30C7\u30D5\u30A9\u30EB\u30C8\u5024\u3064\u304D map"
    links: []
  bundledCode: "#line 2 \"ds/default_map.hpp\"\n\n#line 2 \"template/template_all_but_modint.hpp\"\
    ...
    \ res[i] = randint<T>(T(l), T(r) - T(k));\n  sort(ALL(res));\n  repi(i, k) res[i]\
    \ += i;\n  if (!does_sort)\n    shuffle(ALL(res), mt);\n  return res;\n}\n#line\
    \ 4 \"ds/default_map.hpp\"\n\n#line 2 \"ds/safe_unordered_map.hpp\"\n\n#line 4\
    \ \"ds/safe_unordered_map.hpp\"\n\n/**\n * @brief unordered_map \u306E\u5B89\u5168\
    ...
    \    return splitmix64(x ^ FIXED_RANDOM);\n  }\n};\n#line 6 \"ds/default_map.hpp\"\
    \n\n/**\n * @brief \u30C7\u30D5\u30A9\u30EB\u30C8\u5024\u3064\u304D map\n * @docs\
    \ docs/ds/default_map.md\n */\n\n// default_value \u306F\u305D\u308C\u3092\u8FD4\
    \u3059\u95A2\u6570\ntemplate <class Key, class Value, auto default_value>\nstruct\
    \ DefaultMap : map<Key, Value>\n{\n  const Value &operator[](const Key &key) const\n\
    \  {\n    auto it = this->find(key);\n    return (it != this->end()) ? it->second\
    \ : default_value();\n  }\n\n  Value &operator[](const Key &key)\n  {\n    auto\
    \ it = this->find(key);\n    if (it == this->end())\n      it = this->insert({key,\
    \ default_value()}).first;\n    return it->second;\n  }\n\n  const Value &at(const\
    \ Key &key) const { return operator[](key); }\n  Value &at(const Key &key) { return\
    \ operator[](key); }\n};\n\n// default_value \u306F\u305D\u308C\u3092\u8FD4\u3059\
    \u95A2\u6570\ntemplate <class Key, class Value, auto default_value>\nstruct DefaultUnorderedMap\
    \ : unordered_map<Key, Value, safe_hash>\n{\n  const Value &operator[](const Key\
    \ &key) const\n  {\n    auto it = this->find(key);\n    return (it != this->end())\
  ...
  verifiedWith: []
documentation_of: ds/default_map.hpp
layout: document
redirect_from:
- /library/ds/default_map.hpp
- /library/ds/default_map.hpp.html
title: "\u30C7\u30D5\u30A9\u30EB\u30C8\u5024\u3064\u304D map"
---
## デフォルト値つき map
