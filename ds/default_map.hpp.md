...
data:
  ...
  bundledCode: "#line 2 \"ds/default_map.hpp\"\n\n#line 2 \"template/template_all_but_modint.hpp\"\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 4 \"ds/default_map.hpp\"\n\n#line 2 \"\
    ds/safe_unordered_map.hpp\"\n\n#line 4 \"ds/safe_unordered_map.hpp\"\n\n/**\n\
    \ * @brief unordered_map \u306E\u5B89\u5168\u306A\u30CF\u30C3\u30B7\u30E5\u95A2\
  ...
  code: "#pragma once\n\n#include \"../template/template_all_but_modint.hpp\"\n\n\
    ...
    \ (it != this->end()) ? it->second : default_value();\n  }\n\n  Value &operator[](const\
    \ Key &key)\n  {\n    auto it = this->find(key);\n    if (it == this->end())\n\
    ...
    \ auto default_value>\nstruct DefaultUnorderedMap : unordered_map<Key, Value,\
    \ safe_hash>\n{\n  Value operator[](const Key &key) const\n  {\n    auto it =\
