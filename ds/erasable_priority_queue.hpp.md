...
data:
  ...
  attributes:
    ...
    links: []
  bundledCode: "#line 2 \"ds/erasable_priority_queue.hpp\"\n\n#line 2 \"template/template_all_but_modint.hpp\"\
    ...
    \ res[i] = randint<T>(T(l), T(r) - T(k));\n  sort(ALL(res));\n  repi(i, k) res[i]\
    \ += i;\n  if (!does_sort)\n    shuffle(ALL(res), mt);\n  return res;\n}\n#line\
    \ 4 \"ds/erasable_priority_queue.hpp\"\n\n/**\n * @brief \u6D88\u305B\u308B priority\
    \ queue\n * @docs docs/ds/erasable_priority_queue.md\n */\n\n// Compare \u306F\
    \u3001less \u304C\u6607\u9806\u3067 greater \u304C\u964D\u9806\n// \u6D88\u3057\
    \u3059\u304E\u306A\u3044\u65B9\u6CD5\u306F\u672A\u5B9F\u88C5\ntemplate <class\
...
layout: document
redirect_from:
- /library/ds/erasable_priority_queue.hpp
- /library/ds/erasable_priority_queue.hpp.html
