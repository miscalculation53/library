...
data:
  ...
  attributes:
    _deprecated_at_docs: docs/ds/2d/offline/static_rectangle_add_rectangle_sum.md
    document_title: "\u77E9\u5F62\u52A0\u7B97 \u2192 \u77E9\u5F62\u548C\uFF08\u30AA\
      \u30D5\u30E9\u30A4\u30F3\uFF09"
    links: []
  bundledCode: "#line 2 \"ds/2d/offline/static_rectangle_add_rectangle_sum.hpp\"\n\
    ...
    \ res[i] = randint<T>(T(l), T(r) - T(k));\n  sort(ALL(res));\n  repi(i, k) res[i]\
    \ += i;\n  if (!does_sort)\n    shuffle(ALL(res), mt);\n  return res;\n}\n#line\
    \ 4 \"ds/2d/offline/static_rectangle_add_rectangle_sum.hpp\"\n\n#line 2 \"ds/2d/offline/rectangle_sum.hpp\"\
  ...
  code: "#pragma once\n\n#include \"../../../template/template_all_but_modint.hpp\"\
    ...
    \ \u2192 \u77E9\u5F62\u548C\uFF08\u30AA\u30D5\u30E9\u30A4\u30F3\uFF09\n * @docs\
    \ docs/ds/2d/offline/static_rectangle_add_rectangle_sum.md\n */\n\n// rectangle\
    \ add \u3092\u3059\u3079\u3066\u3084\u3063\u305F\u3042\u3068\u306B rectangle sum\
    \ \u3092\u3084\u308B\n// S: \u6574\u6570\u3084 mint \u306A\u3069 (\u52A0\u6E1B\
    \u7B97\u304A\u3088\u3073\u6574\u6570\u500D\u304C\u53EF\u80FD)\n// I: \u5EA7\u6A19\
    \u306E\u578B\ntemplate <class S, class I>\nstruct StaticRectangleAddRectangleSum\n\
    {\nprivate:\n  LowerLeftSum<GroupAddSub<S>, I> rs1, rs2, rs3, rs4;\n  vc<tuple<int,\
...
documentation_of: ds/2d/offline/static_rectangle_add_rectangle_sum.hpp
layout: document
redirect_from:
- /library/ds/2d/offline/static_rectangle_add_rectangle_sum.hpp
- /library/ds/2d/offline/static_rectangle_add_rectangle_sum.hpp.html
title: "\u77E9\u5F62\u52A0\u7B97 \u2192 \u77E9\u5F62\u548C\uFF08\u30AA\u30D5\u30E9\
  \u30A4\u30F3\uFF09"
---
## 矩形加算 → 矩形和（オフライン）
