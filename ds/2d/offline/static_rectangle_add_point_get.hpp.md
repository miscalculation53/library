...
data:
  ...
  attributes:
    _deprecated_at_docs: docs/ds/2d/offline/static_rectangle_add_point_get.md
    document_title: "\u77E9\u5F62\u52A0\u7B97 \u2192 \u70B9\u53D6\u5F97\uFF08\u30AA\
      \u30D5\u30E9\u30A4\u30F3\uFF09"
    links: []
  bundledCode: "#line 2 \"ds/2d/offline/static_rectangle_add_point_get.hpp\"\n\n#line\
  ...
  code: "#pragma once\n\n#include \"../../../template/template_all_but_modint.hpp\"\
    ...
    \ \u2192 \u70B9\u53D6\u5F97\uFF08\u30AA\u30D5\u30E9\u30A4\u30F3\uFF09\n * @docs\
    \ docs/ds/2d/offline/static_rectangle_add_point_get.md\n */\n\n// G: \u53EF\u63DB\
    \u7FA4\n// I: \u5EA7\u6A19\u306E\u578B\ntemplate <class G, class I>\nstruct StaticRectangleAddPointGet\n\
    {\n  using S = typename G::S;\n\nprivate:\n  LowerLeftSum<G, I> rs;\n\npublic:\n\
    \  // [lx, rx) \xD7 [ly, ry) \u306B\u91CD\u307F w \u306E\u9577\u65B9\u5F62\u3092\
...
documentation_of: ds/2d/offline/static_rectangle_add_point_get.hpp
layout: document
redirect_from:
- /library/ds/2d/offline/static_rectangle_add_point_get.hpp
- /library/ds/2d/offline/static_rectangle_add_point_get.hpp.html
title: "\u77E9\u5F62\u52A0\u7B97 \u2192 \u70B9\u53D6\u5F97\uFF08\u30AA\u30D5\u30E9\
  \u30A4\u30F3\uFF09"
---
## 矩形加算 → 点取得（オフライン）
