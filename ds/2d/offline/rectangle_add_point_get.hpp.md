...
data:
  ...
  attributes:
    _deprecated_at_docs: docs/ds/2d/offline/rectangle_add_point_get.md
    document_title: "\u77E9\u5F62\u52A0\u7B97\u30FB\u70B9\u53D6\u5F97\uFF08\u30AA\u30D5\
      \u30E9\u30A4\u30F3\uFF09"
    links: []
  bundledCode: "#line 2 \"ds/2d/offline/rectangle_add_point_get.hpp\"\n\n#line 2 \"\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 4 \"ds/2d/offline/rectangle_add_point_get.hpp\"\
    \n\n#line 2 \"ds/2d/offline/point_add_rectangle_sum.hpp\"\n\n#line 4 \"ds/2d/offline/point_add_rectangle_sum.hpp\"\
    \n\n#line 2 \"ds/2d/offline/rectangle_sum.hpp\"\n\n#line 4 \"ds/2d/offline/rectangle_sum.hpp\"\
    ...
    \  inline I leq_max_in_multiset(T x) const { return lt_max_in_multiset<T, I>(x\
    \ + 1); }\n  // \u8981\u7D20\u304C [0, size()) \u306E\u591A\u91CD\u96C6\u5408\u3092\
    \u7BA1\u7406\u3059\u308B\u306E\u306B\u4F7F\u3063\u305F\u3068\u304D\u3001x \u4EE5\
    \u4E0A\u3067\u6700\u5C0F\u306E\u8981\u7D20\u304C**\u4F55\u756A\u76EE\u304B** (\u306A\
    ...
    \ x) const { return geq_min_in_multiset<T, I>(x + 1); }\n\n  vc<S> content() const\n\
    ...
    \ }\n};\n#line 6 \"ds/2d/offline/point_add_rectangle_sum.hpp\"\n\n/**\n * @brief\
    \ \u70B9\u52A0\u7B97\u30FB\u77E9\u5F62\u548C\uFF08\u30AA\u30D5\u30E9\u30A4\u30F3\
    \uFF09\n * @docs docs/ds/2d/offline/point_add_rectangle_sum.md\n */\n\n// \u9577\
    \u65B9\u5F62\u9818\u57DF\u304C (-\u221E, x) \xD7 (-\u221E, y) \u306E\u5F62\u306E\
    \u5834\u5408 (\u9006\u5143\u3044\u3089\u306A\u3044)\n// M: \u53EF\u63DB\u30E2\u30CE\
    \u30A4\u30C9\n// I: \u5EA7\u6A19\u306E\u578B\ntemplate <class M, class I>\nstruct\
    \ PointAddLowerLeftSum\n{\n  using S = typename M::S;\n\nprivate:\n  using Fn\
    \ = function<S(S)>;\n  using P = tuple<I, I, S>;\n  using PF = tuple<I, I, int,\
    \ int>;\n  using Q = pair<I, I>;\n  vc<variant<P, PF, Q>> qs;\n  vc<Fn> fs;\n\
    \  LowerLeftSum<M, I> rs;\n  int qn = 0;\n\npublic:\n  // (x, y) \u306B\u91CD\u307F\
    \ w \u306E\u70B9\u3092\u8FFD\u52A0\n  void point_add(I x, I y, const S &w) { qs.eb(P(x,\
    \ y, w)); }\n  // \u524D\u306E rectangle sum \u306E\u30AF\u30A8\u30EA\u3092\u53C2\
    \u7167\u3057\u305F\u91CD\u307F\u306E\u70B9\u3092\u8FFD\u52A0\n  // f \u306F S(S)\
    \ \u3067\u3001res[qi] \u3092\u5F15\u6570\u306B\u3068\u308A\u3001\u91CD\u307F\u3092\
    \u8FD4\u3059\u95A2\u6570\n  template <class F>\n  void point_add_fn(I x, I y,\
    \ int qi, F f)\n  {\n    int fi = fs.size();\n    fs.eb(move(f));\n    qs.eb(PF(x,\
    \ y, qi, fi));\n  }\n  // (-\u221E, rx) \xD7 (-\u221E, ry) \u306E\u91CD\u307F\u548C\
    \u3092\u7B54\u3048\u308B\u30AF\u30A8\u30EA\u3092\u8FFD\u52A0\n  void rectangle_sum(I\
    \ rx, I ry)\n  {\n    qs.eb(Q(rx, ry));\n    qn++;\n  }\n  // \u30AF\u30A8\u30EA\
    \u306B\u307E\u3068\u3081\u3066\u7B54\u3048\u308B\n  vc<S> run()\n  {\n    vc<S>\
    \ res(qn, M::e());\n    auto dfs = [&](auto dfs, int l, int r, int li, int ri)\
    \ -> void\n    {\n      if (r - l <= 1)\n        return;\n      const int m =\
    ...
    \         vc<S> tmp = rs.run();\n          repi(i, mi, ri) res[i] = G::op(res[i],\
    \ tmp[i - mi]);\n        }\n      }\n      repi(i, m, r)\n      {\n        if\
    \ (holds_alternative<PF>(qs[i]))\n        {\n          auto [x, y, qi, fi] = get<PF>(qs[i]);\n\
    \          if (li <= qi && qi < mi)\n          {\n            S w = fs[fi](res[qi]);\n\
    \            fs[fi] = {};\n            qs[i] = P(x, y, w);\n          }\n    \
    \    }\n      }\n      dfs(dfs, m, r, mi, ri);\n    };\n    dfs(dfs, 0, qs.size(),\
    \ 0, qn);\n    return res;\n  }\n};\n#line 6 \"ds/2d/offline/rectangle_add_point_get.hpp\"\
    \n\n/**\n * @brief \u77E9\u5F62\u52A0\u7B97\u30FB\u70B9\u53D6\u5F97\uFF08\u30AA\
    \u30D5\u30E9\u30A4\u30F3\uFF09\n * @docs docs/ds/2d/offline/rectangle_add_point_get.md\n\
    \ */\n\n// G: \u53EF\u63DB\u7FA4\n// I: \u5EA7\u6A19\u306E\u578B\ntemplate <class\
    \ G, class I>\nstruct RectangleAddPointGet\n{\n  using S = typename G::S;\n\n\
    private:\n  PointAddLowerLeftSum<G, I> rs;\n\npublic:\n  // [lx, rx) \xD7 [ly,\
    \ ry) \u306B\u91CD\u307F w \u306E\u9577\u65B9\u5F62\u3092\u8FFD\u52A0\n  void\
    \ rectangle_add(I lx, I rx, I ly, I ry, const S &w)\n  {\n    assert(lx <= rx\
    \ && ly <= ry);\n    S iw = G::inv(w);\n    rs.point_add(lx, ly, w), rs.point_add(rx,\
    \ ry, w);\n    rs.point_add(lx, ry, iw), rs.point_add(rx, ly, iw);\n  }\n  //\
    \ (x, y) \u3092\u542B\u3080\u9577\u65B9\u5F62\u306E\u91CD\u307F\u548C\u3092\u7B54\
    \u3048\u308B\u30AF\u30A8\u30EA\u3092\u8FFD\u52A0\n  void point_get(I x, I y) {\
    \ rs.rectangle_sum(x + 1, y + 1); }\n  // \u3059\u3079\u3066\u306E\u30AF\u30A8\
    \u30EA\u306B\u307E\u3068\u3081\u3066\u7B54\u3048\u308B\n  vc<S> run() { return\
    \ rs.run(); }\n};\n"
  code: "#pragma once\n\n#include \"../../../template/template_all_but_modint.hpp\"\
    \n\n#include \"point_add_rectangle_sum.hpp\"\n\n/**\n * @brief \u77E9\u5F62\u52A0\
    \u7B97\u30FB\u70B9\u53D6\u5F97\uFF08\u30AA\u30D5\u30E9\u30A4\u30F3\uFF09\n * @docs\
    \ docs/ds/2d/offline/rectangle_add_point_get.md\n */\n\n// G: \u53EF\u63DB\u7FA4\
    \n// I: \u5EA7\u6A19\u306E\u578B\ntemplate <class G, class I>\nstruct RectangleAddPointGet\n\
    {\n  using S = typename G::S;\n\nprivate:\n  PointAddLowerLeftSum<G, I> rs;\n\n\
    public:\n  // [lx, rx) \xD7 [ly, ry) \u306B\u91CD\u307F w \u306E\u9577\u65B9\u5F62\
    \u3092\u8FFD\u52A0\n  void rectangle_add(I lx, I rx, I ly, I ry, const S &w)\n\
    \  {\n    assert(lx <= rx && ly <= ry);\n    S iw = G::inv(w);\n    rs.point_add(lx,\
    \ ly, w), rs.point_add(rx, ry, w);\n    rs.point_add(lx, ry, iw), rs.point_add(rx,\
    \ ly, iw);\n  }\n  // (x, y) \u3092\u542B\u3080\u9577\u65B9\u5F62\u306E\u91CD\u307F\
    \u548C\u3092\u7B54\u3048\u308B\u30AF\u30A8\u30EA\u3092\u8FFD\u52A0\n  void point_get(I\
    \ x, I y) { rs.rectangle_sum(x + 1, y + 1); }\n  // \u3059\u3079\u3066\u306E\u30AF\
    \u30A8\u30EA\u306B\u307E\u3068\u3081\u3066\u7B54\u3048\u308B\n  vc<S> run() {\
    \ return rs.run(); }\n};\n"
  dependsOn:
  - template/template_all_but_modint.hpp
...
documentation_of: ds/2d/offline/rectangle_add_point_get.hpp
layout: document
redirect_from:
- /library/ds/2d/offline/rectangle_add_point_get.hpp
- /library/ds/2d/offline/rectangle_add_point_get.hpp.html
title: "\u77E9\u5F62\u52A0\u7B97\u30FB\u70B9\u53D6\u5F97\uFF08\u30AA\u30D5\u30E9\u30A4\
  \u30F3\uFF09"
---
## 矩形加算・点取得（オフライン）
