...
data:
  ...
  attributes:
    _deprecated_at_docs: docs/ds/2d/offline/point_add_rectangle_sum.md
    document_title: "\u70B9\u52A0\u7B97\u30FB\u77E9\u5F62\u548C\uFF08\u30AA\u30D5\u30E9\
      \u30A4\u30F3\uFF09"
    links: []
  bundledCode: "#line 2 \"ds/2d/offline/point_add_rectangle_sum.hpp\"\n\n#line 2 \"\
  ...
  code: "#pragma once\n\n#include \"../../../template/template_all_but_modint.hpp\"\
    ...
    \nprivate:\n  using Fn = function<S(S)>;\n  using P = tuple<I, I, S>;\n  using\
    \ PF = tuple<I, I, int, int>;\n  using Q = pair<I, I>;\n  vc<variant<P, PF, Q>>\
    \ qs;\n  vc<Fn> fs;\n  LowerLeftSum<M, I> rs;\n  int qn = 0;\n\npublic:\n  //\
    \ (x, y) \u306B\u91CD\u307F w \u306E\u70B9\u3092\u8FFD\u52A0\n  void point_add(I\
    \ x, I y, const S &w) { qs.eb(P(x, y, w)); }\n  // \u524D\u306E rectangle sum\
    \ \u306E\u30AF\u30A8\u30EA\u3092\u53C2\u7167\u3057\u305F\u91CD\u307F\u306E\u70B9\
    \u3092\u8FFD\u52A0\n  // f \u306F S(S) \u3067\u3001res[qi] \u3092\u5F15\u6570\u306B\
    \u3068\u308A\u3001\u91CD\u307F\u3092\u8FD4\u3059\u95A2\u6570\n  template <class\
    \ F>\n  void point_add_fn(I x, I y, int qi, F f)\n  {\n    int fi = fs.size();\n\
    \    fs.eb(move(f));\n    qs.eb(PF(x, y, qi, fi));\n  }\n  // (-\u221E, rx) \xD7\
    \ (-\u221E, ry) \u306E\u91CD\u307F\u548C\u3092\u7B54\u3048\u308B\u30AF\u30A8\u30EA\
...
documentation_of: ds/2d/offline/point_add_rectangle_sum.hpp
layout: document
redirect_from:
- /library/ds/2d/offline/point_add_rectangle_sum.hpp
- /library/ds/2d/offline/point_add_rectangle_sum.hpp.html
title: "\u70B9\u52A0\u7B97\u30FB\u77E9\u5F62\u548C\uFF08\u30AA\u30D5\u30E9\u30A4\u30F3\
  \uFF09"
---
## 点加算・矩形和（オフライン）
