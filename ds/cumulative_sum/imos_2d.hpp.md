...
data:
  ...
  attributes:
    _deprecated_at_docs: docs/ds/cumulative_sum/imos_2d.md
    document_title: "$2$ \u6B21\u5143 imos \u6CD5"
    links: []
  bundledCode: "#line 2 \"ds/cumulative_sum/imos_2d.hpp\"\n\n#line 2 \"template/template_all_but_modint.hpp\"\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 4 \"ds/cumulative_sum/imos_2d.hpp\"\n\n\
    ...
    \ GroupMulDiv<T>>;\n#line 6 \"ds/cumulative_sum/imos_2d.hpp\"\n\n/**\n * @brief\
    ...
    \ \u3092\u8FD4\u3059\n  vvc<S> content()\n  {\n    if (d.empty())\n      return\
    \ {};\n    const int n = d.size(), m = d[0].size();\n    vvc<S> a(d);\n    repi(i,\
    \ n) repi(j, m - 1) a[i][j + 1] = G::op(a[i][j + 1], a[i][j]);\n    repi(j, m)\
    \ repi(i, n - 1) a[i + 1][j] = G::op(a[i + 1][j], a[i][j]);\n    return a;\n \
    \ }\n};\n"
...
documentation_of: ds/cumulative_sum/imos_2d.hpp
layout: document
redirect_from:
- /library/ds/cumulative_sum/imos_2d.hpp
- /library/ds/cumulative_sum/imos_2d.hpp.html
title: "$2$ \u6B21\u5143 imos \u6CD5"
---
