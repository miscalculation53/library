...
data:
  ...
  attributes:
    _deprecated_at_docs: docs/ds/fenwick_tree/inversion.md
    document_title: "\u8EE2\u5012\u6570"
    links: []
  bundledCode: "#line 2 \"ds/fenwick_tree/inversion.hpp\"\n\n#line 2 \"template/template_all_but_modint.hpp\"\
  ...
  code: "#pragma once\n\n#include \"../../template/template_all_but_modint.hpp\"\n\
    ...
    \ docs/ds/fenwick_tree/inversion.md\n */\n\n// i < j \u304B\u3064 v[i] > v[j]\
    \ \u3092\u6E80\u305F\u3059 (i, j) \u306E\u500B\u6570\n// \u5EA7\u5727\u3057\u3066\
    \u3044\u306A\u304F\u3066\u3082\u3088\u3044\ntemplate <class V>\nll inversion_number(const\
    \ V &v)\n{\n  const int n = v.size();\n  vc<int> p = permid<int>(n);\n  stable_sort(ALL(p),\
    \ [&](int i, int j)\n       { return v[i] < v[j]; });\n  FenwickTree01 fw(n);\n\
...
layout: document
redirect_from:
- /library/ds/fenwick_tree/inversion.hpp
