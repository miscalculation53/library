...
data:
  ...
  attributes:
    _deprecated_at_docs: docs/ds/segtree/dual_segtree.md
  ...
  bundledCode: "#line 2 \"ds/segtree/dual_segtree.hpp\"\n\n#line 2 \"template/template_all_but_modint.hpp\"\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 4 \"ds/segtree/dual_segtree.hpp\"\n\n\
    ...
    \ GroupMulDiv<T>>;\n#line 6 \"ds/segtree/dual_segtree.hpp\"\n\n/**\n * @brief\
    ...
    \ : DualSegmentTree(vc<S>(n, A::e())) {}\n  template <class Iter>\n  DualSegmentTree(const\
    \ Iter &bg, const Iter &ed) : DualSegmentTree(vc<S>(bg, ed)) {}\n  template <class\
    \ T>\n  DualSegmentTree(const vc<T> &vec)\n  : n(vec.size()), siz(bit_ceil(vec.size())),\
    ...
    \ const S &x) { return M::op(f, x); }\n  static constexpr F composition(const\
    \ F &f, const F &g) { return M::op(f, g); }\n  static constexpr F id() { return\
    \ M::e(); }\n};\n"
