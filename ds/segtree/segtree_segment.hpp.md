...
data:
  ...
  attributes:
    _deprecated_at_docs: docs/ds/segtree/segtree_segment.md
    document_title: "\u30BB\u30B0\u6728\u306E\u533A\u9593\u306B\u95A2\u308F\u308B\u7B97\
      \u6570"
    links: []
  bundledCode: "#line 2 \"ds/segtree/segtree_segment.hpp\"\n\n#line 2 \"template/template_all_but_modint.hpp\"\
    ...
    \ res[i] = randint<T>(T(l), T(r) - T(k));\n  sort(ALL(res));\n  repi(i, k) res[i]\
    \ += i;\n  if (!does_sort)\n    shuffle(ALL(res), mt);\n  return res;\n}\n#line\
    \ 4 \"ds/segtree/segtree_segment.hpp\"\n\n/**\n * @brief \u30BB\u30B0\u6728\u306E\
    \u533A\u9593\u306B\u95A2\u308F\u308B\u7B97\u6570\n * @docs docs/ds/segtree/segtree_segment.md\n\
    \ */\n\n// \u6DF1\u3055 d+1 \u306E\u30BB\u30B0\u6728: 2^{d+1} - 1 \u9802\u70B9\
    \u3067\u3001[0, 2^d) \u306E\u533A\u9593\u304C\u6271\u3048\u308B\n// \u9802\u70B9\
    \ i \u304C\u8868\u3059\u30CE\u30FC\u30C9 [a, b) \u3092\u8FD4\u3059\n// \u8A08\u7B97\
    \u91CF: O(1)\ntemplate <class T = ll>\nT segtree_node_to_segment(int d, T i)\n\
    {\n  const T n = T(1) << d;\n  assert(1 <= i && i < 2 * n);\n  const int k = bit_width(i)\
  ...
  code: "#pragma once\n\n#include \"../../template/template_all_but_modint.hpp\"\n\
    ...
    \ const T len = T(1) << (d - k), a = len * i - n, b = a + len;\n  return {a, b};\n\
    }\n\n// \u6DF1\u3055 d+1 \u306E\u30BB\u30B0\u6728: 2^{d+1} - 1 \u9802\u70B9\u3067\
    \u3001[0, 2^d) \u306E\u533A\u9593\u304C\u6271\u3048\u308B\n// \u533A\u9593 [a,\
    \ b) \u306F\u5358\u4E00\u306E\u30CE\u30FC\u30C9\u3067\u8868\u3055\u308C\u308B\u3068\
    \u3057\u3066\u3001\u8868\u3059\u30CE\u30FC\u30C9\u306E\u756A\u53F7 i \u3092\u8FD4\
    \u3059\n// \u8A08\u7B97\u91CF: O(1)\ntemplate <class T = ll>\nT segtree_segment_to_node(int\
    \ d, T a, T b)\n{\n  const T n = T(1) << d;\n  assert(0 <= a && a <= b && b <=\
    \ n);\n  const T len = b - a;\n  const int k = d + 1 - bit_width(len);\n  return\
    \ (a >> (d - k)) + (T(1) << k);\n}\n\n// \u6DF1\u3055 d+1 \u306E\u30BB\u30B0\u6728\
    : 2^{d+1} - 1 \u9802\u70B9\u3067\u3001[0, 2^d) \u306E\u533A\u9593\u304C\u6271\u3048\
    \u308B\n// [l, r) \u3092\u8868\u3059\u30CE\u30FC\u30C9\u306E\u96C6\u5408\u3092\
    \u8FD4\u3059\n// \u9806\u756A: \u5DE6\u306E\u533A\u9593\u304B\u3089\u306B\u306A\
...
layout: document
redirect_from:
- /library/ds/segtree/segtree_segment.hpp
- /library/ds/segtree/segtree_segment.hpp.html
title: "\u30BB\u30B0\u6728\u306E\u533A\u9593\u306B\u95A2\u308F\u308B\u7B97\u6570"
---
## セグ木の区間に関わる算数
