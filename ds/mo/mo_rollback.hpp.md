...
data:
  ...
  attributes:
    _deprecated_at_docs: docs/ds/mo/mo_rollback.md
    document_title: "rollback \u53EF\u80FD\u306A Mo's algorithm"
    links: []
  bundledCode: "#line 2 \"ds/mo/mo_rollback.hpp\"\n\n#line 2 \"template/template_all_but_modint.hpp\"\
    ...
    \ }\n  const vc<T> &get_elist() const { return elist; }\n};\n#line 6 \"ds/mo/mo_rollback.hpp\"\
    \n\n/**\n * @brief rollback \u53EF\u80FD\u306A Mo's algorithm\n * @docs docs/ds/mo/mo_rollback.md\n\
    \ */\n\n// add_l(l, r): \u4ECA\u306E\u533A\u9593\u304C [l+1, r) \u3067\u3042\u308B\
    \u3068\u304D\u3001l \u3092\u8FFD\u52A0\u3057\u3066 [l, r) \u306B\u3059\u308B\n\
    // add_r(l, r): \u4ECA\u306E\u533A\u9593\u304C [l, r) \u3067\u3042\u308B\u3068\
    \u304D\u3001r \u3092\u8FFD\u52A0\u3057\u3066 [l, r+1) \u306B\u3059\u308B\n// snapshot():\
    \ snapshot \u3092\u64AE\u308B\n// rollback(): snapshot \u3092\u64AE\u3063\u305F\
    \u72B6\u614B\u306B\u5DFB\u304D\u623B\u3059\n// reset(): \u521D\u671F\u72B6\u614B\
    \u306B\u623B\u3059\n// rem(qid): \u4ECA\u304C qid \u756A\u76EE\u306E\u533A\u9593\
    \u3060\u3068\u3057\u3066\u305D\u306E\u90E8\u5206\u306E\u7B54\u3048\u3092\u78BA\
    \u5B9A\u3055\u305B\u308B\ntemplate <class I, class AddL, class AddR, class Snapshot,\
    \ class Rollback, class Reset, class Rem>\nvoid mo_rollback(int n, const vc<pair<I,\
    \ I>> &lrs, const AddL &add_l, const AddR &add_r, const Snapshot &snapshot, const\
    \ Rollback &rollback, const Reset &reset, const Rem &rem)\n{\n  fec([ l, r ] :\
    \ lrs) { assert(0 <= l && l <= r && r <= n); }\n  cauto & [ ls, rs ] = unzip(lrs);\n\
    \  const int q = lrs.size();\n  const int b = max<int>(1, n / sqrt(q + 1));\n\n\
    \  vc<pair<int, int>> ies;\n  ies.reserve(q);\n  repi(qid, q)\n  {\n    const\
    \ int l = ls[qid], r = rs[qid], bid = l / b;\n    if (r - l < b)\n    {\n    \
    ...
    \n// rollback(): \u76F4\u524D\u306B snapshot \u3092\u64AE\u3063\u305F\u72B6\u614B\
    \u306B\u5DFB\u304D\u623B\u3059\n// reset(): \u521D\u671F\u72B6\u614B\u306B\u623B\
    \u3059\n// rem(qid): \u4ECA\u304C qid \u756A\u76EE\u306E\u533A\u9593\u3060\u3068\
    \u3057\u3066\u305D\u306E\u90E8\u5206\u306E\u7B54\u3048\u3092\u78BA\u5B9A\u3055\
    \u305B\u308B\ntemplate <class I, class Add, class Snapshot, class Rollback, class\
    \ Reset, class Rem>\nvoid mo_rollback(int n, const vc<pair<I, I>> &lrs, const\
    \ Add &add, const Snapshot &snapshot, const Rollback &rollback, const Reset &reset,\
    \ const Rem &rem)\n{\n  cauto add_l = [&](int l, int) { add(l, true); };\n  cauto\
    \ add_r = [&](int, int r) { add(r, false); };\n  mo_rollback(n, lrs, add_l, add_r,\
    \ snapshot, rollback, reset, rem);\n}\n"
  code: "#pragma once\n\n#include \"../../template/template_all_but_modint.hpp\"\n\
    \n#include \"../csr.hpp\"\n\n/**\n * @brief rollback \u53EF\u80FD\u306A Mo's algorithm\n\
    \ * @docs docs/ds/mo/mo_rollback.md\n */\n\n// add_l(l, r): \u4ECA\u306E\u533A\
    \u9593\u304C [l+1, r) \u3067\u3042\u308B\u3068\u304D\u3001l \u3092\u8FFD\u52A0\
    \u3057\u3066 [l, r) \u306B\u3059\u308B\n// add_r(l, r): \u4ECA\u306E\u533A\u9593\
    \u304C [l, r) \u3067\u3042\u308B\u3068\u304D\u3001r \u3092\u8FFD\u52A0\u3057\u3066\
    \ [l, r+1) \u306B\u3059\u308B\n// snapshot(): snapshot \u3092\u64AE\u308B\n//\
    \ rollback(): snapshot \u3092\u64AE\u3063\u305F\u72B6\u614B\u306B\u5DFB\u304D\u623B\
    \u3059\n// reset(): \u521D\u671F\u72B6\u614B\u306B\u623B\u3059\n// rem(qid): \u4ECA\
    \u304C qid \u756A\u76EE\u306E\u533A\u9593\u3060\u3068\u3057\u3066\u305D\u306E\u90E8\
    \u5206\u306E\u7B54\u3048\u3092\u78BA\u5B9A\u3055\u305B\u308B\ntemplate <class\
    \ I, class AddL, class AddR, class Snapshot, class Rollback, class Reset, class\
    \ Rem>\nvoid mo_rollback(int n, const vc<pair<I, I>> &lrs, const AddL &add_l,\
    \ const AddR &add_r, const Snapshot &snapshot, const Rollback &rollback, const\
    \ Reset &reset, const Rem &rem)\n{\n  fec([ l, r ] : lrs) { assert(0 <= l && l\
    \ <= r && r <= n); }\n  cauto & [ ls, rs ] = unzip(lrs);\n  const int q = lrs.size();\n\
    \  const int b = max<int>(1, n / sqrt(q + 1));\n\n  vc<pair<int, int>> ies;\n\
    \  ies.reserve(q);\n  repi(qid, q)\n  {\n    const int l = ls[qid], r = rs[qid],\
    \ bid = l / b;\n    if (r - l < b)\n    {\n      repi(i, l, r) add_r(l, i);\n\
    \      rem(qid);\n      reset();\n    }\n    else\n      ies.eb(bid, qid);\n \
    \ }\n  CSR<int> csr(n / b, ies);\n\n  repi(bid, n / b)\n  {\n    auto row = csr[bid];\n\
    \    sort(ALL(row), [&](int i, int j)\n         { return rs[i] < rs[j]; });\n\
    ...
    \      rollback();\n    }\n    reset();\n  }\n}\n\n// add(i, isleft): \u4ECA\u306E\
    \u533A\u9593\u306B i \u3092\u8FFD\u52A0\u3059\u308B (isleft \u306F\u5DE6\u306B\
    \u8FFD\u52A0\u3059\u308B\u304B\u3069\u3046\u304B)\n// snapshot(): \u4ECA\u306E\
    \u72B6\u614B\u306E snapshot \u3092\u64AE\u308B\n// rollback(): \u76F4\u524D\u306B\
    \ snapshot \u3092\u64AE\u3063\u305F\u72B6\u614B\u306B\u5DFB\u304D\u623B\u3059\n\
    // reset(): \u521D\u671F\u72B6\u614B\u306B\u623B\u3059\n// rem(qid): \u4ECA\u304C\
    \ qid \u756A\u76EE\u306E\u533A\u9593\u3060\u3068\u3057\u3066\u305D\u306E\u90E8\
    \u5206\u306E\u7B54\u3048\u3092\u78BA\u5B9A\u3055\u305B\u308B\ntemplate <class\
    \ I, class Add, class Snapshot, class Rollback, class Reset, class Rem>\nvoid\
    \ mo_rollback(int n, const vc<pair<I, I>> &lrs, const Add &add, const Snapshot\
    \ &snapshot, const Rollback &rollback, const Reset &reset, const Rem &rem)\n{\n\
    \  cauto add_l = [&](int l, int) { add(l, true); };\n  cauto add_r = [&](int,\
    \ int r) { add(r, false); };\n  mo_rollback(n, lrs, add_l, add_r, snapshot, rollback,\
    \ reset, rem);\n}\n"
  dependsOn:
...
documentation_of: ds/mo/mo_rollback.hpp
layout: document
redirect_from:
- /library/ds/mo/mo_rollback.hpp
- /library/ds/mo/mo_rollback.hpp.html
