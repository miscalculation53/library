...
data:
  ...
  attributes:
    _deprecated_at_docs: docs/ds/static_range/linear_rmq.md
    document_title: "\u7DDA\u5F62 RMQ"
    links: []
  bundledCode: "#line 2 \"ds/static_range/linear_rmq.hpp\"\n\n#line 2 \"template/template_all_but_modint.hpp\"\
    ...
    \ BST = BlockSparseTable<M, B>;\n\nprotected:\n  using BST::n, BST::v, BST::cl,\
    \ BST::cr, BST::st;\n  // bit[j] \u306E i' \u30D3\u30C3\u30C8\u76EE\u306F\u3001\
    \n  // \u305D\u306E\u30D6\u30ED\u30C3\u30AF\u306B\u3042\u308B i \u2261 i' (mod\
    \ B) \u306A i \u306B\u3064\u3044\u3066\n  // [i, j] \u306E\u7B54\u3048\u304C i\
    \ \u304B\u3069\u3046\u304B\n  vc<Word> bit;\n\npublic:\n  LinearRMQ() {}\n  LinearRMQ(const\
  ...
  code: "#pragma once\n\n#include \"../../template/template_all_but_modint.hpp\"\n\
    ...
    \ docs/ds/static_range/linear_rmq.md\n */\n\n// M \u306F min, max \u306A\u3069\
    \u306E\u30E2\u30CE\u30A4\u30C9\ntemplate <class M, class Word = uint64_t>\nstruct\
    \ LinearRMQ : BlockSparseTable<M, 8 * sizeof(Word)>\n{\n  static_assert(is_unsigned_v<Word>);\n\
    \  static const int B = 8 * sizeof(Word);\n  using S = typename M::S;\n  using\
    \ BST = BlockSparseTable<M, B>;\n\nprotected:\n  using BST::n, BST::v, BST::cl,\
    \ BST::cr, BST::st;\n  // bit[j] \u306E i' \u30D3\u30C3\u30C8\u76EE\u306F\u3001\
    \n  // \u305D\u306E\u30D6\u30ED\u30C3\u30AF\u306B\u3042\u308B i \u2261 i' (mod\
...
documentation_of: ds/static_range/linear_rmq.hpp
layout: document
redirect_from:
- /library/ds/static_range/linear_rmq.hpp
- /library/ds/static_range/linear_rmq.hpp.html
title: "\u7DDA\u5F62 RMQ"
---
## 線形 RMQ
