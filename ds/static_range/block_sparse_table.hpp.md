...
data:
  ...
  attributes:
    ...
    links: []
  bundledCode: "#line 2 \"ds/static_range/block_sparse_table.hpp\"\n\n#line 2 \"template/template_all_but_modint.hpp\"\
    ...
    \ res[i] = randint<T>(T(l), T(r) - T(k));\n  sort(ALL(res));\n  repi(i, k) res[i]\
    \ += i;\n  if (!does_sort)\n    shuffle(ALL(res), mt);\n  return res;\n}\n#line\
    \ 4 \"ds/static_range/block_sparse_table.hpp\"\n\n#line 2 \"ds/static_range/sparse_table.hpp\"\
...
layout: document
redirect_from:
- /library/ds/static_range/block_sparse_table.hpp
- /library/ds/static_range/block_sparse_table.hpp.html
