...
data:
  ...
  attributes:
    _deprecated_at_docs: docs/ds/topk_array.md
    document_title: "\u8981\u7D20\u306E\u8FFD\u52A0\u30FB\u4E0A\u4F4D $k$ \u500B\u306E\
      \u7BA1\u7406"
    links: []
  bundledCode: "#line 2 \"ds/topk_array.hpp\"\n\n#line 2 \"template/template_all_but_modint.hpp\"\
    ...
    \ - T(l) >= T(k));\n  vc<T> res(k);\n  internal::random_sample_range<does_sort>(res,\
    \ T(l), T(r));\n  return res;\n}\n#line 4 \"ds/topk_array.hpp\"\n\n/**\n * @brief\
    \ \u8981\u7D20\u306E\u8FFD\u52A0\u30FB\u4E0A\u4F4D $k$ \u500B\u306E\u7BA1\u7406\
    \n * @docs docs/ds/topk_array.md\n */\n\ntemplate <class T, int k, class Compare\
    \ = less<T>>\nstruct TopKArray\n{\nprivate:\n  int sz;\n  array<T, k> arr;\n\n\
    public:\n  TopKArray() : sz(0), arr{} {}\n  template <class Iter>\n  TopKArray(Iter\
    \ bg, Iter ed) : sz(0), arr{}\n  {\n    for (auto it = bg; it != ed; it++)\n \
    \     add(*it);\n  }\n  TopKArray(initializer_list<T> ini) : TopKArray(ini.begin(),\
    \ ini.end()) {}\n  template <class V>\n  TopKArray(const V &v) : TopKArray(v.begin(),\
    ...
    \ <= i && i < sz);\n    return arr[i];\n  }\n  // O(k)\n  TopKArray merged(const\
    \ TopKArray &other) const\n  {\n    TopKArray res{};\n    int i = 0, j = 0;\n\
    \    while (res.sz < k && (i < sz || j < other.sz))\n    {\n      if (j == other.sz\
    \ || (i < sz && Compare()(arr[i], other.arr[j])))\n        res.arr[res.sz++] =\
    \ arr[i++];\n      else\n        res.arr[res.sz++] = other.arr[j++];\n    }\n\
    \    return res;\n  }\n  // O(k)\n  void merge(const TopKArray &other) { *this\
    \ = merged(other); }\n\n  vc<T> content() const\n  {\n    vc<T> res(sz);\n   \
    \ repi(i, sz) res[i] = arr[i];\n    return res;\n  }\n};\n\ntemplate <class T,\
    \ int k, class Compare = less<T>>\nstruct TopKArrayMonoid\n{\n  using S = TopKArray<T,\
  ...
  verifiedWith: []
documentation_of: ds/topk_array.hpp
layout: document
redirect_from:
- /library/ds/topk_array.hpp
- /library/ds/topk_array.hpp.html
title: "\u8981\u7D20\u306E\u8FFD\u52A0\u30FB\u4E0A\u4F4D $k$ \u500B\u306E\u7BA1\u7406"
---
